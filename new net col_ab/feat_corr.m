...
for j=1:s_similar
    ...
    out_similar(j,3)=similar(j,6);
    out_similar(j,4)=frst_sum/num1(j);
end
num2=0;
for i=1:q
    test_ok=0;
...
lt_out1=length(out1);
out(1:lt_out1,1:4)=out1(:,1:4);
if num0>0
    out(lt_out1+1:lt_out1+lt_out_similar,1:4)=out_similar(:,1:4);
end
end