...
function out=mlp_4_new6(inps,outps)
...
while as==0
    ...
    for rep=1:10
        ...
        dat_vald_inp=zeros(num_vald,2);dat_vald_otp=zeros(num_vald,1);
        %-------------------------------------------------------------------------
        ...
        input_data=[dat_trn_inp(:,1)' dat_vald_inp(:,1)' dat_tst_inp(:,1)';dat_trn_inp(:,2)' dat_vald_inp(:,2)' dat_tst_inp(:,2)'];
