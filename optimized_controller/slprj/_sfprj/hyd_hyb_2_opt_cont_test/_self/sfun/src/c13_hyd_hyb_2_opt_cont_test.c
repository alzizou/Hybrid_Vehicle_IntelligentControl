...
static void initialize_c13_hyd_hyb_2_opt_cont_test
  (SFc13_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance);
static void initialize_params_c13_hyd_hyb_2_opt_cont_test
  (SFc13_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance);
static void enable_c13_hyd_hyb_2_opt_cont_test
  (SFc13_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance);
static void disable_c13_hyd_hyb_2_opt_cont_test
  (SFc13_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance);
static void c13_update_debugger_state_c13_hyd_hyb_2_opt_cont_test
  (SFc13_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c13_hyd_hyb_2_opt_cont_test
  (SFc13_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance);
static void set_sim_state_c13_hyd_hyb_2_opt_cont_test
  (SFc13_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance, const mxArray
   *c13_st);
static void finalize_c13_hyd_hyb_2_opt_cont_test
  (SFc13_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance);
static void sf_c13_hyd_hyb_2_opt_cont_test
  (SFc13_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance);
static void initSimStructsc13_hyd_hyb_2_opt_cont_test
  (SFc13_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c13_machineNumber, uint32_T
  c13_chartNumber);
static const mxArray *c13_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static real_T c13_emlrt_marshallIn(SFc13_hyd_hyb_2_opt_cont_testInstanceStruct
  *chartInstance, const mxArray *c13_y, const char_T *c13_identifier);
static real_T c13_b_emlrt_marshallIn(SFc13_hyd_hyb_2_opt_cont_testInstanceStruct
...
static uint8_T c13_d_emlrt_marshallIn
  (SFc13_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance, const mxArray
   *c13_b_is_active_c13_hyd_hyb_2_opt_cont_test, const char_T *c13_identifier);
static uint8_T c13_e_emlrt_marshallIn
  (SFc13_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance, const mxArray
   *c13_u, const emlrtMsgIdentifier *c13_parentId);
static void init_dsm_address_info(SFc13_hyd_hyb_2_opt_cont_testInstanceStruct
  *chartInstance);
  ...
  (SFc13_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance)
{
  ...
  chartInstance->c13_is_active_c13_hyd_hyb_2_opt_cont_test = 0U;
}
  ...
  (SFc13_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance)
{
  ...
  c13_b_hoistedGlobal = chartInstance->c13_is_active_c13_hyd_hyb_2_opt_cont_test;
   ...
   *c13_st)
{
  ...
  *c13_y = c13_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c13_u,
    0)), "y");
  chartInstance->c13_is_active_c13_hyd_hyb_2_opt_cont_test =
    c13_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c13_u, 1)),
    "is_active_c13_hyd_hyb_2_opt_cont_test");
  sf_mex_destroy(&c13_u);
  c13_update_debugger_state_c13_hyd_hyb_2_opt_cont_test(chartInstance);
  ...
  *c13_inData)
{
  ...
  const mxArray *c13_y = NULL;
  SFc13_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance;
  chartInstance = (SFc13_hyd_hyb_2_opt_cont_testInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c13_hyd_hyb_2_opt_cont_test_get_eml_resolved_functions_info
  (void)
{
   ...
   *c13_b_is_active_c13_hyd_hyb_2_opt_cont_test, const char_T *c13_identifier)
{
  ...
  c13_y = c13_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c13_b_is_active_c13_hyd_hyb_2_opt_cont_test), &c13_thisId);
  sf_mex_destroy(&c13_b_is_active_c13_hyd_hyb_2_opt_cont_test);
  return c13_y;
}
...
/* SFunction Glue Code */
void sf_c13_hyd_hyb_2_opt_cont_test_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c13_hyd_hyb_2_opt_cont_test_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c13_hyd_hyb_2_opt_cont_test(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c13_hyd_hyb_2_opt_cont_test\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c13_hyd_hyb_2_opt_cont_test_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c13_hyd_hyb_2_opt_cont_test(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc13_hyd_hyb_2_opt_cont_testInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c13_hyd_hyb_2_opt_cont_test
    ((SFc13_hyd_hyb_2_opt_cont_testInstanceStruct*) chartInstanceVar);
  initialize_c13_hyd_hyb_2_opt_cont_test
    ((SFc13_hyd_hyb_2_opt_cont_testInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c13_hyd_hyb_2_opt_cont_test(void *chartInstanceVar)
{
  enable_c13_hyd_hyb_2_opt_cont_test
    ((SFc13_hyd_hyb_2_opt_cont_testInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c13_hyd_hyb_2_opt_cont_test(void *chartInstanceVar)
{
  disable_c13_hyd_hyb_2_opt_cont_test
    ((SFc13_hyd_hyb_2_opt_cont_testInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c13_hyd_hyb_2_opt_cont_test(void *chartInstanceVar)
{
  sf_c13_hyd_hyb_2_opt_cont_test((SFc13_hyd_hyb_2_opt_cont_testInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c13_hyd_hyb_2_opt_cont_test
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c13_hyd_hyb_2_opt_cont_test
    ((SFc13_hyd_hyb_2_opt_cont_testInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c13_hyd_hyb_2_opt_cont_test();/* state var info */
...
extern void sf_internal_set_sim_state_c13_hyd_hyb_2_opt_cont_test(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c13_hyd_hyb_2_opt_cont_test
    ((SFc13_hyd_hyb_2_opt_cont_testInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c13_hyd_hyb_2_opt_cont_test
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c13_hyd_hyb_2_opt_cont_test(S);
}

static void sf_opaque_set_sim_state_c13_hyd_hyb_2_opt_cont_test(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c13_hyd_hyb_2_opt_cont_test(S, st);
}

static void sf_opaque_terminate_c13_hyd_hyb_2_opt_cont_test(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc13_hyd_hyb_2_opt_cont_testInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c13_hyd_hyb_2_opt_cont_test
      ((SFc13_hyd_hyb_2_opt_cont_testInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc13_hyd_hyb_2_opt_cont_test
    ((SFc13_hyd_hyb_2_opt_cont_testInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c13_hyd_hyb_2_opt_cont_test(SimStruct *S)
{
  int i;
...
static void mdlRTW_c13_hyd_hyb_2_opt_cont_test(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c13_hyd_hyb_2_opt_cont_test(SimStruct *S)
{
  SFc13_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance;
  chartInstance = (SFc13_hyd_hyb_2_opt_cont_testInstanceStruct *)malloc(sizeof
    (SFc13_hyd_hyb_2_opt_cont_testInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc13_hyd_hyb_2_opt_cont_testInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c13_hyd_hyb_2_opt_cont_test;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c13_hyd_hyb_2_opt_cont_test;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c13_hyd_hyb_2_opt_cont_test;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c13_hyd_hyb_2_opt_cont_test;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c13_hyd_hyb_2_opt_cont_test;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c13_hyd_hyb_2_opt_cont_test;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c13_hyd_hyb_2_opt_cont_test;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c13_hyd_hyb_2_opt_cont_test;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c13_hyd_hyb_2_opt_cont_test;
  chartInstance->chartInfo.mdlStart = mdlStart_c13_hyd_hyb_2_opt_cont_test;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c13_hyd_hyb_2_opt_cont_test;
...
void c13_hyd_hyb_2_opt_cont_test_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c13_hyd_hyb_2_opt_cont_test(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c13_hyd_hyb_2_opt_cont_test(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c13_hyd_hyb_2_opt_cont_test(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c13_hyd_hyb_2_opt_cont_test_method_dispatcher.\n"
