...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_hyd_hyb_2_opt_cont_test_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_hyd_hyb_2_opt_cont_test_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_hyd_hyb_2_opt_cont_test_autoinheritance_info( int nlhs,
  ...
  if (strcmp(machineName, "hyd_hyb_2_opt_cont_test") == 0) {
    const mxArray *newRhs[2] = { NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_hyd_hyb_2_opt_cont_test_autoinheritance_info(nlhs,plhs,2,newRhs);
  }
...
{
  extern unsigned int sf_hyd_hyb_2_opt_cont_test_get_eml_resolved_functions_info
  ...
  if (strcmp(machineName, "hyd_hyb_2_opt_cont_test") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_hyd_hyb_2_opt_cont_test_get_eml_resolved_functions_info(nlhs,plhs,
      2,newRhs);
  }
...
extern unsigned int sf_hyd_hyb_2_opt_cont_test_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"hyd_hyb_2_opt_cont_test")) {
    return(sf_hyd_hyb_2_opt_cont_test_method_dispatcher(simstructPtr,
...
extern void hyd_hyb_2_opt_cont_test_terminator(void);
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    hyd_hyb_2_opt_cont_test_terminator();
    sf_debug_terminate();
  }
...
extern void hyd_hyb_2_opt_cont_test_initializer(void);
extern void hyd_hyb_2_opt_cont_test_register_exported_symbols(SimStruct* S);
extern void hyd_hyb_2_opt_cont_test_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  hyd_hyb_2_opt_cont_test_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      hyd_hyb_2_opt_cont_test_debug_initialize();
    }

    hyd_hyb_2_opt_cont_test_initializer();
  }
