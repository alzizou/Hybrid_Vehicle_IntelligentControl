...
static void initialize_c24_hyd_hyb_2_opt_cont_test
  (SFc24_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance);
static void initialize_params_c24_hyd_hyb_2_opt_cont_test
  (SFc24_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance);
static void enable_c24_hyd_hyb_2_opt_cont_test
  (SFc24_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance);
static void disable_c24_hyd_hyb_2_opt_cont_test
  (SFc24_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance);
static void c24_update_debugger_state_c24_hyd_hyb_2_opt_cont_test
  (SFc24_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c24_hyd_hyb_2_opt_cont_test
  (SFc24_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance);
static void set_sim_state_c24_hyd_hyb_2_opt_cont_test
  (SFc24_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance, const mxArray
   *c24_st);
static void finalize_c24_hyd_hyb_2_opt_cont_test
  (SFc24_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance);
static void sf_c24_hyd_hyb_2_opt_cont_test
  (SFc24_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance);
static void initSimStructsc24_hyd_hyb_2_opt_cont_test
  (SFc24_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance);
...
static const mxArray *c24_sf_marshallOut(void *chartInstanceVoid, void
  *c24_inData);
static real_T c24_emlrt_marshallIn(SFc24_hyd_hyb_2_opt_cont_testInstanceStruct
  *chartInstance, const mxArray *c24_T_mech_brk, const char_T *c24_identifier);
static real_T c24_b_emlrt_marshallIn(SFc24_hyd_hyb_2_opt_cont_testInstanceStruct
...
static void c24_eml_scalar_eg(SFc24_hyd_hyb_2_opt_cont_testInstanceStruct
  *chartInstance);
...
static uint8_T c24_d_emlrt_marshallIn
  (SFc24_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance, const mxArray
   *c24_b_is_active_c24_hyd_hyb_2_opt_cont_test, const char_T *c24_identifier);
static uint8_T c24_e_emlrt_marshallIn
  (SFc24_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance, const mxArray
   *c24_u, const emlrtMsgIdentifier *c24_parentId);
static void init_dsm_address_info(SFc24_hyd_hyb_2_opt_cont_testInstanceStruct
  *chartInstance);
  ...
  (SFc24_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance)
{
  ...
  chartInstance->c24_is_active_c24_hyd_hyb_2_opt_cont_test = 0U;
}
  ...
  (SFc24_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance)
{
  ...
  c24_c_hoistedGlobal = chartInstance->c24_is_active_c24_hyd_hyb_2_opt_cont_test;
   ...
   *c24_st)
{
  ...
  *c24_T_mech_brk = c24_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c24_is_active_c24_hyd_hyb_2_opt_cont_test =
    c24_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c24_u, 2)),
    "is_active_c24_hyd_hyb_2_opt_cont_test");
  sf_mex_destroy(&c24_u);
  c24_update_debugger_state_c24_hyd_hyb_2_opt_cont_test(chartInstance);
  ...
  *c24_inData)
{
  ...
  const mxArray *c24_y = NULL;
  SFc24_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance;
  chartInstance = (SFc24_hyd_hyb_2_opt_cont_testInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c24_hyd_hyb_2_opt_cont_test_get_eml_resolved_functions_info
  (void)
{
   ...
   *c24_b_is_active_c24_hyd_hyb_2_opt_cont_test, const char_T *c24_identifier)
{
  ...
  c24_y = c24_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c24_b_is_active_c24_hyd_hyb_2_opt_cont_test), &c24_thisId);
  sf_mex_destroy(&c24_b_is_active_c24_hyd_hyb_2_opt_cont_test);
  return c24_y;
}
...
/* SFunction Glue Code */
void sf_c24_hyd_hyb_2_opt_cont_test_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c24_hyd_hyb_2_opt_cont_test_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c24_hyd_hyb_2_opt_cont_test(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"T_eng\",},{M[1],M[8],T\"T_mech_brk\",},{M[8],M[0],T\"is_active_c24_hyd_hyb_2_opt_cont_test\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c24_hyd_hyb_2_opt_cont_test_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c24_hyd_hyb_2_opt_cont_test(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc24_hyd_hyb_2_opt_cont_testInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c24_hyd_hyb_2_opt_cont_test
    ((SFc24_hyd_hyb_2_opt_cont_testInstanceStruct*) chartInstanceVar);
  initialize_c24_hyd_hyb_2_opt_cont_test
    ((SFc24_hyd_hyb_2_opt_cont_testInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c24_hyd_hyb_2_opt_cont_test(void *chartInstanceVar)
{
  enable_c24_hyd_hyb_2_opt_cont_test
    ((SFc24_hyd_hyb_2_opt_cont_testInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c24_hyd_hyb_2_opt_cont_test(void *chartInstanceVar)
{
  disable_c24_hyd_hyb_2_opt_cont_test
    ((SFc24_hyd_hyb_2_opt_cont_testInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c24_hyd_hyb_2_opt_cont_test(void *chartInstanceVar)
{
  sf_c24_hyd_hyb_2_opt_cont_test((SFc24_hyd_hyb_2_opt_cont_testInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c24_hyd_hyb_2_opt_cont_test
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c24_hyd_hyb_2_opt_cont_test
    ((SFc24_hyd_hyb_2_opt_cont_testInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c24_hyd_hyb_2_opt_cont_test();/* state var info */
...
extern void sf_internal_set_sim_state_c24_hyd_hyb_2_opt_cont_test(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c24_hyd_hyb_2_opt_cont_test
    ((SFc24_hyd_hyb_2_opt_cont_testInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c24_hyd_hyb_2_opt_cont_test
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c24_hyd_hyb_2_opt_cont_test(S);
}

static void sf_opaque_set_sim_state_c24_hyd_hyb_2_opt_cont_test(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c24_hyd_hyb_2_opt_cont_test(S, st);
}

static void sf_opaque_terminate_c24_hyd_hyb_2_opt_cont_test(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc24_hyd_hyb_2_opt_cont_testInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c24_hyd_hyb_2_opt_cont_test
      ((SFc24_hyd_hyb_2_opt_cont_testInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc24_hyd_hyb_2_opt_cont_test
    ((SFc24_hyd_hyb_2_opt_cont_testInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c24_hyd_hyb_2_opt_cont_test(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c24_hyd_hyb_2_opt_cont_test
      ((SFc24_hyd_hyb_2_opt_cont_testInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c24_hyd_hyb_2_opt_cont_test(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"hyd_hyb_2_opt_cont_test",
      "hyd_hyb_2_opt_cont_test",24);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"hyd_hyb_2_opt_cont_test",
                "hyd_hyb_2_opt_cont_test",24,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,
      "hyd_hyb_2_opt_cont_test","hyd_hyb_2_opt_cont_test",24,
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"hyd_hyb_2_opt_cont_test",
        "hyd_hyb_2_opt_cont_test",24,3);
      sf_mark_chart_reusable_outputs(S,"hyd_hyb_2_opt_cont_test",
        "hyd_hyb_2_opt_cont_test",24,2);
    }
...
static void mdlRTW_c24_hyd_hyb_2_opt_cont_test(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c24_hyd_hyb_2_opt_cont_test(SimStruct *S)
{
  SFc24_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance;
  chartInstance = (SFc24_hyd_hyb_2_opt_cont_testInstanceStruct *)malloc(sizeof
    (SFc24_hyd_hyb_2_opt_cont_testInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc24_hyd_hyb_2_opt_cont_testInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c24_hyd_hyb_2_opt_cont_test;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c24_hyd_hyb_2_opt_cont_test;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c24_hyd_hyb_2_opt_cont_test;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c24_hyd_hyb_2_opt_cont_test;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c24_hyd_hyb_2_opt_cont_test;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c24_hyd_hyb_2_opt_cont_test;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c24_hyd_hyb_2_opt_cont_test;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c24_hyd_hyb_2_opt_cont_test;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c24_hyd_hyb_2_opt_cont_test;
  chartInstance->chartInfo.mdlStart = mdlStart_c24_hyd_hyb_2_opt_cont_test;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c24_hyd_hyb_2_opt_cont_test;
...
void c24_hyd_hyb_2_opt_cont_test_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c24_hyd_hyb_2_opt_cont_test(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c24_hyd_hyb_2_opt_cont_test(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c24_hyd_hyb_2_opt_cont_test(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c24_hyd_hyb_2_opt_cont_test_method_dispatcher.\n"
