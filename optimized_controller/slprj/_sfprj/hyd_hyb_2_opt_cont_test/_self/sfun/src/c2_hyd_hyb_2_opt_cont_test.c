...
static void initialize_c2_hyd_hyb_2_opt_cont_test
  (SFc2_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance);
static void initialize_params_c2_hyd_hyb_2_opt_cont_test
  (SFc2_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance);
static void enable_c2_hyd_hyb_2_opt_cont_test
  (SFc2_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance);
static void disable_c2_hyd_hyb_2_opt_cont_test
  (SFc2_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_hyd_hyb_2_opt_cont_test
  (SFc2_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_hyd_hyb_2_opt_cont_test
  (SFc2_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance);
static void set_sim_state_c2_hyd_hyb_2_opt_cont_test
  (SFc2_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance, const mxArray
   *c2_st);
static void c2_set_sim_state_side_effects_c2_hyd_hyb_2_opt_cont_test
  (SFc2_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance);
static void finalize_c2_hyd_hyb_2_opt_cont_test
  (SFc2_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance);
static void sf_c2_hyd_hyb_2_opt_cont_test
  (SFc2_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance);
static void c2_chartstep_c2_hyd_hyb_2_opt_cont_test
  (SFc2_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance);
static void initSimStructsc2_hyd_hyb_2_opt_cont_test
  (SFc2_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static int32_T c2_emlrt_marshallIn(SFc2_hyd_hyb_2_opt_cont_testInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static uint8_T c2_b_emlrt_marshallIn(SFc2_hyd_hyb_2_opt_cont_testInstanceStruct *
  chartInstance, const mxArray *c2_b_tp_fourth, const char_T *c2_identifier);
static uint8_T c2_c_emlrt_marshallIn(SFc2_hyd_hyb_2_opt_cont_testInstanceStruct *
  chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_d_emlrt_marshallIn(SFc2_hyd_hyb_2_opt_cont_testInstanceStruct
  *chartInstance, const mxArray *c2_gear, const char_T *c2_identifier);
static real_T c2_e_emlrt_marshallIn(SFc2_hyd_hyb_2_opt_cont_testInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint32_T c2_f_emlrt_marshallIn(SFc2_hyd_hyb_2_opt_cont_testInstanceStruct
  *chartInstance, const mxArray *c2_b_temporalCounter_i1, const char_T
  *c2_identifier);
static uint32_T c2_g_emlrt_marshallIn(SFc2_hyd_hyb_2_opt_cont_testInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
static void init_dsm_address_info(SFc2_hyd_hyb_2_opt_cont_testInstanceStruct
  *chartInstance);
  ...
  (SFc2_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_hyd_hyb_2_opt_cont_test = 0U;
  chartInstance->c2_is_c2_hyd_hyb_2_opt_cont_test = 0U;
  ...
  (SFc2_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance)
{
  ...
  c2_c_hoistedGlobal = chartInstance->c2_is_active_c2_hyd_hyb_2_opt_cont_test;
  c2_c_u = c2_c_hoistedGlobal;
  c2_d_y = NULL;
  sf_mex_assign(&c2_d_y, sf_mex_create("y", &c2_c_u, 3, 0U, 0U, 0U, 0));
  sf_mex_setcell(c2_y, 2, c2_d_y);
  c2_d_hoistedGlobal = chartInstance->c2_is_c2_hyd_hyb_2_opt_cont_test;
   ...
   *c2_st)
{
  ...
  *c2_gear = c2_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u,
    1)), "gear");
  chartInstance->c2_is_active_c2_hyd_hyb_2_opt_cont_test = c2_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 2)),
     "is_active_c2_hyd_hyb_2_opt_cont_test");
  chartInstance->c2_is_c2_hyd_hyb_2_opt_cont_test = c2_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 3)),
     "is_c2_hyd_hyb_2_opt_cont_test");
  ...
  c2_update_debugger_state_c2_hyd_hyb_2_opt_cont_test(chartInstance);
  ...
  (SFc2_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance)
{
  ...
  c2_set_sim_state_side_effects_c2_hyd_hyb_2_opt_cont_test(chartInstance);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  ...
  c2_chartstep_c2_hyd_hyb_2_opt_cont_test(chartInstance);
  ...
  (SFc2_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance)
{
  ...
  if ((int16_T)chartInstance->c2_is_active_c2_hyd_hyb_2_opt_cont_test == 0) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 1U, chartInstance->c2_sfEvent);
    chartInstance->c2_is_active_c2_hyd_hyb_2_opt_cont_test = 1U;
    ...
    chartInstance->c2_is_c2_hyd_hyb_2_opt_cont_test = c2_IN_firstc;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c2_sfEvent);
    chartInstance->c2_temporalCounter_i1 = 0U;
    chartInstance->c2_tp_firstc = 1U;
    *c2_gear = 1.0;
    ...
    *c2_TC = 0.0;
    ...
    switch (chartInstance->c2_is_c2_hyd_hyb_2_opt_cont_test) {
     case c2_IN_first:
      CV_CHART_EVAL(1, 0, 1);
      ...
      if (CV_TRANSITION_EVAL(1U, (int32_T)c2_b_temp)) {
        ...
        chartInstance->c2_tp_first = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c2_sfEvent);
        chartInstance->c2_is_c2_hyd_hyb_2_opt_cont_test = c2_IN_second;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, chartInstance->c2_sfEvent);
        chartInstance->c2_temporalCounter_i1 = 0U;
        chartInstance->c2_tp_second = 1U;
        *c2_gear = 2.0;
     ...
     case c2_IN_firstc:
      ...
      if (CV_TRANSITION_EVAL(3U, (int32_T)c2_f_temp)) {
        ...
        chartInstance->c2_tp_firstc = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c2_sfEvent);
        chartInstance->c2_is_c2_hyd_hyb_2_opt_cont_test = c2_IN_first;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c2_sfEvent);
        chartInstance->c2_temporalCounter_i1 = 0U;
        chartInstance->c2_tp_first = 1U;
        *c2_TC = 1.0;
     ...
     case c2_IN_fourth:
      ...
      if (CV_TRANSITION_EVAL(6U, (int32_T)c2_h_temp)) {
        ...
        chartInstance->c2_tp_fourth = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, chartInstance->c2_sfEvent);
        chartInstance->c2_is_c2_hyd_hyb_2_opt_cont_test = c2_IN_third;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 4U, chartInstance->c2_sfEvent);
        chartInstance->c2_temporalCounter_i1 = 0U;
        chartInstance->c2_tp_third = 1U;
        *c2_gear = 3.0;
     ...
     case c2_IN_third:
      ...
      if (CV_TRANSITION_EVAL(2U, (int32_T)c2_n_temp)) {
        ...
        chartInstance->c2_tp_third = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 4U, chartInstance->c2_sfEvent);
        chartInstance->c2_is_c2_hyd_hyb_2_opt_cont_test = c2_IN_fourth;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c2_sfEvent);
        chartInstance->c2_temporalCounter_i1 = 0U;
        chartInstance->c2_tp_fourth = 1U;
        *c2_gear = 4.0;
     ...
     default:
      CV_CHART_EVAL(1, 0, 0);
      chartInstance->c2_is_c2_hyd_hyb_2_opt_cont_test = (uint8_T)
...
const mxArray *sf_c2_hyd_hyb_2_opt_cont_test_get_eml_resolved_functions_info
  (void)
{
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance;
  chartInstance = (SFc2_hyd_hyb_2_opt_cont_testInstanceStruct *)
    chartInstanceVoid;
...
/* SFunction Glue Code */
void sf_c2_hyd_hyb_2_opt_cont_test_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_hyd_hyb_2_opt_cont_test_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_hyd_hyb_2_opt_cont_test(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[17],T\"TC\",},{M[1],M[16],T\"gear\",},{M[8],M[0],T\"is_active_c2_hyd_hyb_2_opt_cont_test\",},{M[9],M[0],T\"is_c2_hyd_hyb_2_opt_cont_test\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"wu\",M1x5[3 4 2 5 1],M[1]}}}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_hyd_hyb_2_opt_cont_test_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c2_hyd_hyb_2_opt_cont_test(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_hyd_hyb_2_opt_cont_testInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_hyd_hyb_2_opt_cont_test
    ((SFc2_hyd_hyb_2_opt_cont_testInstanceStruct*) chartInstanceVar);
  initialize_c2_hyd_hyb_2_opt_cont_test
    ((SFc2_hyd_hyb_2_opt_cont_testInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_hyd_hyb_2_opt_cont_test(void *chartInstanceVar)
{
  enable_c2_hyd_hyb_2_opt_cont_test((SFc2_hyd_hyb_2_opt_cont_testInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_hyd_hyb_2_opt_cont_test(void *chartInstanceVar)
{
  disable_c2_hyd_hyb_2_opt_cont_test((SFc2_hyd_hyb_2_opt_cont_testInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_hyd_hyb_2_opt_cont_test(void *chartInstanceVar)
{
  sf_c2_hyd_hyb_2_opt_cont_test((SFc2_hyd_hyb_2_opt_cont_testInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_hyd_hyb_2_opt_cont_test
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_hyd_hyb_2_opt_cont_test
    ((SFc2_hyd_hyb_2_opt_cont_testInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_hyd_hyb_2_opt_cont_test();/* state var info */
...
extern void sf_internal_set_sim_state_c2_hyd_hyb_2_opt_cont_test(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_hyd_hyb_2_opt_cont_test
    ((SFc2_hyd_hyb_2_opt_cont_testInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_hyd_hyb_2_opt_cont_test
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c2_hyd_hyb_2_opt_cont_test(S);
}

static void sf_opaque_set_sim_state_c2_hyd_hyb_2_opt_cont_test(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c2_hyd_hyb_2_opt_cont_test(S, st);
}

static void sf_opaque_terminate_c2_hyd_hyb_2_opt_cont_test(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_hyd_hyb_2_opt_cont_testInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_hyd_hyb_2_opt_cont_test
      ((SFc2_hyd_hyb_2_opt_cont_testInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_hyd_hyb_2_opt_cont_test
    ((SFc2_hyd_hyb_2_opt_cont_testInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_hyd_hyb_2_opt_cont_test(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_hyd_hyb_2_opt_cont_test
      ((SFc2_hyd_hyb_2_opt_cont_testInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_hyd_hyb_2_opt_cont_test(SimStruct *S)
{
...
static void mdlRTW_c2_hyd_hyb_2_opt_cont_test(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_hyd_hyb_2_opt_cont_test(SimStruct *S)
{
  SFc2_hyd_hyb_2_opt_cont_testInstanceStruct *chartInstance;
  chartInstance = (SFc2_hyd_hyb_2_opt_cont_testInstanceStruct *)malloc(sizeof
    (SFc2_hyd_hyb_2_opt_cont_testInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_hyd_hyb_2_opt_cont_testInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_hyd_hyb_2_opt_cont_test;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_hyd_hyb_2_opt_cont_test;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_hyd_hyb_2_opt_cont_test;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_hyd_hyb_2_opt_cont_test;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_hyd_hyb_2_opt_cont_test;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_hyd_hyb_2_opt_cont_test;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_hyd_hyb_2_opt_cont_test;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_hyd_hyb_2_opt_cont_test;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_hyd_hyb_2_opt_cont_test;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_hyd_hyb_2_opt_cont_test;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_hyd_hyb_2_opt_cont_test;
...
void c2_hyd_hyb_2_opt_cont_test_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_hyd_hyb_2_opt_cont_test(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_hyd_hyb_2_opt_cont_test(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_hyd_hyb_2_opt_cont_test(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_hyd_hyb_2_opt_cont_test_method_dispatcher.\n"
