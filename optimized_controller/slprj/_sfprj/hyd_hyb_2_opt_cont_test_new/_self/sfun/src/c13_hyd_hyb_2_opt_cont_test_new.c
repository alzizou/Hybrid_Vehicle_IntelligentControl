...
static void initialize_c13_hyd_hyb_2_opt_cont_test_new
  (SFc13_hyd_hyb_2_opt_cont_test_newInstanceStruct *chartInstance);
static void initialize_params_c13_hyd_hyb_2_opt_cont_test_new
  (SFc13_hyd_hyb_2_opt_cont_test_newInstanceStruct *chartInstance);
static void enable_c13_hyd_hyb_2_opt_cont_test_new
  (SFc13_hyd_hyb_2_opt_cont_test_newInstanceStruct *chartInstance);
static void disable_c13_hyd_hyb_2_opt_cont_test_new
  (SFc13_hyd_hyb_2_opt_cont_test_newInstanceStruct *chartInstance);
static void c13_update_debugger_state_c13_hyd_hyb_2_opt_cont_test_new
  (SFc13_hyd_hyb_2_opt_cont_test_newInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c13_hyd_hyb_2_opt_cont_test_new
  (SFc13_hyd_hyb_2_opt_cont_test_newInstanceStruct *chartInstance);
static void set_sim_state_c13_hyd_hyb_2_opt_cont_test_new
  (SFc13_hyd_hyb_2_opt_cont_test_newInstanceStruct *chartInstance, const mxArray
   *c13_st);
static void finalize_c13_hyd_hyb_2_opt_cont_test_new
  (SFc13_hyd_hyb_2_opt_cont_test_newInstanceStruct *chartInstance);
static void sf_c13_hyd_hyb_2_opt_cont_test_new
  (SFc13_hyd_hyb_2_opt_cont_test_newInstanceStruct *chartInstance);
static void initSimStructsc13_hyd_hyb_2_opt_cont_test_new
  (SFc13_hyd_hyb_2_opt_cont_test_newInstanceStruct *chartInstance);
...
static uint8_T c13_d_emlrt_marshallIn
  (SFc13_hyd_hyb_2_opt_cont_test_newInstanceStruct *chartInstance, const mxArray
   *c13_b_is_active_c13_hyd_hyb_2_opt_cont_test_new, const char_T
   *c13_identifier);
  ...
  (SFc13_hyd_hyb_2_opt_cont_test_newInstanceStruct *chartInstance)
{
  ...
  chartInstance->c13_is_active_c13_hyd_hyb_2_opt_cont_test_new = 0U;
}
  ...
  (SFc13_hyd_hyb_2_opt_cont_test_newInstanceStruct *chartInstance)
{
  ...
  c13_b_hoistedGlobal =
    chartInstance->c13_is_active_c13_hyd_hyb_2_opt_cont_test_new;
   ...
   *c13_st)
{
  ...
  *c13_y = c13_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c13_u,
  ...
  chartInstance->c13_is_active_c13_hyd_hyb_2_opt_cont_test_new =
    ...
    "is_active_c13_hyd_hyb_2_opt_cont_test_new");
  sf_mex_destroy(&c13_u);
  c13_update_debugger_state_c13_hyd_hyb_2_opt_cont_test_new(chartInstance);
  ...
  *c13_inData)
{
  ...
  const mxArray *c13_y = NULL;
  SFc13_hyd_hyb_2_opt_cont_test_newInstanceStruct *chartInstance;
  chartInstance = (SFc13_hyd_hyb_2_opt_cont_test_newInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c13_hyd_hyb_2_opt_cont_test_new_get_eml_resolved_functions_info(void)
{
   ...
   *c13_identifier)
{
  ...
  c13_y = c13_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c13_b_is_active_c13_hyd_hyb_2_opt_cont_test_new), &c13_thisId);
  sf_mex_destroy(&c13_b_is_active_c13_hyd_hyb_2_opt_cont_test_new);
  return c13_y;
}
...
/* SFunction Glue Code */
void sf_c13_hyd_hyb_2_opt_cont_test_new_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c13_hyd_hyb_2_opt_cont_test_new_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c13_hyd_hyb_2_opt_cont_test_new(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c13_hyd_hyb_2_opt_cont_test_new\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c13_hyd_hyb_2_opt_cont_test_new_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c13_hyd_hyb_2_opt_cont_test_new(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc13_hyd_hyb_2_opt_cont_test_newInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c13_hyd_hyb_2_opt_cont_test_new
    ((SFc13_hyd_hyb_2_opt_cont_test_newInstanceStruct*) chartInstanceVar);
  initialize_c13_hyd_hyb_2_opt_cont_test_new
    ((SFc13_hyd_hyb_2_opt_cont_test_newInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c13_hyd_hyb_2_opt_cont_test_new(void
  *chartInstanceVar)
{
  enable_c13_hyd_hyb_2_opt_cont_test_new
    ((SFc13_hyd_hyb_2_opt_cont_test_newInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c13_hyd_hyb_2_opt_cont_test_new(void
  *chartInstanceVar)
{
  disable_c13_hyd_hyb_2_opt_cont_test_new
    ((SFc13_hyd_hyb_2_opt_cont_test_newInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c13_hyd_hyb_2_opt_cont_test_new(void
  *chartInstanceVar)
{
  sf_c13_hyd_hyb_2_opt_cont_test_new
    ((SFc13_hyd_hyb_2_opt_cont_test_newInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c13_hyd_hyb_2_opt_cont_test_new
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c13_hyd_hyb_2_opt_cont_test_new
    ((SFc13_hyd_hyb_2_opt_cont_test_newInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c13_hyd_hyb_2_opt_cont_test_new();/* state var info */
...
extern void sf_internal_set_sim_state_c13_hyd_hyb_2_opt_cont_test_new(SimStruct*
  S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c13_hyd_hyb_2_opt_cont_test_new
    ((SFc13_hyd_hyb_2_opt_cont_test_newInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c13_hyd_hyb_2_opt_cont_test_new
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c13_hyd_hyb_2_opt_cont_test_new(S);
}

static void sf_opaque_set_sim_state_c13_hyd_hyb_2_opt_cont_test_new(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c13_hyd_hyb_2_opt_cont_test_new(S, st);
}

static void sf_opaque_terminate_c13_hyd_hyb_2_opt_cont_test_new(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc13_hyd_hyb_2_opt_cont_test_newInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c13_hyd_hyb_2_opt_cont_test_new
      ((SFc13_hyd_hyb_2_opt_cont_test_newInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc13_hyd_hyb_2_opt_cont_test_new
    ((SFc13_hyd_hyb_2_opt_cont_test_newInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c13_hyd_hyb_2_opt_cont_test_new(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c13_hyd_hyb_2_opt_cont_test_new
      ((SFc13_hyd_hyb_2_opt_cont_test_newInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c13_hyd_hyb_2_opt_cont_test_new(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"hyd_hyb_2_opt_cont_test_new",
      "hyd_hyb_2_opt_cont_test_new",13);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"hyd_hyb_2_opt_cont_test_new",
                "hyd_hyb_2_opt_cont_test_new",13,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,
      "hyd_hyb_2_opt_cont_test_new","hyd_hyb_2_opt_cont_test_new",13,
      "gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"hyd_hyb_2_opt_cont_test_new",
        "hyd_hyb_2_opt_cont_test_new",13,2);
      sf_mark_chart_reusable_outputs(S,"hyd_hyb_2_opt_cont_test_new",
        "hyd_hyb_2_opt_cont_test_new",13,1);
    }
...
static void mdlRTW_c13_hyd_hyb_2_opt_cont_test_new(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c13_hyd_hyb_2_opt_cont_test_new(SimStruct *S)
{
  SFc13_hyd_hyb_2_opt_cont_test_newInstanceStruct *chartInstance;
  chartInstance = (SFc13_hyd_hyb_2_opt_cont_test_newInstanceStruct *)malloc
    (sizeof(SFc13_hyd_hyb_2_opt_cont_test_newInstanceStruct));
  memset(chartInstance, 0, sizeof
         (SFc13_hyd_hyb_2_opt_cont_test_newInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c13_hyd_hyb_2_opt_cont_test_new;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c13_hyd_hyb_2_opt_cont_test_new;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c13_hyd_hyb_2_opt_cont_test_new;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c13_hyd_hyb_2_opt_cont_test_new;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c13_hyd_hyb_2_opt_cont_test_new;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c13_hyd_hyb_2_opt_cont_test_new;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c13_hyd_hyb_2_opt_cont_test_new;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c13_hyd_hyb_2_opt_cont_test_new;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c13_hyd_hyb_2_opt_cont_test_new;
  chartInstance->chartInfo.mdlStart = mdlStart_c13_hyd_hyb_2_opt_cont_test_new;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c13_hyd_hyb_2_opt_cont_test_new;
...
void c13_hyd_hyb_2_opt_cont_test_new_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c13_hyd_hyb_2_opt_cont_test_new(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c13_hyd_hyb_2_opt_cont_test_new(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c13_hyd_hyb_2_opt_cont_test_new(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c13_hyd_hyb_2_opt_cont_test_new_method_dispatcher.\n"
