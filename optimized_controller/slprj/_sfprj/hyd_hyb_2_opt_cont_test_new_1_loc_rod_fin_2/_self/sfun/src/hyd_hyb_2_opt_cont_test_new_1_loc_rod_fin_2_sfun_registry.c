  ...
  const mxArray * prhs[] )
{
  ...
  if (sf_hyd_hyb_2_opt_cont_test_new_1_loc_rod_fin_2_process_check_sum_call(nlhs,
       plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int
    sf_hyd_hyb_2_opt_cont_test_new_1_loc_rod_fin_2_autoinheritance_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "hyd_hyb_2_opt_cont_test_new_1_loc_rod_fin_2") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_hyd_hyb_2_opt_cont_test_new_1_loc_rod_fin_2_autoinheritance_info
      (nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_hyd_hyb_2_opt_cont_test_new_1_loc_rod_fin_2_third_party_uses_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "hyd_hyb_2_opt_cont_test_new_1_loc_rod_fin_2") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_hyd_hyb_2_opt_cont_test_new_1_loc_rod_fin_2_third_party_uses_info
      (nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_hyd_hyb_2_opt_cont_test_new_1_loc_rod_fin_2_updateBuildInfo_args_info
...
extern unsigned int
  sf_hyd_hyb_2_opt_cont_test_new_1_loc_rod_fin_2_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"hyd_hyb_2_opt_cont_test_new_1_loc_rod_fin_2")) {
    return(sf_hyd_hyb_2_opt_cont_test_new_1_loc_rod_fin_2_method_dispatcher
...
extern void hyd_hyb_2_opt_cont_test_new_1_loc_rod_fin_2_terminator(void);
void sf_machine_global_terminator(void)
{
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    hyd_hyb_2_opt_cont_test_new_1_loc_rod_fin_2_terminator();
...
extern void hyd_hyb_2_opt_cont_test_new_1_loc_rod_fin_2_initializer(void);
extern void
  hyd_hyb_2_opt_cont_test_new_1_loc_rod_fin_2_register_exported_symbols
  (SimStruct* S);
extern void hyd_hyb_2_opt_cont_test_new_1_loc_rod_fin_2_debug_initialize(struct
  SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  hyd_hyb_2_opt_cont_test_new_1_loc_rod_fin_2_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      hyd_hyb_2_opt_cont_test_new_1_loc_rod_fin_2_debug_initialize
        (sfGlobalDebugInstanceStruct);
    }

    hyd_hyb_2_opt_cont_test_new_1_loc_rod_fin_2_initializer();
  }
