...
#include "hyd_hyb_2_worth_sfun.h"
#include "c5_hyd_hyb_2_worth.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "hyd_hyb_2_worth_sfun_debug_macros.h"
...
static void initialize_c5_hyd_hyb_2_worth(SFc5_hyd_hyb_2_worthInstanceStruct
  *chartInstance);
static void initialize_params_c5_hyd_hyb_2_worth
  (SFc5_hyd_hyb_2_worthInstanceStruct *chartInstance);
static void enable_c5_hyd_hyb_2_worth(SFc5_hyd_hyb_2_worthInstanceStruct
  *chartInstance);
static void disable_c5_hyd_hyb_2_worth(SFc5_hyd_hyb_2_worthInstanceStruct
  *chartInstance);
static void c5_update_debugger_state_c5_hyd_hyb_2_worth
  (SFc5_hyd_hyb_2_worthInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_hyd_hyb_2_worth
  (SFc5_hyd_hyb_2_worthInstanceStruct *chartInstance);
static void set_sim_state_c5_hyd_hyb_2_worth(SFc5_hyd_hyb_2_worthInstanceStruct *
  chartInstance, const mxArray *c5_st);
static void c5_set_sim_state_side_effects_c5_hyd_hyb_2_worth
  (SFc5_hyd_hyb_2_worthInstanceStruct *chartInstance);
static void finalize_c5_hyd_hyb_2_worth(SFc5_hyd_hyb_2_worthInstanceStruct
  *chartInstance);
static void sf_c5_hyd_hyb_2_worth(SFc5_hyd_hyb_2_worthInstanceStruct
  *chartInstance);
static void c5_chartstep_c5_hyd_hyb_2_worth(SFc5_hyd_hyb_2_worthInstanceStruct
  *chartInstance);
static void initSimStructsc5_hyd_hyb_2_worth(SFc5_hyd_hyb_2_worthInstanceStruct *
  chartInstance);
static void c5_state1(SFc5_hyd_hyb_2_worthInstanceStruct *chartInstance);
static void c5_state3(SFc5_hyd_hyb_2_worthInstanceStruct *chartInstance);
static void c5_exit_internal_state3(SFc5_hyd_hyb_2_worthInstanceStruct
  *chartInstance);
static void c5_enter_internal_state2(SFc5_hyd_hyb_2_worthInstanceStruct
  *chartInstance);
static void c5_exit_internal_state2(SFc5_hyd_hyb_2_worthInstanceStruct
  *chartInstance);
static void c5_exit_internal_state4(SFc5_hyd_hyb_2_worthInstanceStruct
  *chartInstance);
static void c5_enter_internal_state1(SFc5_hyd_hyb_2_worthInstanceStruct
  *chartInstance);
static void c5_b_state1(SFc5_hyd_hyb_2_worthInstanceStruct *chartInstance);
static void c5_exit_internal_state1(SFc5_hyd_hyb_2_worthInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static int32_T c5_emlrt_marshallIn(SFc5_hyd_hyb_2_worthInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_b_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static uint8_T c5_b_emlrt_marshallIn(SFc5_hyd_hyb_2_worthInstanceStruct
  *chartInstance, const mxArray *c5_f_tp_state1, const char_T *c5_identifier);
static uint8_T c5_c_emlrt_marshallIn(SFc5_hyd_hyb_2_worthInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_c_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static real_T c5_d_emlrt_marshallIn(SFc5_hyd_hyb_2_worthInstanceStruct
  *chartInstance, const mxArray *c5_T_eng, const char_T *c5_identifier);
static real_T c5_e_emlrt_marshallIn(SFc5_hyd_hyb_2_worthInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static uint32_T c5_f_emlrt_marshallIn(SFc5_hyd_hyb_2_worthInstanceStruct
  *chartInstance, const mxArray *c5_b_temporalCounter_i2, const char_T
  *c5_identifier);
static uint32_T c5_g_emlrt_marshallIn(SFc5_hyd_hyb_2_worthInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static const mxArray *c5_h_emlrt_marshallIn(SFc5_hyd_hyb_2_worthInstanceStruct
  *chartInstance, const mxArray *c5_b_setSimStateSideEffectsInfo, const char_T
  *c5_identifier);
static const mxArray *c5_i_emlrt_marshallIn(SFc5_hyd_hyb_2_worthInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void init_dsm_address_info(SFc5_hyd_hyb_2_worthInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_hyd_hyb_2_worth = 0U;
  chartInstance->c5_is_c5_hyd_hyb_2_worth = 0U;
  ...
  (SFc5_hyd_hyb_2_worthInstanceStruct *chartInstance)
{
  ...
  if ((int16_T)chartInstance->c5_is_active_c5_hyd_hyb_2_worth == 1) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 3U, chartInstance->c5_sfEvent);
  }

  if (chartInstance->c5_is_c5_hyd_hyb_2_worth == c5_IN_state1) {
  ...
  if (chartInstance->c5_is_c5_hyd_hyb_2_worth == c5_IN_state3) {
  ...
  if (chartInstance->c5_is_c5_hyd_hyb_2_worth == c5_IN_state2) {
  ...
  if (chartInstance->c5_is_c5_hyd_hyb_2_worth == c5_IN_state4) {
  ...
  (SFc5_hyd_hyb_2_worthInstanceStruct *chartInstance)
{
  ...
  c5_d_hoistedGlobal = chartInstance->c5_is_active_c5_hyd_hyb_2_worth;
  c5_d_u = c5_d_hoistedGlobal;
  c5_e_y = NULL;
  sf_mex_assign(&c5_e_y, sf_mex_create("y", &c5_d_u, 3, 0U, 0U, 0U, 0));
  sf_mex_setcell(c5_y, 3, c5_e_y);
  c5_e_hoistedGlobal = chartInstance->c5_is_c5_hyd_hyb_2_worth;
  ...
  chartInstance, const mxArray *c5_st)
{
  ...
  *c5_eng_on = c5_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c5_u, 2)), "eng_on");
  chartInstance->c5_is_active_c5_hyd_hyb_2_worth = c5_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 3)),
     "is_active_c5_hyd_hyb_2_worth");
  chartInstance->c5_is_c5_hyd_hyb_2_worth = c5_b_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c5_u, 4)), "is_c5_hyd_hyb_2_worth");
  ...
  c5_update_debugger_state_c5_hyd_hyb_2_worth(chartInstance);
  ...
  *chartInstance)
{
  ...
  c5_set_sim_state_side_effects_c5_hyd_hyb_2_worth(chartInstance);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  ...
  chartInstance->c5_sfEvent = CALL_EVENT;
  c5_chartstep_c5_hyd_hyb_2_worth(chartInstance);
  sf_debug_check_for_state_inconsistency(_hyd_hyb_2_worthMachineNumber_,
  ...
  *chartInstance)
{
  ...
  if ((int16_T)chartInstance->c5_is_active_c5_hyd_hyb_2_worth == 0) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 3U, chartInstance->c5_sfEvent);
    chartInstance->c5_is_active_c5_hyd_hyb_2_worth = 1U;
    ...
    chartInstance->c5_is_c5_hyd_hyb_2_worth = c5_IN_state1;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c5_sfEvent);
    chartInstance->c5_temporalCounter_i1 = 0U;
    chartInstance->c5_tp_state1 = 1U;
  } else {
    switch (chartInstance->c5_is_c5_hyd_hyb_2_worth) {
     case c5_IN_state1:
      CV_CHART_EVAL(3, 0, 1);
     ...
     case c5_IN_state2:
      ...
      if (CV_TRANSITION_EVAL(14U, (int32_T)_SFD_CCP_CALL(14U, 0, *c5_T_acc <=
        ...
        chartInstance->c5_b_tp_state2 = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c5_sfEvent);
        chartInstance->c5_is_c5_hyd_hyb_2_worth = c5_IN_state4;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 11U, chartInstance->c5_sfEvent);
        chartInstance->c5_temporalCounter_i1 = 0U;
        chartInstance->c5_tp_state4 = 1U;
        ...
        if (CV_TRANSITION_EVAL(17U, (int32_T)_SFD_CCP_CALL(17U, 0, *c5_soc <=
          ...
          chartInstance->c5_b_tp_state2 = 0U;
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c5_sfEvent);
          chartInstance->c5_is_c5_hyd_hyb_2_worth = c5_IN_state3;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 4U, chartInstance->c5_sfEvent);
          chartInstance->c5_tp_state3 = 1U;
      ...
      if (CV_TRANSITION_EVAL(16U, (int32_T)_SFD_CCP_CALL(16U, 0, *c5_soc <=
        ...
        if (CV_TRANSITION_EVAL(15U, (int32_T)c5_c_temp)) {
          ...
          if (CV_TRANSITION_EVAL(20U, (int32_T)c5_e_temp)) {
            ...
            chartInstance->c5_tp_state4 = 0U;
            _SFD_CS_CALL(STATE_INACTIVE_TAG, 11U, chartInstance->c5_sfEvent);
            chartInstance->c5_is_c5_hyd_hyb_2_worth = c5_IN_state2;
            _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c5_sfEvent);
            chartInstance->c5_b_tp_state2 = 1U;
     ...
     default:
      CV_CHART_EVAL(3, 0, 0);
      chartInstance->c5_is_c5_hyd_hyb_2_worth = (uint8_T)c5_IN_NO_ACTIVE_CHILD;
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c5_sfEvent);
      break;
    }
  }
...
const mxArray *sf_c5_hyd_hyb_2_worth_get_eml_resolved_functions_info(void)
{
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  const mxArray *c5_y = NULL;
  SFc5_hyd_hyb_2_worthInstanceStruct *chartInstance;
  chartInstance = (SFc5_hyd_hyb_2_worthInstanceStruct *)chartInstanceVoid;
...
/* SFunction Glue Code */
void sf_c5_hyd_hyb_2_worth_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c5_hyd_hyb_2_worth_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c5_hyd_hyb_2_worth(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[4],T\"T_eng\",},{M[1],M[6],T\"T_pm\",},{M[1],M[123],T\"eng_on\",},{M[8],M[0],T\"is_active_c5_hyd_hyb_2_worth\",},{M[9],M[0],T\"is_c5_hyd_hyb_2_worth\",},{M[9],M[12],T\"is_state2\",},{M[9],M[13],T\"is_state3\",},{M[9],M[65],T\"is_state4\",},{M[9],M[173],T\"is_state1\",},{M[11],M[0],T\"temporalCounter_i2\",S'et','os','ct'{{T\"at\",M[129],M[1]}}}}",
  ...
  sf_c5_hyd_hyb_2_worth_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc5_hyd_hyb_2_worthInstanceStruct *chartInstance;
    chartInstance = (SFc5_hyd_hyb_2_worthInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (_hyd_hyb_2_worthMachineNumber_,
           5,
           14,
           33,
           16,
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_hyd_hyb_2_worthMachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (_hyd_hyb_2_worthMachineNumber_,chartInstance->chartNumber,1);
          sf_debug_set_chart_event_thresholds(_hyd_hyb_2_worthMachineNumber_,
            chartInstance->chartNumber,
            0,
            0,
            0);
      ...
      sf_debug_reset_current_state_configuration(_hyd_hyb_2_worthMachineNumber_,
        chartInstance->chartNumber,chartInstance->instanceNumber);
    }
  }
}

static void sf_opaque_initialize_c5_hyd_hyb_2_worth(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_hyd_hyb_2_worthInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c5_hyd_hyb_2_worth((SFc5_hyd_hyb_2_worthInstanceStruct*)
    chartInstanceVar);
  initialize_c5_hyd_hyb_2_worth((SFc5_hyd_hyb_2_worthInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c5_hyd_hyb_2_worth(void *chartInstanceVar)
{
  enable_c5_hyd_hyb_2_worth((SFc5_hyd_hyb_2_worthInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c5_hyd_hyb_2_worth(void *chartInstanceVar)
{
  disable_c5_hyd_hyb_2_worth((SFc5_hyd_hyb_2_worthInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c5_hyd_hyb_2_worth(void *chartInstanceVar)
{
  sf_c5_hyd_hyb_2_worth((SFc5_hyd_hyb_2_worthInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c5_hyd_hyb_2_worth(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_hyd_hyb_2_worth
    ((SFc5_hyd_hyb_2_worthInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_hyd_hyb_2_worth();/* state var info */
...
extern void sf_internal_set_sim_state_c5_hyd_hyb_2_worth(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c5_hyd_hyb_2_worth((SFc5_hyd_hyb_2_worthInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c5_hyd_hyb_2_worth(SimStruct* S)
{
  return sf_internal_get_sim_state_c5_hyd_hyb_2_worth(S);
}

static void sf_opaque_set_sim_state_c5_hyd_hyb_2_worth(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c5_hyd_hyb_2_worth(S, st);
}

static void sf_opaque_terminate_c5_hyd_hyb_2_worth(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_hyd_hyb_2_worthInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c5_hyd_hyb_2_worth((SFc5_hyd_hyb_2_worthInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc5_hyd_hyb_2_worth((SFc5_hyd_hyb_2_worthInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_hyd_hyb_2_worth(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_hyd_hyb_2_worth(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"hyd_hyb_2_worth","hyd_hyb_2_worth",5);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"hyd_hyb_2_worth","hyd_hyb_2_worth",5,
                "RTWCG"));
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"hyd_hyb_2_worth",
      "hyd_hyb_2_worth",5,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"hyd_hyb_2_worth","hyd_hyb_2_worth",
        5,5);
      sf_mark_chart_reusable_outputs(S,"hyd_hyb_2_worth","hyd_hyb_2_worth",5,3);
    }

    sf_set_rtw_dwork_info(S,"hyd_hyb_2_worth","hyd_hyb_2_worth",5);
...
static void mdlRTW_c5_hyd_hyb_2_worth(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "hyd_hyb_2_worth", "hyd_hyb_2_worth",5);
    ssWriteRTWStrParam(S, "StateflowChartType", "Stateflow");
  }
}

static void mdlStart_c5_hyd_hyb_2_worth(SimStruct *S)
{
  SFc5_hyd_hyb_2_worthInstanceStruct *chartInstance;
  chartInstance = (SFc5_hyd_hyb_2_worthInstanceStruct *)malloc(sizeof
    (SFc5_hyd_hyb_2_worthInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_hyd_hyb_2_worthInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_hyd_hyb_2_worth;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_hyd_hyb_2_worth;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_hyd_hyb_2_worth;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c5_hyd_hyb_2_worth;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c5_hyd_hyb_2_worth;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_hyd_hyb_2_worth;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_hyd_hyb_2_worth;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_hyd_hyb_2_worth;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_hyd_hyb_2_worth;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_hyd_hyb_2_worth;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_hyd_hyb_2_worth;
...
void c5_hyd_hyb_2_worth_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_hyd_hyb_2_worth(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_hyd_hyb_2_worth(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_hyd_hyb_2_worth(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_hyd_hyb_2_worth_method_dispatcher.\n"
