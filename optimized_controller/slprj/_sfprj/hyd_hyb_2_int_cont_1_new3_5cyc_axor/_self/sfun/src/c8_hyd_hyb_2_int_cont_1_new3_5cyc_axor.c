...
#include "c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor.h"
...
static void initialize_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor
  (SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance);
static void initialize_params_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor
  (SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance);
static void enable_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor
  (SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance);
static void disable_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor
  (SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance);
static void c8_update_debugger_state_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor
  (SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor
  (SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance);
static void set_sim_state_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor
  (SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance, const
   mxArray *c8_st);
static void finalize_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor
  (SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance);
static void sf_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor
  (SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance);
static void initSimStructsc8_hyd_hyb_2_int_cont_1_new3_5cyc_axor
  (SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance);
...
static uint8_T c8_d_emlrt_marshallIn
  (SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance, const
   mxArray *c8_b_is_active_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor, const char_T *
   c8_identifier);
  ...
  (SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor = 0U;
}
  ...
  (SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance)
{
  ...
  c8_b_hoistedGlobal =
    chartInstance->c8_is_active_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor;
   ...
   mxArray *c8_st)
{
  ...
  *c8_y = c8_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 0)),
  ...
  chartInstance->c8_is_active_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor =
    ...
    "is_active_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor");
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor(chartInstance);
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  const mxArray *c8_y = NULL;
  SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance;
  chartInstance = (SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor_get_eml_resolved_functions_info
  (void)
{
   ...
   c8_identifier)
{
  ...
  c8_y = c8_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor);
  return c8_y;
}
...
/* SFunction Glue Code */
void sf_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor_get_autoinheritance_info(void)
{
...
static const mxArray
  *sf_get_sim_state_info_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct*) chartInstanceVar)
     ->S,0);
  initialize_params_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor
    ((SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct*) chartInstanceVar);
  initialize_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor
    ((SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor(void
  *chartInstanceVar)
{
  enable_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor
    ((SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor(void
  *chartInstanceVar)
{
  disable_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor
    ((SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor(void
  *chartInstanceVar)
{
  sf_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor
    ((SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor
    ((SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor();/* state var info */
...
extern void sf_internal_set_sim_state_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor
    ((SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor(SimStruct* S)
{
  return sf_internal_get_sim_state_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor(S);
}

static void sf_opaque_set_sim_state_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor(S, st);
}

static void sf_opaque_terminate_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor
      ((SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc8_hyd_hyb_2_int_cont_1_new3_5cyc_axor
    ((SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"hyd_hyb_2_int_cont_1_new3_5cyc_axor",
      "hyd_hyb_2_int_cont_1_new3_5cyc_axor",8);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"hyd_hyb_2_int_cont_1_new3_5cyc_axor",
                "hyd_hyb_2_int_cont_1_new3_5cyc_axor",8,"RTWCG"));
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,
        "hyd_hyb_2_int_cont_1_new3_5cyc_axor",
        "hyd_hyb_2_int_cont_1_new3_5cyc_axor",8,2);
      sf_mark_chart_reusable_outputs(S,"hyd_hyb_2_int_cont_1_new3_5cyc_axor",
        "hyd_hyb_2_int_cont_1_new3_5cyc_axor",8,1);
    }
...
static void mdlRTW_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor(SimStruct *S)
{
  SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance;
  chartInstance = (SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *)
    malloc(sizeof(SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor;
...
void c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_hyd_hyb_2_int_cont_1_new3_5cyc_axor_method_dispatcher.\n"
