...
#include "c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor.h"
...
static void initialize_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor
  (SFc1_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance);
static void initialize_params_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor
  (SFc1_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance);
static void enable_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor
  (SFc1_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance);
static void disable_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor
  (SFc1_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor
  (SFc1_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor
  (SFc1_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance);
static void set_sim_state_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor
  (SFc1_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance, const
   mxArray *c1_st);
static void c1_set_sim_state_side_effects_c1_hyd_hyb_2_int_cont_1_new3_5cyc_
  (SFc1_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance);
static void finalize_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor
  (SFc1_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance);
static void sf_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor
  (SFc1_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance);
static void initSimStructsc1_hyd_hyb_2_int_cont_1_new3_5cyc_axor
  (SFc1_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance);
  ...
  (SFc1_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor = 0U;
  chartInstance->c1_is_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor = 0U;
  ...
  (SFc1_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance)
{
  ...
  if ((int16_T)
      chartInstance->c1_is_active_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor == 1) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
  }

  if (chartInstance->c1_is_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor == c1_IN_Drive)
  {
  ...
  if (chartInstance->c1_is_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor ==
      c1_IN_Neutral) {
  ...
  (SFc1_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance)
{
  ...
  c1_b_hoistedGlobal =
    chartInstance->c1_is_active_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor;
  c1_b_u = c1_b_hoistedGlobal;
  c1_c_y = NULL;
  sf_mex_assign(&c1_c_y, sf_mex_create("y", &c1_b_u, 3, 0U, 0U, 0U, 0));
  sf_mex_setcell(c1_y, 1, c1_c_y);
  c1_c_hoistedGlobal =
    chartInstance->c1_is_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor;
   ...
   mxArray *c1_st)
{
  ...
  *c1_s = c1_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 0)),
  ...
  chartInstance->c1_is_active_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor =
    ...
    "is_active_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor");
  chartInstance->c1_is_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor =
    c1_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 2)),
    "is_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor");
  ...
  c1_update_debugger_state_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor(chartInstance);
  ...
  (SFc1_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance)
{
  ...
  c1_set_sim_state_side_effects_c1_hyd_hyb_2_int_cont_1_new3_5cyc_(chartInstance);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  ...
  if ((int16_T)
      chartInstance->c1_is_active_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor == 0) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
    chartInstance->c1_is_active_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
    _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 0U, chartInstance->c1_sfEvent);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
    chartInstance->c1_is_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor = c1_IN_Neutral;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c1_sfEvent);
    chartInstance->c1_tp_Neutral = 1U;
  } else {
    switch (chartInstance->c1_is_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor) {
     case c1_IN_Drive:
      CV_CHART_EVAL(0, 0, 1);
     ...
     default:
      CV_CHART_EVAL(0, 0, 0);
      chartInstance->c1_is_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor = (uint8_T)
...
const mxArray
  *sf_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor_get_eml_resolved_functions_info
  (void)
{
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance;
  chartInstance = (SFc1_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *)
    chartInstanceVoid;
...
/* SFunction Glue Code */
void sf_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor_get_autoinheritance_info(void)
{
...
static const mxArray
  *sf_get_sim_state_info_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[9],T\"s\",},{M[8],M[0],T\"is_active_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor\",},{M[9],M[0],T\"is_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"at\",M[2],M[1]}}},{M[13],M[0],T\"previousTicks\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc1_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct*) chartInstanceVar)
     ->S,0);
  initialize_params_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor
    ((SFc1_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct*) chartInstanceVar);
  initialize_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor
    ((SFc1_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor(void
  *chartInstanceVar)
{
  enable_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor
    ((SFc1_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor(void
  *chartInstanceVar)
{
  disable_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor
    ((SFc1_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor(void
  *chartInstanceVar)
{
  sf_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor
    ((SFc1_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor
    ((SFc1_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor();/* state var info */
...
extern void sf_internal_set_sim_state_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor
    ((SFc1_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor(S);
}

static void sf_opaque_set_sim_state_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor(S, st);
}

static void sf_opaque_terminate_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor
      ((SFc1_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc1_hyd_hyb_2_int_cont_1_new3_5cyc_axor
    ((SFc1_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor(SimStruct *S)
{
  ssSetNeedAbsoluteTime(S,1);
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"hyd_hyb_2_int_cont_1_new3_5cyc_axor",
      "hyd_hyb_2_int_cont_1_new3_5cyc_axor",1);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"hyd_hyb_2_int_cont_1_new3_5cyc_axor",
                "hyd_hyb_2_int_cont_1_new3_5cyc_axor",1,"RTWCG"));
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,
        "hyd_hyb_2_int_cont_1_new3_5cyc_axor",
        "hyd_hyb_2_int_cont_1_new3_5cyc_axor",1,2);
      sf_mark_chart_reusable_outputs(S,"hyd_hyb_2_int_cont_1_new3_5cyc_axor",
        "hyd_hyb_2_int_cont_1_new3_5cyc_axor",1,1);
    }
...
static void mdlRTW_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor(SimStruct *S)
{
  SFc1_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *chartInstance;
  chartInstance = (SFc1_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct *)
    malloc(sizeof(SFc1_hyd_hyb_2_int_cont_1_new3_5cyc_axorInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor;
...
void c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_hyd_hyb_2_int_cont_1_new3_5cyc_axor_method_dispatcher.\n"
