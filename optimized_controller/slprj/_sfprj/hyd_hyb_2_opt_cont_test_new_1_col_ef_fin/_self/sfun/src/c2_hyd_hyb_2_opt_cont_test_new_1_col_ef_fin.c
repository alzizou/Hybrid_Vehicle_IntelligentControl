...
#include "hyd_hyb_2_opt_cont_test_new_1_col_ef_fin_sfun.h"
#include "c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "hyd_hyb_2_opt_cont_test_new_1_col_ef_fin_sfun_debug_macros.h"
...
static void initialize_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin
  (SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct *chartInstance);
static void initialize_params_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin
  (SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct *chartInstance);
static void enable_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin
  (SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct *chartInstance);
static void disable_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin
  (SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef
  (SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin
  (SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct *chartInstance);
static void set_sim_state_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin
  (SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct *chartInstance,
   const mxArray *c2_st);
static void c2_set_sim_state_side_effects_c2_hyd_hyb_2_opt_cont_test_new_1_c
  (SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct *chartInstance);
static void finalize_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin
  (SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct *chartInstance);
static void sf_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin
  (SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct *chartInstance);
static void c2_chartstep_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin
  (SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct *chartInstance);
static void initSimStructsc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin
  (SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct *chartInstance);
...
static uint32_T c2_f_emlrt_marshallIn
  (SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct *chartInstance,
   const mxArray *c2_b_temporalCounter_i1, const char_T *c2_identifier);
  ...
  (SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin = 0U;
  chartInstance->c2_is_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin = 0U;
  ...
  (SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct *chartInstance)
{
  ...
  if ((int16_T)
      chartInstance->c2_is_active_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin ==
      1) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 1U, chartInstance->c2_sfEvent);
  }

  if (chartInstance->c2_is_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin ==
      c2_IN_fourth) {
  ...
  (SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct *chartInstance)
{
  ...
  c2_d_hoistedGlobal =
    chartInstance->c2_is_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin;
   ...
   const mxArray *c2_st)
{
  ...
  *c2_gear = c2_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u,
  ...
  chartInstance->c2_is_active_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin =
    ...
    "is_active_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin");
  chartInstance->c2_is_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin =
    c2_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 3)),
    "is_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin");
  ...
  c2_update_debugger_state_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef(chartInstance);
  ...
  (SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct *chartInstance)
{
  ...
  c2_set_sim_state_side_effects_c2_hyd_hyb_2_opt_cont_test_new_1_c(chartInstance);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  ...
  c2_chartstep_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin(chartInstance);
  sf_debug_check_for_state_inconsistency
    (_hyd_hyb_2_opt_cont_test_new_1_col_ef_finMachineNumber_,
  ...
  (SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct *chartInstance)
{
  ...
  if ((int16_T)
    ...
    chartInstance->c2_is_active_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin = 1U;
    ...
    *c2_TC = 0.0;
    ...
    switch (chartInstance->c2_is_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin) {
     case c2_IN_first:
      CV_CHART_EVAL(1, 0, 1);
...
const mxArray
  *sf_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin_get_eml_resolved_functions_info
  (void)
{
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct *chartInstance;
  chartInstance = (SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct *)
    chartInstanceVoid;
...
/* SFunction Glue Code */
void sf_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin_get_autoinheritance_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[17],T\"TC\",},{M[1],M[16],T\"gear\",},{M[8],M[0],T\"is_active_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin\",},{M[9],M[0],T\"is_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"wu\",M1x5[3 4 2 5 1],M[1]}}}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin
  (void *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin
    ((SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct*)
     chartInstanceVar);
  initialize_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin
    ((SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin(void
  *chartInstanceVar)
{
  enable_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin
    ((SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin(void
  *chartInstanceVar)
{
  disable_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin
    ((SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin(void
  *chartInstanceVar)
{
  sf_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin
    ((SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin
    ((SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin();/* state var info */
...
extern void
  sf_internal_set_sim_state_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin
    ((SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin(S);
}

static void sf_opaque_set_sim_state_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin(S, st);
}

static void sf_opaque_terminate_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin
      ((SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin
    ((SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin
  (SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"hyd_hyb_2_opt_cont_test_new_1_col_ef_fin",
      "hyd_hyb_2_opt_cont_test_new_1_col_ef_fin",2);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,
                "hyd_hyb_2_opt_cont_test_new_1_col_ef_fin",
                "hyd_hyb_2_opt_cont_test_new_1_col_ef_fin",2,"RTWCG"));
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,
        "hyd_hyb_2_opt_cont_test_new_1_col_ef_fin",
        "hyd_hyb_2_opt_cont_test_new_1_col_ef_fin",2,1);
      sf_mark_chart_reusable_outputs(S,
        "hyd_hyb_2_opt_cont_test_new_1_col_ef_fin",
        "hyd_hyb_2_opt_cont_test_new_1_col_ef_fin",2,2);
    }

    sf_set_rtw_dwork_info(S,"hyd_hyb_2_opt_cont_test_new_1_col_ef_fin",
                          "hyd_hyb_2_opt_cont_test_new_1_col_ef_fin",2);
...
static void mdlRTW_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "hyd_hyb_2_opt_cont_test_new_1_col_ef_fin",
      "hyd_hyb_2_opt_cont_test_new_1_col_ef_fin",2);
    ssWriteRTWStrParam(S, "StateflowChartType", "Stateflow");
  }
}

static void mdlStart_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin(SimStruct *S)
{
  SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct *chartInstance;
  chartInstance = (SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct *)
    malloc(sizeof(SFc2_hyd_hyb_2_opt_cont_test_new_1_col_ef_finInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin;
...
void c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_hyd_hyb_2_opt_cont_test_new_1_col_ef_fin_method_dispatcher.\n"
