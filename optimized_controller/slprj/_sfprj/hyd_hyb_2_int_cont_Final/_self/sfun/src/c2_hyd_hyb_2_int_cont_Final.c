...
static void initialize_c2_hyd_hyb_2_int_cont_Final
  (SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct *chartInstance);
static void initialize_params_c2_hyd_hyb_2_int_cont_Final
  (SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct *chartInstance);
static void enable_c2_hyd_hyb_2_int_cont_Final
  (SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct *chartInstance);
static void disable_c2_hyd_hyb_2_int_cont_Final
  (SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_hyd_hyb_2_int_cont_Final
  (SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_hyd_hyb_2_int_cont_Final
  (SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct *chartInstance);
static void set_sim_state_c2_hyd_hyb_2_int_cont_Final
  (SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct *chartInstance, const mxArray
   *c2_st);
static void c2_set_sim_state_side_effects_c2_hyd_hyb_2_int_cont_Final
  (SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct *chartInstance);
static void finalize_c2_hyd_hyb_2_int_cont_Final
  (SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct *chartInstance);
static void sf_c2_hyd_hyb_2_int_cont_Final
  (SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct *chartInstance);
static void c2_chartstep_c2_hyd_hyb_2_int_cont_Final
  (SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct *chartInstance);
static void initSimStructsc2_hyd_hyb_2_int_cont_Final
  (SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static int32_T c2_emlrt_marshallIn(SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static uint8_T c2_b_emlrt_marshallIn(SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct
  *chartInstance, const mxArray *c2_b_tp_fourth, const char_T *c2_identifier);
static uint8_T c2_c_emlrt_marshallIn(SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_d_emlrt_marshallIn(SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct *
  chartInstance, const mxArray *c2_gear, const char_T *c2_identifier);
static real_T c2_e_emlrt_marshallIn(SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct *
  chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
static const mxArray *c2_i_emlrt_marshallIn
  (SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct *chartInstance, const mxArray
   *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct
  *chartInstance);
  ...
  (SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_temporalCounter_i1 = 0U;
  chartInstance->c2_is_active_c2_hyd_hyb_2_int_cont_Final = 0U;
  chartInstance->c2_is_c2_hyd_hyb_2_int_cont_Final = c2_IN_NO_ACTIVE_CHILD;
  ...
  (SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct *chartInstance)
{
  ...
  c2_c_hoistedGlobal = chartInstance->c2_is_active_c2_hyd_hyb_2_int_cont_Final;
  c2_c_u = c2_c_hoistedGlobal;
  c2_d_y = NULL;
  sf_mex_assign(&c2_d_y, sf_mex_create("y", &c2_c_u, 3, 0U, 0U, 0U, 0), FALSE);
  sf_mex_setcell(c2_y, 2, c2_d_y);
  c2_d_hoistedGlobal = chartInstance->c2_is_c2_hyd_hyb_2_int_cont_Final;
   ...
   *c2_st)
{
  ...
  *c2_gear = c2_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u,
    1)), "gear");
  chartInstance->c2_is_active_c2_hyd_hyb_2_int_cont_Final =
    c2_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 2)),
    "is_active_c2_hyd_hyb_2_int_cont_Final");
  chartInstance->c2_is_c2_hyd_hyb_2_int_cont_Final = c2_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 3)),
     "is_c2_hyd_hyb_2_int_cont_Final");
  ...
  c2_update_debugger_state_c2_hyd_hyb_2_int_cont_Final(chartInstance);
  ...
  (SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct *chartInstance)
{
  ...
  c2_set_sim_state_side_effects_c2_hyd_hyb_2_int_cont_Final(chartInstance);
  ...
  c2_chartstep_c2_hyd_hyb_2_int_cont_Final(chartInstance);
  ...
  (SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c2_is_active_c2_hyd_hyb_2_int_cont_Final == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 1U, chartInstance->c2_sfEvent);
    chartInstance->c2_is_active_c2_hyd_hyb_2_int_cont_Final = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 1U, chartInstance->c2_sfEvent);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 4U, chartInstance->c2_sfEvent);
    chartInstance->c2_is_c2_hyd_hyb_2_int_cont_Final = c2_IN_firstc;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c2_sfEvent);
    chartInstance->c2_temporalCounter_i1 = 0U;
    chartInstance->c2_tp_firstc = 1U;
    *c2_gear = 1.0;
    ...
    *c2_TC = 0.0;
    ...
    switch (chartInstance->c2_is_c2_hyd_hyb_2_int_cont_Final) {
     case c2_IN_first:
      CV_CHART_EVAL(1, 0, 1);
      ...
      if (c2_out) {
        ...
        chartInstance->c2_tp_first = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c2_sfEvent);
        chartInstance->c2_is_c2_hyd_hyb_2_int_cont_Final = c2_IN_second;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, chartInstance->c2_sfEvent);
        chartInstance->c2_temporalCounter_i1 = 0U;
        chartInstance->c2_tp_second = 1U;
        *c2_gear = 2.0;
     ...
     case c2_IN_firstc:
      ...
      if (c2_c_out) {
        ...
        chartInstance->c2_tp_firstc = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c2_sfEvent);
        chartInstance->c2_is_c2_hyd_hyb_2_int_cont_Final = c2_IN_first;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c2_sfEvent);
        chartInstance->c2_temporalCounter_i1 = 0U;
        chartInstance->c2_tp_first = 1U;
        *c2_TC = 1.0;
     ...
     case c2_IN_fourth:
      ...
      if (c2_d_out) {
        ...
        chartInstance->c2_tp_fourth = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, chartInstance->c2_sfEvent);
        chartInstance->c2_is_c2_hyd_hyb_2_int_cont_Final = c2_IN_third;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 4U, chartInstance->c2_sfEvent);
        chartInstance->c2_temporalCounter_i1 = 0U;
        chartInstance->c2_tp_third = 1U;
        *c2_gear = 3.0;
     ...
     case c2_IN_third:
      ...
      if (c2_g_out) {
        ...
        chartInstance->c2_tp_third = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 4U, chartInstance->c2_sfEvent);
        chartInstance->c2_is_c2_hyd_hyb_2_int_cont_Final = c2_IN_fourth;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c2_sfEvent);
        chartInstance->c2_temporalCounter_i1 = 0U;
        chartInstance->c2_tp_fourth = 1U;
        *c2_gear = 4.0;
...
const mxArray *sf_c2_hyd_hyb_2_int_cont_Final_get_eml_resolved_functions_info
  (void)
{
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct *chartInstance;
  chartInstance = (SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct *)
    chartInstanceVoid;
...
void sf_c2_hyd_hyb_2_int_cont_Final_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_hyd_hyb_2_int_cont_Final_get_autoinheritance_info(void)
{
...
mxArray *sf_c2_hyd_hyb_2_int_cont_Final_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_hyd_hyb_2_int_cont_Final_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_hyd_hyb_2_int_cont_Final(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[17],T\"TC\",},{M[1],M[16],T\"gear\",},{M[8],M[0],T\"is_active_c2_hyd_hyb_2_int_cont_Final\",},{M[9],M[0],T\"is_c2_hyd_hyb_2_int_cont_Final\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"wu\",M1x5[3 4 2 5 1],M[1]}}}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_hyd_hyb_2_int_cont_Final_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c2_hyd_hyb_2_int_cont_Final(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_hyd_hyb_2_int_cont_Final
    ((SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct*) chartInstanceVar);
  initialize_c2_hyd_hyb_2_int_cont_Final
    ((SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_hyd_hyb_2_int_cont_Final(void *chartInstanceVar)
{
  enable_c2_hyd_hyb_2_int_cont_Final
    ((SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_hyd_hyb_2_int_cont_Final(void *chartInstanceVar)
{
  disable_c2_hyd_hyb_2_int_cont_Final
    ((SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_hyd_hyb_2_int_cont_Final(void *chartInstanceVar)
{
  sf_c2_hyd_hyb_2_int_cont_Final((SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_hyd_hyb_2_int_cont_Final
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_hyd_hyb_2_int_cont_Final
    ((SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_hyd_hyb_2_int_cont_Final();/* state var info */
...
extern void sf_internal_set_sim_state_c2_hyd_hyb_2_int_cont_Final(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_hyd_hyb_2_int_cont_Final
    ((SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_hyd_hyb_2_int_cont_Final
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c2_hyd_hyb_2_int_cont_Final(S);
}

static void sf_opaque_set_sim_state_c2_hyd_hyb_2_int_cont_Final(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c2_hyd_hyb_2_int_cont_Final(S, st);
}

static void sf_opaque_terminate_c2_hyd_hyb_2_int_cont_Final(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c2_hyd_hyb_2_int_cont_Final
      ((SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_hyd_hyb_2_int_cont_Final
    ((SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_hyd_hyb_2_int_cont_Final(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_hyd_hyb_2_int_cont_Final
      ((SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_hyd_hyb_2_int_cont_Final(SimStruct *S)
{
...
static void mdlRTW_c2_hyd_hyb_2_int_cont_Final(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_hyd_hyb_2_int_cont_Final(SimStruct *S)
{
  SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct *chartInstance;
  chartInstance = (SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct *)utMalloc(sizeof
    (SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_hyd_hyb_2_int_cont_FinalInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_hyd_hyb_2_int_cont_Final;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_hyd_hyb_2_int_cont_Final;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_hyd_hyb_2_int_cont_Final;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_hyd_hyb_2_int_cont_Final;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_hyd_hyb_2_int_cont_Final;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_hyd_hyb_2_int_cont_Final;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_hyd_hyb_2_int_cont_Final;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_hyd_hyb_2_int_cont_Final;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_hyd_hyb_2_int_cont_Final;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_hyd_hyb_2_int_cont_Final;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_hyd_hyb_2_int_cont_Final;
...
void c2_hyd_hyb_2_int_cont_Final_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_hyd_hyb_2_int_cont_Final(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_hyd_hyb_2_int_cont_Final(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_hyd_hyb_2_int_cont_Final(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_hyd_hyb_2_int_cont_Final_method_dispatcher.\n"
