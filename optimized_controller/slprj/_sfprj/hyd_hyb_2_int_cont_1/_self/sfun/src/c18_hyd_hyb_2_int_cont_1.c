...
static void initialize_c18_hyd_hyb_2_int_cont_1
  (SFc18_hyd_hyb_2_int_cont_1InstanceStruct *chartInstance);
static void initialize_params_c18_hyd_hyb_2_int_cont_1
  (SFc18_hyd_hyb_2_int_cont_1InstanceStruct *chartInstance);
static void enable_c18_hyd_hyb_2_int_cont_1
  (SFc18_hyd_hyb_2_int_cont_1InstanceStruct *chartInstance);
static void disable_c18_hyd_hyb_2_int_cont_1
  (SFc18_hyd_hyb_2_int_cont_1InstanceStruct *chartInstance);
static void c18_update_debugger_state_c18_hyd_hyb_2_int_cont_1
  (SFc18_hyd_hyb_2_int_cont_1InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c18_hyd_hyb_2_int_cont_1
  (SFc18_hyd_hyb_2_int_cont_1InstanceStruct *chartInstance);
static void set_sim_state_c18_hyd_hyb_2_int_cont_1
  (SFc18_hyd_hyb_2_int_cont_1InstanceStruct *chartInstance, const mxArray
   *c18_st);
static void finalize_c18_hyd_hyb_2_int_cont_1
  (SFc18_hyd_hyb_2_int_cont_1InstanceStruct *chartInstance);
static void sf_c18_hyd_hyb_2_int_cont_1(SFc18_hyd_hyb_2_int_cont_1InstanceStruct
  *chartInstance);
static void initSimStructsc18_hyd_hyb_2_int_cont_1
  (SFc18_hyd_hyb_2_int_cont_1InstanceStruct *chartInstance);
...
static const mxArray *c18_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static real_T c18_emlrt_marshallIn(SFc18_hyd_hyb_2_int_cont_1InstanceStruct
  *chartInstance, const mxArray *c18_y, const char_T *c18_identifier);
static real_T c18_b_emlrt_marshallIn(SFc18_hyd_hyb_2_int_cont_1InstanceStruct
...
static const mxArray *c18_b_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static int32_T c18_c_emlrt_marshallIn(SFc18_hyd_hyb_2_int_cont_1InstanceStruct
  *chartInstance, const mxArray *c18_u, const emlrtMsgIdentifier *c18_parentId);
static void c18_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c18_mxArrayInData, const char_T *c18_varName, void *c18_outData);
static uint8_T c18_d_emlrt_marshallIn(SFc18_hyd_hyb_2_int_cont_1InstanceStruct
  *chartInstance, const mxArray *c18_b_is_active_c18_hyd_hyb_2_int_cont_1, const
  char_T *c18_identifier);
static uint8_T c18_e_emlrt_marshallIn(SFc18_hyd_hyb_2_int_cont_1InstanceStruct
  *chartInstance, const mxArray *c18_u, const emlrtMsgIdentifier *c18_parentId);
static void init_dsm_address_info(SFc18_hyd_hyb_2_int_cont_1InstanceStruct
  *chartInstance);
  ...
  (SFc18_hyd_hyb_2_int_cont_1InstanceStruct *chartInstance)
{
  ...
  chartInstance->c18_is_active_c18_hyd_hyb_2_int_cont_1 = 0U;
}
  ...
  (SFc18_hyd_hyb_2_int_cont_1InstanceStruct *chartInstance)
{
  ...
  c18_b_hoistedGlobal = chartInstance->c18_is_active_c18_hyd_hyb_2_int_cont_1;
   ...
   *c18_st)
{
  ...
  *c18_y = c18_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c18_u,
    0)), "y");
  chartInstance->c18_is_active_c18_hyd_hyb_2_int_cont_1 = c18_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c18_u, 1)),
     "is_active_c18_hyd_hyb_2_int_cont_1");
  sf_mex_destroy(&c18_u);
  c18_update_debugger_state_c18_hyd_hyb_2_int_cont_1(chartInstance);
  ...
  *chartInstance)
{
  ...
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 8U, chartInstance->c18_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c18_b_u, 0U);
  _SFD_DATA_RANGE_CHECK(*c18_d_y, 1U);
  _SFD_DATA_RANGE_CHECK(chartInstance->c18_T0, 2U);
  chartInstance->c18_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 8U, chartInstance->c18_sfEvent);
  ...
  *c18_d_y = c18_y;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 8U, chartInstance->c18_sfEvent);
  ...
  *c18_inData)
{
  ...
  const mxArray *c18_y = NULL;
  SFc18_hyd_hyb_2_int_cont_1InstanceStruct *chartInstance;
  chartInstance = (SFc18_hyd_hyb_2_int_cont_1InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c18_hyd_hyb_2_int_cont_1_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c18_identifier)
{
  ...
  c18_y = c18_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c18_b_is_active_c18_hyd_hyb_2_int_cont_1), &c18_thisId);
  sf_mex_destroy(&c18_b_is_active_c18_hyd_hyb_2_int_cont_1);
  return c18_y;
}
...
/* SFunction Glue Code */
void sf_c18_hyd_hyb_2_int_cont_1_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c18_hyd_hyb_2_int_cont_1_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c18_hyd_hyb_2_int_cont_1(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c18_hyd_hyb_2_int_cont_1\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c18_hyd_hyb_2_int_cont_1_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc18_hyd_hyb_2_int_cont_1InstanceStruct *chartInstance;
    chartInstance = (SFc18_hyd_hyb_2_int_cont_1InstanceStruct *)
...
static void sf_opaque_initialize_c18_hyd_hyb_2_int_cont_1(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc18_hyd_hyb_2_int_cont_1InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c18_hyd_hyb_2_int_cont_1
    ((SFc18_hyd_hyb_2_int_cont_1InstanceStruct*) chartInstanceVar);
  initialize_c18_hyd_hyb_2_int_cont_1((SFc18_hyd_hyb_2_int_cont_1InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c18_hyd_hyb_2_int_cont_1(void *chartInstanceVar)
{
  enable_c18_hyd_hyb_2_int_cont_1((SFc18_hyd_hyb_2_int_cont_1InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c18_hyd_hyb_2_int_cont_1(void *chartInstanceVar)
{
  disable_c18_hyd_hyb_2_int_cont_1((SFc18_hyd_hyb_2_int_cont_1InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c18_hyd_hyb_2_int_cont_1(void *chartInstanceVar)
{
  sf_c18_hyd_hyb_2_int_cont_1((SFc18_hyd_hyb_2_int_cont_1InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c18_hyd_hyb_2_int_cont_1
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c18_hyd_hyb_2_int_cont_1
    ((SFc18_hyd_hyb_2_int_cont_1InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c18_hyd_hyb_2_int_cont_1();/* state var info */
...
extern void sf_internal_set_sim_state_c18_hyd_hyb_2_int_cont_1(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c18_hyd_hyb_2_int_cont_1
    ((SFc18_hyd_hyb_2_int_cont_1InstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c18_hyd_hyb_2_int_cont_1(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c18_hyd_hyb_2_int_cont_1(S);
}

static void sf_opaque_set_sim_state_c18_hyd_hyb_2_int_cont_1(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c18_hyd_hyb_2_int_cont_1(S, st);
}

static void sf_opaque_terminate_c18_hyd_hyb_2_int_cont_1(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc18_hyd_hyb_2_int_cont_1InstanceStruct*) chartInstanceVar)
      ->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c18_hyd_hyb_2_int_cont_1((SFc18_hyd_hyb_2_int_cont_1InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc18_hyd_hyb_2_int_cont_1
    ((SFc18_hyd_hyb_2_int_cont_1InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c18_hyd_hyb_2_int_cont_1(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c18_hyd_hyb_2_int_cont_1
      ((SFc18_hyd_hyb_2_int_cont_1InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c18_hyd_hyb_2_int_cont_1(SimStruct *S)
{
...
static void mdlRTW_c18_hyd_hyb_2_int_cont_1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "hyd_hyb_2_int_cont_1", "hyd_hyb_2_int_cont_1",18);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c18_hyd_hyb_2_int_cont_1(SimStruct *S)
{
  SFc18_hyd_hyb_2_int_cont_1InstanceStruct *chartInstance;
  chartInstance = (SFc18_hyd_hyb_2_int_cont_1InstanceStruct *)malloc(sizeof
    (SFc18_hyd_hyb_2_int_cont_1InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc18_hyd_hyb_2_int_cont_1InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c18_hyd_hyb_2_int_cont_1;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c18_hyd_hyb_2_int_cont_1;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c18_hyd_hyb_2_int_cont_1;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c18_hyd_hyb_2_int_cont_1;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c18_hyd_hyb_2_int_cont_1;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c18_hyd_hyb_2_int_cont_1;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c18_hyd_hyb_2_int_cont_1;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c18_hyd_hyb_2_int_cont_1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c18_hyd_hyb_2_int_cont_1;
  chartInstance->chartInfo.mdlStart = mdlStart_c18_hyd_hyb_2_int_cont_1;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c18_hyd_hyb_2_int_cont_1;
...
void c18_hyd_hyb_2_int_cont_1_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c18_hyd_hyb_2_int_cont_1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c18_hyd_hyb_2_int_cont_1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c18_hyd_hyb_2_int_cont_1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c18_hyd_hyb_2_int_cont_1_method_dispatcher.\n"
