...
static void initialize_c17_hyd_hyb_2_opt_cont_1
  (SFc17_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance);
static void initialize_params_c17_hyd_hyb_2_opt_cont_1
  (SFc17_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance);
static void enable_c17_hyd_hyb_2_opt_cont_1
  (SFc17_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance);
static void disable_c17_hyd_hyb_2_opt_cont_1
  (SFc17_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance);
static void c17_update_debugger_state_c17_hyd_hyb_2_opt_cont_1
  (SFc17_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c17_hyd_hyb_2_opt_cont_1
  (SFc17_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance);
static void set_sim_state_c17_hyd_hyb_2_opt_cont_1
  (SFc17_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance, const mxArray
   *c17_st);
static void finalize_c17_hyd_hyb_2_opt_cont_1
  (SFc17_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance);
static void sf_c17_hyd_hyb_2_opt_cont_1(SFc17_hyd_hyb_2_opt_cont_1InstanceStruct
  *chartInstance);
static void initSimStructsc17_hyd_hyb_2_opt_cont_1
  (SFc17_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance);
...
static const mxArray *c17_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static real_T c17_emlrt_marshallIn(SFc17_hyd_hyb_2_opt_cont_1InstanceStruct
  *chartInstance, const mxArray *c17_y, const char_T *c17_identifier);
static real_T c17_b_emlrt_marshallIn(SFc17_hyd_hyb_2_opt_cont_1InstanceStruct
...
static const mxArray *c17_c_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static int32_T c17_c_emlrt_marshallIn(SFc17_hyd_hyb_2_opt_cont_1InstanceStruct
  *chartInstance, const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId);
static void c17_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c17_mxArrayInData, const char_T *c17_varName, void *c17_outData);
static uint8_T c17_d_emlrt_marshallIn(SFc17_hyd_hyb_2_opt_cont_1InstanceStruct
  *chartInstance, const mxArray *c17_b_is_active_c17_hyd_hyb_2_opt_cont_1, const
  char_T *c17_identifier);
static uint8_T c17_e_emlrt_marshallIn(SFc17_hyd_hyb_2_opt_cont_1InstanceStruct
  *chartInstance, const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId);
static void init_dsm_address_info(SFc17_hyd_hyb_2_opt_cont_1InstanceStruct
  *chartInstance);
  ...
  (SFc17_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance)
{
  ...
  chartInstance->c17_is_active_c17_hyd_hyb_2_opt_cont_1 = 0U;
}
  ...
  (SFc17_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance)
{
  ...
  c17_b_hoistedGlobal = chartInstance->c17_is_active_c17_hyd_hyb_2_opt_cont_1;
   ...
   *c17_st)
{
  ...
  *c17_y = c17_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c17_u,
    0)), "y");
  chartInstance->c17_is_active_c17_hyd_hyb_2_opt_cont_1 = c17_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c17_u, 1)),
     "is_active_c17_hyd_hyb_2_opt_cont_1");
  sf_mex_destroy(&c17_u);
  c17_update_debugger_state_c17_hyd_hyb_2_opt_cont_1(chartInstance);
  ...
  *c17_inData)
{
  ...
  const mxArray *c17_y = NULL;
  SFc17_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance;
  chartInstance = (SFc17_hyd_hyb_2_opt_cont_1InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c17_hyd_hyb_2_opt_cont_1_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c17_identifier)
{
  ...
  c17_y = c17_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c17_b_is_active_c17_hyd_hyb_2_opt_cont_1), &c17_thisId);
  sf_mex_destroy(&c17_b_is_active_c17_hyd_hyb_2_opt_cont_1);
  return c17_y;
}
...
/* SFunction Glue Code */
void sf_c17_hyd_hyb_2_opt_cont_1_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c17_hyd_hyb_2_opt_cont_1_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c17_hyd_hyb_2_opt_cont_1(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c17_hyd_hyb_2_opt_cont_1\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c17_hyd_hyb_2_opt_cont_1_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc17_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance;
    chartInstance = (SFc17_hyd_hyb_2_opt_cont_1InstanceStruct *)
...
static void sf_opaque_initialize_c17_hyd_hyb_2_opt_cont_1(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc17_hyd_hyb_2_opt_cont_1InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c17_hyd_hyb_2_opt_cont_1
    ((SFc17_hyd_hyb_2_opt_cont_1InstanceStruct*) chartInstanceVar);
  initialize_c17_hyd_hyb_2_opt_cont_1((SFc17_hyd_hyb_2_opt_cont_1InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c17_hyd_hyb_2_opt_cont_1(void *chartInstanceVar)
{
  enable_c17_hyd_hyb_2_opt_cont_1((SFc17_hyd_hyb_2_opt_cont_1InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c17_hyd_hyb_2_opt_cont_1(void *chartInstanceVar)
{
  disable_c17_hyd_hyb_2_opt_cont_1((SFc17_hyd_hyb_2_opt_cont_1InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c17_hyd_hyb_2_opt_cont_1(void *chartInstanceVar)
{
  sf_c17_hyd_hyb_2_opt_cont_1((SFc17_hyd_hyb_2_opt_cont_1InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c17_hyd_hyb_2_opt_cont_1
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c17_hyd_hyb_2_opt_cont_1
    ((SFc17_hyd_hyb_2_opt_cont_1InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c17_hyd_hyb_2_opt_cont_1();/* state var info */
...
extern void sf_internal_set_sim_state_c17_hyd_hyb_2_opt_cont_1(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c17_hyd_hyb_2_opt_cont_1
    ((SFc17_hyd_hyb_2_opt_cont_1InstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c17_hyd_hyb_2_opt_cont_1(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c17_hyd_hyb_2_opt_cont_1(S);
}

static void sf_opaque_set_sim_state_c17_hyd_hyb_2_opt_cont_1(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c17_hyd_hyb_2_opt_cont_1(S, st);
}

static void sf_opaque_terminate_c17_hyd_hyb_2_opt_cont_1(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc17_hyd_hyb_2_opt_cont_1InstanceStruct*) chartInstanceVar)
      ->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c17_hyd_hyb_2_opt_cont_1((SFc17_hyd_hyb_2_opt_cont_1InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc17_hyd_hyb_2_opt_cont_1
    ((SFc17_hyd_hyb_2_opt_cont_1InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c17_hyd_hyb_2_opt_cont_1(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c17_hyd_hyb_2_opt_cont_1
      ((SFc17_hyd_hyb_2_opt_cont_1InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c17_hyd_hyb_2_opt_cont_1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"hyd_hyb_2_opt_cont_1",
      "hyd_hyb_2_opt_cont_1",17);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"hyd_hyb_2_opt_cont_1",
                "hyd_hyb_2_opt_cont_1",17,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"hyd_hyb_2_opt_cont_1",
      "hyd_hyb_2_opt_cont_1",17,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"hyd_hyb_2_opt_cont_1",
        "hyd_hyb_2_opt_cont_1",17,2);
      sf_mark_chart_reusable_outputs(S,"hyd_hyb_2_opt_cont_1",
        "hyd_hyb_2_opt_cont_1",17,1);
    }

    sf_set_rtw_dwork_info(S,"hyd_hyb_2_opt_cont_1","hyd_hyb_2_opt_cont_1",17);
...
static void mdlRTW_c17_hyd_hyb_2_opt_cont_1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "hyd_hyb_2_opt_cont_1", "hyd_hyb_2_opt_cont_1",17);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c17_hyd_hyb_2_opt_cont_1(SimStruct *S)
{
  SFc17_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance;
  chartInstance = (SFc17_hyd_hyb_2_opt_cont_1InstanceStruct *)malloc(sizeof
    (SFc17_hyd_hyb_2_opt_cont_1InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc17_hyd_hyb_2_opt_cont_1InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c17_hyd_hyb_2_opt_cont_1;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c17_hyd_hyb_2_opt_cont_1;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c17_hyd_hyb_2_opt_cont_1;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c17_hyd_hyb_2_opt_cont_1;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c17_hyd_hyb_2_opt_cont_1;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c17_hyd_hyb_2_opt_cont_1;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c17_hyd_hyb_2_opt_cont_1;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c17_hyd_hyb_2_opt_cont_1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c17_hyd_hyb_2_opt_cont_1;
  chartInstance->chartInfo.mdlStart = mdlStart_c17_hyd_hyb_2_opt_cont_1;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c17_hyd_hyb_2_opt_cont_1;
...
void c17_hyd_hyb_2_opt_cont_1_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c17_hyd_hyb_2_opt_cont_1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c17_hyd_hyb_2_opt_cont_1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c17_hyd_hyb_2_opt_cont_1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c17_hyd_hyb_2_opt_cont_1_method_dispatcher.\n"
