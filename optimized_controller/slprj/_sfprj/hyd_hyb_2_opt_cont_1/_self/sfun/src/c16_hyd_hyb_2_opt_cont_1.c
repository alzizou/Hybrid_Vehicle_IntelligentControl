...
static void initialize_c16_hyd_hyb_2_opt_cont_1
  (SFc16_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance);
static void initialize_params_c16_hyd_hyb_2_opt_cont_1
  (SFc16_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance);
static void enable_c16_hyd_hyb_2_opt_cont_1
  (SFc16_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance);
static void disable_c16_hyd_hyb_2_opt_cont_1
  (SFc16_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance);
static void c16_update_debugger_state_c16_hyd_hyb_2_opt_cont_1
  (SFc16_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c16_hyd_hyb_2_opt_cont_1
  (SFc16_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance);
static void set_sim_state_c16_hyd_hyb_2_opt_cont_1
  (SFc16_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance, const mxArray
   *c16_st);
static void finalize_c16_hyd_hyb_2_opt_cont_1
  (SFc16_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance);
static void sf_c16_hyd_hyb_2_opt_cont_1(SFc16_hyd_hyb_2_opt_cont_1InstanceStruct
  *chartInstance);
static void initSimStructsc16_hyd_hyb_2_opt_cont_1
  (SFc16_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance);
...
static const mxArray *c16_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static real_T c16_emlrt_marshallIn(SFc16_hyd_hyb_2_opt_cont_1InstanceStruct
  *chartInstance, const mxArray *c16_y, const char_T *c16_identifier);
static real_T c16_b_emlrt_marshallIn(SFc16_hyd_hyb_2_opt_cont_1InstanceStruct
...
static const mxArray *c16_c_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static int32_T c16_c_emlrt_marshallIn(SFc16_hyd_hyb_2_opt_cont_1InstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
static void c16_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c16_mxArrayInData, const char_T *c16_varName, void *c16_outData);
static uint8_T c16_d_emlrt_marshallIn(SFc16_hyd_hyb_2_opt_cont_1InstanceStruct
  *chartInstance, const mxArray *c16_b_is_active_c16_hyd_hyb_2_opt_cont_1, const
  char_T *c16_identifier);
static uint8_T c16_e_emlrt_marshallIn(SFc16_hyd_hyb_2_opt_cont_1InstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
static void init_dsm_address_info(SFc16_hyd_hyb_2_opt_cont_1InstanceStruct
  *chartInstance);
  ...
  (SFc16_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance)
{
  ...
  chartInstance->c16_is_active_c16_hyd_hyb_2_opt_cont_1 = 0U;
}
  ...
  (SFc16_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance)
{
  ...
  c16_b_hoistedGlobal = chartInstance->c16_is_active_c16_hyd_hyb_2_opt_cont_1;
   ...
   *c16_st)
{
  ...
  *c16_y = c16_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c16_u,
    0)), "y");
  chartInstance->c16_is_active_c16_hyd_hyb_2_opt_cont_1 = c16_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c16_u, 1)),
     "is_active_c16_hyd_hyb_2_opt_cont_1");
  sf_mex_destroy(&c16_u);
  c16_update_debugger_state_c16_hyd_hyb_2_opt_cont_1(chartInstance);
  ...
  *c16_inData)
{
  ...
  const mxArray *c16_y = NULL;
  SFc16_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance;
  chartInstance = (SFc16_hyd_hyb_2_opt_cont_1InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c16_hyd_hyb_2_opt_cont_1_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c16_identifier)
{
  ...
  c16_y = c16_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c16_b_is_active_c16_hyd_hyb_2_opt_cont_1), &c16_thisId);
  sf_mex_destroy(&c16_b_is_active_c16_hyd_hyb_2_opt_cont_1);
  return c16_y;
}
...
/* SFunction Glue Code */
void sf_c16_hyd_hyb_2_opt_cont_1_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c16_hyd_hyb_2_opt_cont_1_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c16_hyd_hyb_2_opt_cont_1(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c16_hyd_hyb_2_opt_cont_1\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c16_hyd_hyb_2_opt_cont_1_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc16_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance;
    chartInstance = (SFc16_hyd_hyb_2_opt_cont_1InstanceStruct *)
...
static void sf_opaque_initialize_c16_hyd_hyb_2_opt_cont_1(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc16_hyd_hyb_2_opt_cont_1InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c16_hyd_hyb_2_opt_cont_1
    ((SFc16_hyd_hyb_2_opt_cont_1InstanceStruct*) chartInstanceVar);
  initialize_c16_hyd_hyb_2_opt_cont_1((SFc16_hyd_hyb_2_opt_cont_1InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c16_hyd_hyb_2_opt_cont_1(void *chartInstanceVar)
{
  enable_c16_hyd_hyb_2_opt_cont_1((SFc16_hyd_hyb_2_opt_cont_1InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c16_hyd_hyb_2_opt_cont_1(void *chartInstanceVar)
{
  disable_c16_hyd_hyb_2_opt_cont_1((SFc16_hyd_hyb_2_opt_cont_1InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c16_hyd_hyb_2_opt_cont_1(void *chartInstanceVar)
{
  sf_c16_hyd_hyb_2_opt_cont_1((SFc16_hyd_hyb_2_opt_cont_1InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c16_hyd_hyb_2_opt_cont_1
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c16_hyd_hyb_2_opt_cont_1
    ((SFc16_hyd_hyb_2_opt_cont_1InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c16_hyd_hyb_2_opt_cont_1();/* state var info */
...
extern void sf_internal_set_sim_state_c16_hyd_hyb_2_opt_cont_1(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c16_hyd_hyb_2_opt_cont_1
    ((SFc16_hyd_hyb_2_opt_cont_1InstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c16_hyd_hyb_2_opt_cont_1(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c16_hyd_hyb_2_opt_cont_1(S);
}

static void sf_opaque_set_sim_state_c16_hyd_hyb_2_opt_cont_1(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c16_hyd_hyb_2_opt_cont_1(S, st);
}

static void sf_opaque_terminate_c16_hyd_hyb_2_opt_cont_1(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc16_hyd_hyb_2_opt_cont_1InstanceStruct*) chartInstanceVar)
      ->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c16_hyd_hyb_2_opt_cont_1((SFc16_hyd_hyb_2_opt_cont_1InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc16_hyd_hyb_2_opt_cont_1
    ((SFc16_hyd_hyb_2_opt_cont_1InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c16_hyd_hyb_2_opt_cont_1(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c16_hyd_hyb_2_opt_cont_1
      ((SFc16_hyd_hyb_2_opt_cont_1InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c16_hyd_hyb_2_opt_cont_1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"hyd_hyb_2_opt_cont_1",
      "hyd_hyb_2_opt_cont_1",16);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"hyd_hyb_2_opt_cont_1",
                "hyd_hyb_2_opt_cont_1",16,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"hyd_hyb_2_opt_cont_1",
      "hyd_hyb_2_opt_cont_1",16,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"hyd_hyb_2_opt_cont_1",
        "hyd_hyb_2_opt_cont_1",16,2);
      sf_mark_chart_reusable_outputs(S,"hyd_hyb_2_opt_cont_1",
        "hyd_hyb_2_opt_cont_1",16,1);
    }

    sf_set_rtw_dwork_info(S,"hyd_hyb_2_opt_cont_1","hyd_hyb_2_opt_cont_1",16);
...
static void mdlRTW_c16_hyd_hyb_2_opt_cont_1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "hyd_hyb_2_opt_cont_1", "hyd_hyb_2_opt_cont_1",16);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c16_hyd_hyb_2_opt_cont_1(SimStruct *S)
{
  SFc16_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance;
  chartInstance = (SFc16_hyd_hyb_2_opt_cont_1InstanceStruct *)malloc(sizeof
    (SFc16_hyd_hyb_2_opt_cont_1InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc16_hyd_hyb_2_opt_cont_1InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c16_hyd_hyb_2_opt_cont_1;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c16_hyd_hyb_2_opt_cont_1;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c16_hyd_hyb_2_opt_cont_1;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c16_hyd_hyb_2_opt_cont_1;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c16_hyd_hyb_2_opt_cont_1;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c16_hyd_hyb_2_opt_cont_1;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c16_hyd_hyb_2_opt_cont_1;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c16_hyd_hyb_2_opt_cont_1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c16_hyd_hyb_2_opt_cont_1;
  chartInstance->chartInfo.mdlStart = mdlStart_c16_hyd_hyb_2_opt_cont_1;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c16_hyd_hyb_2_opt_cont_1;
...
void c16_hyd_hyb_2_opt_cont_1_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c16_hyd_hyb_2_opt_cont_1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c16_hyd_hyb_2_opt_cont_1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c16_hyd_hyb_2_opt_cont_1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c16_hyd_hyb_2_opt_cont_1_method_dispatcher.\n"
