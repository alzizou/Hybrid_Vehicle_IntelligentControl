...
static void initialize_c23_hyd_hyb_2_opt_cont_1
  (SFc23_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance);
static void initialize_params_c23_hyd_hyb_2_opt_cont_1
  (SFc23_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance);
static void enable_c23_hyd_hyb_2_opt_cont_1
  (SFc23_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance);
static void disable_c23_hyd_hyb_2_opt_cont_1
  (SFc23_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance);
static void c23_update_debugger_state_c23_hyd_hyb_2_opt_cont_1
  (SFc23_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c23_hyd_hyb_2_opt_cont_1
  (SFc23_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance);
static void set_sim_state_c23_hyd_hyb_2_opt_cont_1
  (SFc23_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance, const mxArray
   *c23_st);
static void finalize_c23_hyd_hyb_2_opt_cont_1
  (SFc23_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance);
static void sf_c23_hyd_hyb_2_opt_cont_1(SFc23_hyd_hyb_2_opt_cont_1InstanceStruct
  *chartInstance);
static void initSimStructsc23_hyd_hyb_2_opt_cont_1
  (SFc23_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance);
...
static const mxArray *c23_sf_marshallOut(void *chartInstanceVoid, void
  *c23_inData);
static real_T c23_emlrt_marshallIn(SFc23_hyd_hyb_2_opt_cont_1InstanceStruct
  *chartInstance, const mxArray *c23_y, const char_T *c23_identifier);
static real_T c23_b_emlrt_marshallIn(SFc23_hyd_hyb_2_opt_cont_1InstanceStruct
...
static const mxArray *c23_c_sf_marshallOut(void *chartInstanceVoid, void
  *c23_inData);
static int32_T c23_c_emlrt_marshallIn(SFc23_hyd_hyb_2_opt_cont_1InstanceStruct
  *chartInstance, const mxArray *c23_u, const emlrtMsgIdentifier *c23_parentId);
static void c23_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c23_mxArrayInData, const char_T *c23_varName, void *c23_outData);
static uint8_T c23_d_emlrt_marshallIn(SFc23_hyd_hyb_2_opt_cont_1InstanceStruct
  *chartInstance, const mxArray *c23_b_is_active_c23_hyd_hyb_2_opt_cont_1, const
  char_T *c23_identifier);
static uint8_T c23_e_emlrt_marshallIn(SFc23_hyd_hyb_2_opt_cont_1InstanceStruct
  *chartInstance, const mxArray *c23_u, const emlrtMsgIdentifier *c23_parentId);
static void init_dsm_address_info(SFc23_hyd_hyb_2_opt_cont_1InstanceStruct
  *chartInstance);
  ...
  (SFc23_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance)
{
  ...
  chartInstance->c23_is_active_c23_hyd_hyb_2_opt_cont_1 = 0U;
}
  ...
  (SFc23_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance)
{
  ...
  c23_b_hoistedGlobal = chartInstance->c23_is_active_c23_hyd_hyb_2_opt_cont_1;
   ...
   *c23_st)
{
  ...
  *c23_y = c23_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c23_u,
    0)), "y");
  chartInstance->c23_is_active_c23_hyd_hyb_2_opt_cont_1 = c23_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c23_u, 1)),
     "is_active_c23_hyd_hyb_2_opt_cont_1");
  sf_mex_destroy(&c23_u);
  c23_update_debugger_state_c23_hyd_hyb_2_opt_cont_1(chartInstance);
  ...
  *c23_inData)
{
  ...
  const mxArray *c23_y = NULL;
  SFc23_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance;
  chartInstance = (SFc23_hyd_hyb_2_opt_cont_1InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c23_hyd_hyb_2_opt_cont_1_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c23_identifier)
{
  ...
  c23_y = c23_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c23_b_is_active_c23_hyd_hyb_2_opt_cont_1), &c23_thisId);
  sf_mex_destroy(&c23_b_is_active_c23_hyd_hyb_2_opt_cont_1);
  return c23_y;
}
...
/* SFunction Glue Code */
void sf_c23_hyd_hyb_2_opt_cont_1_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c23_hyd_hyb_2_opt_cont_1_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c23_hyd_hyb_2_opt_cont_1(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c23_hyd_hyb_2_opt_cont_1\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c23_hyd_hyb_2_opt_cont_1_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc23_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance;
    chartInstance = (SFc23_hyd_hyb_2_opt_cont_1InstanceStruct *)
...
static void sf_opaque_initialize_c23_hyd_hyb_2_opt_cont_1(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc23_hyd_hyb_2_opt_cont_1InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c23_hyd_hyb_2_opt_cont_1
    ((SFc23_hyd_hyb_2_opt_cont_1InstanceStruct*) chartInstanceVar);
  initialize_c23_hyd_hyb_2_opt_cont_1((SFc23_hyd_hyb_2_opt_cont_1InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c23_hyd_hyb_2_opt_cont_1(void *chartInstanceVar)
{
  enable_c23_hyd_hyb_2_opt_cont_1((SFc23_hyd_hyb_2_opt_cont_1InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c23_hyd_hyb_2_opt_cont_1(void *chartInstanceVar)
{
  disable_c23_hyd_hyb_2_opt_cont_1((SFc23_hyd_hyb_2_opt_cont_1InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c23_hyd_hyb_2_opt_cont_1(void *chartInstanceVar)
{
  sf_c23_hyd_hyb_2_opt_cont_1((SFc23_hyd_hyb_2_opt_cont_1InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c23_hyd_hyb_2_opt_cont_1
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c23_hyd_hyb_2_opt_cont_1
    ((SFc23_hyd_hyb_2_opt_cont_1InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c23_hyd_hyb_2_opt_cont_1();/* state var info */
...
extern void sf_internal_set_sim_state_c23_hyd_hyb_2_opt_cont_1(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c23_hyd_hyb_2_opt_cont_1
    ((SFc23_hyd_hyb_2_opt_cont_1InstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c23_hyd_hyb_2_opt_cont_1(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c23_hyd_hyb_2_opt_cont_1(S);
}

static void sf_opaque_set_sim_state_c23_hyd_hyb_2_opt_cont_1(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c23_hyd_hyb_2_opt_cont_1(S, st);
}

static void sf_opaque_terminate_c23_hyd_hyb_2_opt_cont_1(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc23_hyd_hyb_2_opt_cont_1InstanceStruct*) chartInstanceVar)
      ->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c23_hyd_hyb_2_opt_cont_1((SFc23_hyd_hyb_2_opt_cont_1InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc23_hyd_hyb_2_opt_cont_1
    ((SFc23_hyd_hyb_2_opt_cont_1InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c23_hyd_hyb_2_opt_cont_1(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c23_hyd_hyb_2_opt_cont_1
      ((SFc23_hyd_hyb_2_opt_cont_1InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c23_hyd_hyb_2_opt_cont_1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"hyd_hyb_2_opt_cont_1",
      "hyd_hyb_2_opt_cont_1",23);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"hyd_hyb_2_opt_cont_1",
                "hyd_hyb_2_opt_cont_1",23,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"hyd_hyb_2_opt_cont_1",
      "hyd_hyb_2_opt_cont_1",23,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"hyd_hyb_2_opt_cont_1",
        "hyd_hyb_2_opt_cont_1",23,2);
      sf_mark_chart_reusable_outputs(S,"hyd_hyb_2_opt_cont_1",
        "hyd_hyb_2_opt_cont_1",23,1);
    }

    sf_set_rtw_dwork_info(S,"hyd_hyb_2_opt_cont_1","hyd_hyb_2_opt_cont_1",23);
...
static void mdlRTW_c23_hyd_hyb_2_opt_cont_1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "hyd_hyb_2_opt_cont_1", "hyd_hyb_2_opt_cont_1",23);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c23_hyd_hyb_2_opt_cont_1(SimStruct *S)
{
  SFc23_hyd_hyb_2_opt_cont_1InstanceStruct *chartInstance;
  chartInstance = (SFc23_hyd_hyb_2_opt_cont_1InstanceStruct *)malloc(sizeof
    (SFc23_hyd_hyb_2_opt_cont_1InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc23_hyd_hyb_2_opt_cont_1InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c23_hyd_hyb_2_opt_cont_1;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c23_hyd_hyb_2_opt_cont_1;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c23_hyd_hyb_2_opt_cont_1;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c23_hyd_hyb_2_opt_cont_1;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c23_hyd_hyb_2_opt_cont_1;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c23_hyd_hyb_2_opt_cont_1;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c23_hyd_hyb_2_opt_cont_1;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c23_hyd_hyb_2_opt_cont_1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c23_hyd_hyb_2_opt_cont_1;
  chartInstance->chartInfo.mdlStart = mdlStart_c23_hyd_hyb_2_opt_cont_1;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c23_hyd_hyb_2_opt_cont_1;
...
void c23_hyd_hyb_2_opt_cont_1_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c23_hyd_hyb_2_opt_cont_1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c23_hyd_hyb_2_opt_cont_1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c23_hyd_hyb_2_opt_cont_1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c23_hyd_hyb_2_opt_cont_1_method_dispatcher.\n"
