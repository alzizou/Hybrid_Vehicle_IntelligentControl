...
#include "c36_hyd_hyb_2_int_cont.h"
...
static void initialize_c36_hyd_hyb_2_int_cont
  (SFc36_hyd_hyb_2_int_contInstanceStruct *chartInstance);
static void initialize_params_c36_hyd_hyb_2_int_cont
  (SFc36_hyd_hyb_2_int_contInstanceStruct *chartInstance);
static void enable_c36_hyd_hyb_2_int_cont(SFc36_hyd_hyb_2_int_contInstanceStruct
  *chartInstance);
static void disable_c36_hyd_hyb_2_int_cont
  (SFc36_hyd_hyb_2_int_contInstanceStruct *chartInstance);
static void c36_update_debugger_state_c36_hyd_hyb_2_int_cont
  (SFc36_hyd_hyb_2_int_contInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c36_hyd_hyb_2_int_cont
  (SFc36_hyd_hyb_2_int_contInstanceStruct *chartInstance);
static void set_sim_state_c36_hyd_hyb_2_int_cont
  (SFc36_hyd_hyb_2_int_contInstanceStruct *chartInstance, const mxArray *c36_st);
static void finalize_c36_hyd_hyb_2_int_cont
  (SFc36_hyd_hyb_2_int_contInstanceStruct *chartInstance);
static void sf_c36_hyd_hyb_2_int_cont(SFc36_hyd_hyb_2_int_contInstanceStruct
  *chartInstance);
static void c36_chartstep_c36_hyd_hyb_2_int_cont
  (SFc36_hyd_hyb_2_int_contInstanceStruct *chartInstance);
static void initSimStructsc36_hyd_hyb_2_int_cont
  (SFc36_hyd_hyb_2_int_contInstanceStruct *chartInstance);
...
static const mxArray *c36_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static void c36_emlrt_marshallIn(SFc36_hyd_hyb_2_int_contInstanceStruct
  *chartInstance, const mxArray *c36_u, const char_T *c36_identifier, real_T
  c36_y[4]);
static void c36_b_emlrt_marshallIn(SFc36_hyd_hyb_2_int_contInstanceStruct
...
static const mxArray *c36_b_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static real_T c36_c_emlrt_marshallIn(SFc36_hyd_hyb_2_int_contInstanceStruct
  *chartInstance, const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId);
...
static const mxArray *c36_c_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static void c36_d_emlrt_marshallIn(SFc36_hyd_hyb_2_int_contInstanceStruct
  *chartInstance, const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId,
  real_T c36_y[24]);
...
static real_T c36_rem(SFc36_hyd_hyb_2_int_contInstanceStruct *chartInstance,
                      real_T c36_x, real_T c36_y);
static void c36_eml_scalar_eg(SFc36_hyd_hyb_2_int_contInstanceStruct
  *chartInstance);
static real_T c36_power(SFc36_hyd_hyb_2_int_contInstanceStruct *chartInstance,
  real_T c36_a, real_T c36_b);
static void c36_eml_error(SFc36_hyd_hyb_2_int_contInstanceStruct *chartInstance);
static const mxArray *c36_e_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static int32_T c36_e_emlrt_marshallIn(SFc36_hyd_hyb_2_int_contInstanceStruct
  *chartInstance, const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId);
static void c36_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c36_mxArrayInData, const char_T *c36_varName, void *c36_outData);
static uint8_T c36_f_emlrt_marshallIn(SFc36_hyd_hyb_2_int_contInstanceStruct
  *chartInstance, const mxArray *c36_b_is_active_c36_hyd_hyb_2_int_cont, const
  char_T *c36_identifier);
static uint8_T c36_g_emlrt_marshallIn(SFc36_hyd_hyb_2_int_contInstanceStruct
  *chartInstance, const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId);
static void init_dsm_address_info(SFc36_hyd_hyb_2_int_contInstanceStruct
  *chartInstance);
  ...
  (SFc36_hyd_hyb_2_int_contInstanceStruct *chartInstance)
{
  ...
  chartInstance->c36_is_active_c36_hyd_hyb_2_int_cont = 0U;
}
  ...
  (SFc36_hyd_hyb_2_int_contInstanceStruct *chartInstance)
{
  ...
  c36_hoistedGlobal = chartInstance->c36_is_active_c36_hyd_hyb_2_int_cont;
  ...
  (SFc36_hyd_hyb_2_int_contInstanceStruct *chartInstance, const mxArray *c36_st)
{
  ...
  chartInstance->c36_is_active_c36_hyd_hyb_2_int_cont = c36_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c36_u, 1)),
     "is_active_c36_hyd_hyb_2_int_cont");
  sf_mex_destroy(&c36_u);
  c36_update_debugger_state_c36_hyd_hyb_2_int_cont(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c36_sfEvent = CALL_EVENT;
  c36_chartstep_c36_hyd_hyb_2_int_cont(chartInstance);
      ...
      if (CV_EML_COND(0, 1, c36_r1 >= 0.01)) {
        ...
        while (c36_b_k <= 4.0) {
          ...
          while (c36_b_t <= 4.0) {
            ...
            c36_A = c36_dist2[_SFD_EML_ARRAY_BOUNDS_CHECK("dist2", (int32_T)
              _SFD_INTEGER_CHECK("k", c36_k), 1, 4, 1, 0) - 1];
            c36_B = c36_dist2[_SFD_EML_ARRAY_BOUNDS_CHECK("dist2", (int32_T)
            ...
            c36_c_a = c36_e_y;
            c36_c_c = c36_power(chartInstance, c36_c_a, 2.0);
            c36_den += c36_c_c;
            c36_b_t++;
            sf_mex_listen_for_ctrl_c(chartInstance->S);
          }
  ...
  *c36_inData)
{
  ...
  const mxArray *c36_y = NULL;
  SFc36_hyd_hyb_2_int_contInstanceStruct *chartInstance;
  chartInstance = (SFc36_hyd_hyb_2_int_contInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c36_hyd_hyb_2_int_cont_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c36_identifier)
{
  ...
  c36_y = c36_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c36_b_is_active_c36_hyd_hyb_2_int_cont), &c36_thisId);
  sf_mex_destroy(&c36_b_is_active_c36_hyd_hyb_2_int_cont);
  return c36_y;
}
...
/* SFunction Glue Code */
void sf_c36_hyd_hyb_2_int_cont_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1885852303U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2281717752U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2739600935U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(749706391U);
}

mxArray *sf_c36_hyd_hyb_2_int_cont_get_autoinheritance_info(void)
{
...

  {
    ...
    pr[0] = (double)(1664360116U);
    pr[1] = (double)(1444567774U);
    pr[2] = (double)(2363708581U);
    pr[3] = (double)(1671958865U);
...
static const mxArray *sf_get_sim_state_info_c36_hyd_hyb_2_int_cont(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"u\",},{M[8],M[0],T\"is_active_c36_hyd_hyb_2_int_cont\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c36_hyd_hyb_2_int_cont_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc36_hyd_hyb_2_int_contInstanceStruct *chartInstance;
    chartInstance = (SFc36_hyd_hyb_2_int_contInstanceStruct *) ((ChartInfoStruct
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_IF(0,0,114,121,-1,599);
        _SFD_CV_INIT_EML_IF(0,1,161,184,-1,595);
        _SFD_CV_INIT_EML_FOR(0,0,193,203,403);
        _SFD_CV_INIT_EML_FOR(0,1,234,244,352);
        _SFD_CV_INIT_EML_FOR(0,2,412,422,574);
        _SFD_CV_INIT_EML_FOR(0,3,453,463,535);

        {
          static int condStart[] = { 164, 175 };

          static int condEnd[] = { 170, 183 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,0,164,184,2,0,&(condStart[0]),&(condEnd[0]),3,
                                &(pfixExpr[0]));
        }
...
static void sf_opaque_initialize_c36_hyd_hyb_2_int_cont(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc36_hyd_hyb_2_int_contInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c36_hyd_hyb_2_int_cont
    ((SFc36_hyd_hyb_2_int_contInstanceStruct*) chartInstanceVar);
  initialize_c36_hyd_hyb_2_int_cont((SFc36_hyd_hyb_2_int_contInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c36_hyd_hyb_2_int_cont(void *chartInstanceVar)
{
  enable_c36_hyd_hyb_2_int_cont((SFc36_hyd_hyb_2_int_contInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c36_hyd_hyb_2_int_cont(void *chartInstanceVar)
{
  disable_c36_hyd_hyb_2_int_cont((SFc36_hyd_hyb_2_int_contInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c36_hyd_hyb_2_int_cont(void *chartInstanceVar)
{
  sf_c36_hyd_hyb_2_int_cont((SFc36_hyd_hyb_2_int_contInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c36_hyd_hyb_2_int_cont(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c36_hyd_hyb_2_int_cont
    ((SFc36_hyd_hyb_2_int_contInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c36_hyd_hyb_2_int_cont();/* state var info */
...
extern void sf_internal_set_sim_state_c36_hyd_hyb_2_int_cont(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c36_hyd_hyb_2_int_cont((SFc36_hyd_hyb_2_int_contInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c36_hyd_hyb_2_int_cont(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c36_hyd_hyb_2_int_cont(S);
}

static void sf_opaque_set_sim_state_c36_hyd_hyb_2_int_cont(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c36_hyd_hyb_2_int_cont(S, st);
}

static void sf_opaque_terminate_c36_hyd_hyb_2_int_cont(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc36_hyd_hyb_2_int_contInstanceStruct*) chartInstanceVar
      )->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c36_hyd_hyb_2_int_cont((SFc36_hyd_hyb_2_int_contInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc36_hyd_hyb_2_int_cont((SFc36_hyd_hyb_2_int_contInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c36_hyd_hyb_2_int_cont(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c36_hyd_hyb_2_int_cont
      ((SFc36_hyd_hyb_2_int_contInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c36_hyd_hyb_2_int_cont(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"hyd_hyb_2_int_cont","hyd_hyb_2_int_cont",
      36);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"hyd_hyb_2_int_cont",
                "hyd_hyb_2_int_cont",36,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"hyd_hyb_2_int_cont",
      "hyd_hyb_2_int_cont",36,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 2, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"hyd_hyb_2_int_cont",
        "hyd_hyb_2_int_cont",36,3);
      sf_mark_chart_reusable_outputs(S,"hyd_hyb_2_int_cont","hyd_hyb_2_int_cont",
        36,1);
    }

    sf_set_rtw_dwork_info(S,"hyd_hyb_2_int_cont","hyd_hyb_2_int_cont",36);
    ssSetHasSubFunctions(S,!(chartIsInlinable));
  } else {
  }

  ssSetOptions(S,ssGetOptions(S)|SS_OPTION_WORKS_WITH_CODE_REUSE);
  ssSetChecksum0(S,(256047706U));
  ssSetChecksum1(S,(923539558U));
  ssSetChecksum2(S,(2315378639U));
  ssSetChecksum3(S,(3725193161U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c36_hyd_hyb_2_int_cont(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "hyd_hyb_2_int_cont", "hyd_hyb_2_int_cont",36);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c36_hyd_hyb_2_int_cont(SimStruct *S)
{
  SFc36_hyd_hyb_2_int_contInstanceStruct *chartInstance;
  chartInstance = (SFc36_hyd_hyb_2_int_contInstanceStruct *)malloc(sizeof
    (SFc36_hyd_hyb_2_int_contInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc36_hyd_hyb_2_int_contInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c36_hyd_hyb_2_int_cont;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c36_hyd_hyb_2_int_cont;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c36_hyd_hyb_2_int_cont;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c36_hyd_hyb_2_int_cont;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c36_hyd_hyb_2_int_cont;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c36_hyd_hyb_2_int_cont;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c36_hyd_hyb_2_int_cont;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c36_hyd_hyb_2_int_cont;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c36_hyd_hyb_2_int_cont;
  chartInstance->chartInfo.mdlStart = mdlStart_c36_hyd_hyb_2_int_cont;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c36_hyd_hyb_2_int_cont;
...
void c36_hyd_hyb_2_int_cont_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c36_hyd_hyb_2_int_cont(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c36_hyd_hyb_2_int_cont(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c36_hyd_hyb_2_int_cont(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c36_hyd_hyb_2_int_cont_method_dispatcher.\n"
