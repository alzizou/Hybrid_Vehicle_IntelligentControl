...
static void initialize_c3_hyd_hyb_2_fuz(SFc3_hyd_hyb_2_fuzInstanceStruct
  *chartInstance);
static void initialize_params_c3_hyd_hyb_2_fuz(SFc3_hyd_hyb_2_fuzInstanceStruct *
  chartInstance);
static void enable_c3_hyd_hyb_2_fuz(SFc3_hyd_hyb_2_fuzInstanceStruct
  *chartInstance);
static void disable_c3_hyd_hyb_2_fuz(SFc3_hyd_hyb_2_fuzInstanceStruct
  *chartInstance);
static void c3_update_debugger_state_c3_hyd_hyb_2_fuz
  (SFc3_hyd_hyb_2_fuzInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_hyd_hyb_2_fuz
  (SFc3_hyd_hyb_2_fuzInstanceStruct *chartInstance);
static void set_sim_state_c3_hyd_hyb_2_fuz(SFc3_hyd_hyb_2_fuzInstanceStruct
  *chartInstance, const mxArray *c3_st);
static void finalize_c3_hyd_hyb_2_fuz(SFc3_hyd_hyb_2_fuzInstanceStruct
  *chartInstance);
static void sf_c3_hyd_hyb_2_fuz(SFc3_hyd_hyb_2_fuzInstanceStruct *chartInstance);
static void initSimStructsc3_hyd_hyb_2_fuz(SFc3_hyd_hyb_2_fuzInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_hyd_hyb_2_fuzInstanceStruct
  *chartInstance, const mxArray *c3_T_mech_brk, const char_T *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_hyd_hyb_2_fuzInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static void c3_eml_scalar_eg(SFc3_hyd_hyb_2_fuzInstanceStruct *chartInstance);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_c_emlrt_marshallIn(SFc3_hyd_hyb_2_fuzInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_d_emlrt_marshallIn(SFc3_hyd_hyb_2_fuzInstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_hyd_hyb_2_fuz, const char_T
  *c3_identifier);
static uint8_T c3_e_emlrt_marshallIn(SFc3_hyd_hyb_2_fuzInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_hyd_hyb_2_fuzInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_hyd_hyb_2_fuz = 0U;
}
  ...
  (SFc3_hyd_hyb_2_fuzInstanceStruct *chartInstance)
{
  ...
  c3_c_hoistedGlobal = chartInstance->c3_is_active_c3_hyd_hyb_2_fuz;
  ...
  *chartInstance, const mxArray *c3_st)
{
  ...
  *c3_T_mech_brk = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c3_u, 1)), "T_mech_brk");
  chartInstance->c3_is_active_c3_hyd_hyb_2_fuz = c3_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 2)),
     "is_active_c3_hyd_hyb_2_fuz");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_hyd_hyb_2_fuz(chartInstance);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_hyd_hyb_2_fuzInstanceStruct *chartInstance;
  chartInstance = (SFc3_hyd_hyb_2_fuzInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_hyd_hyb_2_fuz_get_eml_resolved_functions_info(void)
{
  ...
  *c3_identifier)
{
  ...
  c3_y = c3_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_hyd_hyb_2_fuz), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_hyd_hyb_2_fuz);
  return c3_y;
}
...
/* SFunction Glue Code */
void sf_c3_hyd_hyb_2_fuz_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_hyd_hyb_2_fuz_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c3_hyd_hyb_2_fuz(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"T_eng\",},{M[1],M[8],T\"T_mech_brk\",},{M[8],M[0],T\"is_active_c3_hyd_hyb_2_fuz\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_hyd_hyb_2_fuz_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc3_hyd_hyb_2_fuzInstanceStruct *chartInstance;
    chartInstance = (SFc3_hyd_hyb_2_fuzInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c3_hyd_hyb_2_fuz(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_hyd_hyb_2_fuzInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_hyd_hyb_2_fuz((SFc3_hyd_hyb_2_fuzInstanceStruct*)
    chartInstanceVar);
  initialize_c3_hyd_hyb_2_fuz((SFc3_hyd_hyb_2_fuzInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c3_hyd_hyb_2_fuz(void *chartInstanceVar)
{
  enable_c3_hyd_hyb_2_fuz((SFc3_hyd_hyb_2_fuzInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_hyd_hyb_2_fuz(void *chartInstanceVar)
{
  disable_c3_hyd_hyb_2_fuz((SFc3_hyd_hyb_2_fuzInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_hyd_hyb_2_fuz(void *chartInstanceVar)
{
  sf_c3_hyd_hyb_2_fuz((SFc3_hyd_hyb_2_fuzInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_hyd_hyb_2_fuz(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_hyd_hyb_2_fuz
    ((SFc3_hyd_hyb_2_fuzInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_hyd_hyb_2_fuz();/* state var info */
...
extern void sf_internal_set_sim_state_c3_hyd_hyb_2_fuz(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c3_hyd_hyb_2_fuz((SFc3_hyd_hyb_2_fuzInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_hyd_hyb_2_fuz(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_hyd_hyb_2_fuz(S);
}

static void sf_opaque_set_sim_state_c3_hyd_hyb_2_fuz(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c3_hyd_hyb_2_fuz(S, st);
}

static void sf_opaque_terminate_c3_hyd_hyb_2_fuz(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_hyd_hyb_2_fuzInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c3_hyd_hyb_2_fuz((SFc3_hyd_hyb_2_fuzInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc3_hyd_hyb_2_fuz((SFc3_hyd_hyb_2_fuzInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_hyd_hyb_2_fuz(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_hyd_hyb_2_fuz(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"hyd_hyb_2_fuz","hyd_hyb_2_fuz",3);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"hyd_hyb_2_fuz","hyd_hyb_2_fuz",3,
                "RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"hyd_hyb_2_fuz",
      "hyd_hyb_2_fuz",3,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 2, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"hyd_hyb_2_fuz","hyd_hyb_2_fuz",3,3);
      sf_mark_chart_reusable_outputs(S,"hyd_hyb_2_fuz","hyd_hyb_2_fuz",3,2);
    }

    sf_set_rtw_dwork_info(S,"hyd_hyb_2_fuz","hyd_hyb_2_fuz",3);
...
static void mdlRTW_c3_hyd_hyb_2_fuz(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "hyd_hyb_2_fuz", "hyd_hyb_2_fuz",3);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c3_hyd_hyb_2_fuz(SimStruct *S)
{
  SFc3_hyd_hyb_2_fuzInstanceStruct *chartInstance;
  chartInstance = (SFc3_hyd_hyb_2_fuzInstanceStruct *)malloc(sizeof
    (SFc3_hyd_hyb_2_fuzInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_hyd_hyb_2_fuzInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c3_hyd_hyb_2_fuz;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_hyd_hyb_2_fuz;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c3_hyd_hyb_2_fuz;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_hyd_hyb_2_fuz;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_hyd_hyb_2_fuz;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_hyd_hyb_2_fuz;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_hyd_hyb_2_fuz;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_hyd_hyb_2_fuz;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_hyd_hyb_2_fuz;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_hyd_hyb_2_fuz;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_hyd_hyb_2_fuz;
...
void c3_hyd_hyb_2_fuz_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_hyd_hyb_2_fuz(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_hyd_hyb_2_fuz(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_hyd_hyb_2_fuz(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_hyd_hyb_2_fuz_method_dispatcher.\n"
