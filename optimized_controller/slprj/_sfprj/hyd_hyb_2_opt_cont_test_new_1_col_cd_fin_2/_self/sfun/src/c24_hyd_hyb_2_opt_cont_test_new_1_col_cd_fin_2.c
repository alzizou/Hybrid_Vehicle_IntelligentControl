...
#include "c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2.h"
...
static void initialize_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2
  (SFc24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2InstanceStruct *chartInstance);
static void initialize_params_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2
  (SFc24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2InstanceStruct *chartInstance);
static void enable_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2
  (SFc24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2InstanceStruct *chartInstance);
static void disable_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2
  (SFc24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2InstanceStruct *chartInstance);
static void c24_update_debugger_state_c24_hyd_hyb_2_opt_cont_test_new_1_col_
  (SFc24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2InstanceStruct *chartInstance);
static const mxArray
  *get_sim_state_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2
  (SFc24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2InstanceStruct *chartInstance);
static void set_sim_state_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2
  (SFc24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2InstanceStruct *chartInstance,
   const mxArray *c24_st);
static void finalize_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2
  (SFc24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2InstanceStruct *chartInstance);
static void sf_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2
  (SFc24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2InstanceStruct *chartInstance);
static void initSimStructsc24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2
  (SFc24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2InstanceStruct *chartInstance);
...
static uint8_T c24_d_emlrt_marshallIn
  (SFc24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2InstanceStruct *chartInstance,
   const mxArray *c24_b_is_active_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2,
  ...
  (SFc24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c24_is_active_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2 =
    0U;
}
   ...
   const mxArray *c24_st)
{
  ...
  *c24_T_mech_brk = c24_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c24_is_active_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2 =
    ...
    "is_active_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2");
   ...
   const char_T *c24_identifier)
{
  ...
  c24_y = c24_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c24_b_is_active_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2),
    &c24_thisId);
  sf_mex_destroy(&c24_b_is_active_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2);
  return c24_y;
}
...
/* SFunction Glue Code */
void sf_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2_get_check_sum(mxArray
  *plhs[])
{
...
mxArray
  *sf_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2_get_autoinheritance_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"T_eng\",},{M[1],M[8],T\"T_mech_brk\",},{M[8],M[0],T\"is_active_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2
  (void *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2InstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2
    ((SFc24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2InstanceStruct*)
     chartInstanceVar);
  initialize_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2
    ((SFc24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2(void
  *chartInstanceVar)
{
  enable_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2
    ((SFc24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2
  (void *chartInstanceVar)
{
  disable_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2
    ((SFc24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2
  (void *chartInstanceVar)
{
  sf_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2
    ((SFc24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2InstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2
  (SimStruct* S)
{
  ...
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2();/* state var info */
...
extern void
  sf_internal_set_sim_state_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2
    ((SFc24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2InstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2
  (SimStruct* S)
{
  return
    sf_internal_get_sim_state_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2(S);
}

static void
  sf_opaque_set_sim_state_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2(S, st);
}

static void sf_opaque_terminate_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2
  (void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    ...
    finalize_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2
      ((SFc24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2InstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2
    ((SFc24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2InstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2
  (SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      ...
      "hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2",24);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,
                "hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2",
                "hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2",24,"RTWCG"));
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,
        "hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2",
        "hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2",24,3);
      sf_mark_chart_reusable_outputs(S,
        "hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2",
        "hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2",24,2);
    }
...
static void mdlRTW_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2(SimStruct *S)
{
  SFc24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2InstanceStruct *chartInstance;
  chartInstance =
    (SFc24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2InstanceStruct *)malloc
    (sizeof(SFc24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2;
...
void c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2_method_dispatcher(SimStruct *
  S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c24_hyd_hyb_2_opt_cont_test_new_1_col_cd_fin_2_method_dispatcher.\n"
