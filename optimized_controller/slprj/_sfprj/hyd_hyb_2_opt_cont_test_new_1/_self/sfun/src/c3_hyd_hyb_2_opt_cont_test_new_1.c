...
#include "c3_hyd_hyb_2_opt_cont_test_new_1.h"
...
static const char * c3_debug_family_names[9] = { "nargin", "nargout", "T_pm_1",
  "T_brk", "T_dem", "delta_p", "T_pm", "T_eng", "T_mech_brk" };

/* Function Declarations */
static void initialize_c3_hyd_hyb_2_opt_cont_test_new_1
  (SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance);
static void initialize_params_c3_hyd_hyb_2_opt_cont_test_new_1
  (SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance);
static void enable_c3_hyd_hyb_2_opt_cont_test_new_1
  (SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance);
static void disable_c3_hyd_hyb_2_opt_cont_test_new_1
  (SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_hyd_hyb_2_opt_cont_test_new_1
  (SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_hyd_hyb_2_opt_cont_test_new_1
  (SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance);
static void set_sim_state_c3_hyd_hyb_2_opt_cont_test_new_1
  (SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance, const
   mxArray *c3_st);
static void finalize_c3_hyd_hyb_2_opt_cont_test_new_1
  (SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance);
static void sf_c3_hyd_hyb_2_opt_cont_test_new_1
  (SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance);
static void initSimStructsc3_hyd_hyb_2_opt_cont_test_new_1
  (SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance);
...
static real_T c3_emlrt_marshallIn
  (SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance, const
   mxArray *c3_T_mech_brk, const char_T *c3_identifier);
static real_T c3_b_emlrt_marshallIn
  (SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance, const
   mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static real_T c3_min(SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct
                     *chartInstance, real_T c3_varargin_1, real_T c3_varargin_2);
static void c3_eml_scalar_eg(SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct
  *chartInstance);
...
static uint8_T c3_d_emlrt_marshallIn
  (SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance, const
   mxArray *c3_b_is_active_c3_hyd_hyb_2_opt_cont_test_new_1, const char_T
   *c3_identifier);
  ...
  (SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_hyd_hyb_2_opt_cont_test_new_1 = 0U;
}
  ...
  (SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance)
{
  ...
  c3_d_hoistedGlobal =
    chartInstance->c3_is_active_c3_hyd_hyb_2_opt_cont_test_new_1;
   ...
   mxArray *c3_st)
{
  ...
  *c3_T_pm = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u,
  ...
  chartInstance->c3_is_active_c3_hyd_hyb_2_opt_cont_test_new_1 =
    ...
    "is_active_c3_hyd_hyb_2_opt_cont_test_new_1");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_hyd_hyb_2_opt_cont_test_new_1(chartInstance);
  ...
  (SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance)
{
  ...
  _SFD_DATA_RANGE_CHECK(*c3_b_T_mech_brk, 5U);
  _SFD_DATA_RANGE_CHECK(*c3_b_delta_p, 6U);
  chartInstance->c3_sfEvent = CALL_EVENT;
  ...
  sf_debug_symbol_scope_add_eml_importable(&c3_T_pm, 6U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_T_eng, 7U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c3_T_mech_brk, 8U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  if (CV_EML_IF(0, 0, c3_y > 0.0)) {
    ...
    if (CV_EML_IF(0, 1, c3_b_y > 0.1)) {
      _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 4);
      c3_T_eng = 0.0;
      _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 4);
      c3_T_pm = c3_T_pm_1;
      _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 5);
      c3_T_mech_brk = c3_min(chartInstance, 0.0, c3_T_brk - c3_T_pm_1);
    } else {
      ...
      c3_g_x = c3_f_x;
      c3_d_y = c3_g_x / 325.0;
      c3_T_pm = c3_min(chartInstance, c3_T_pm_1, c3_d_y);
      _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 9);
      if (CV_EML_IF(0, 2, c3_delta_p <= 137.0)) {
        _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 10);
        c3_T_pm = 0.0;
      }

      _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 12);
      c3_varargin_2 = c3_T_dem - c3_T_pm;
      ...
      if (CV_EML_IF(0, 3, c3_T_eng < 100.0)) {
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance;
  chartInstance = (SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c3_hyd_hyb_2_opt_cont_test_new_1_get_eml_resolved_functions_info(void)
{
  ...
  (*c3_b_info)[11].name = "max";
  (*c3_b_info)[11].dominantType = "double";
  (*c3_b_info)[11].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/max.m";
  (*c3_b_info)[11].fileTimeLo = 2181966592U;
  (*c3_b_info)[11].fileTimeHi = 30107998U;
  (*c3_b_info)[11].mFileTimeLo = 0U;
  (*c3_b_info)[11].mFileTimeHi = 0U;
  sf_mex_assign(&c3_m0, sf_mex_createstruct("nameCaptureInfo", 1, 12));
   ...
   *c3_identifier)
{
  ...
  c3_y = c3_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_hyd_hyb_2_opt_cont_test_new_1), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_hyd_hyb_2_opt_cont_test_new_1);
  return c3_y;
}
...
/* SFunction Glue Code */
void sf_c3_hyd_hyb_2_opt_cont_test_new_1_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2990292048U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3288109546U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1799363575U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4071890806U);
}

mxArray *sf_c3_hyd_hyb_2_opt_cont_test_new_1_get_autoinheritance_info(void)
{
...

  {
    ...
    pr[0] = (double)(1275891588U);
    pr[1] = (double)(128035386U);
    pr[2] = (double)(3008583530U);
    pr[3] = (double)(3043584546U);
...
static const mxArray *sf_get_sim_state_info_c3_hyd_hyb_2_opt_cont_test_new_1
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"T_eng\",},{M[1],M[8],T\"T_mech_brk\",},{M[1],M[4],T\"T_pm\",},{M[8],M[0],T\"is_active_c3_hyd_hyb_2_opt_cont_test_new_1\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_hyd_hyb_2_opt_cont_test_new_1_get_check_sum(&mxChecksum);
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(5,2,0,1,"T_mech_brk");
          _SFD_SET_DATA_PROPS(6,1,1,0,"delta_p");
        ...
        _SFD_CV_INIT_EML_IF(0,0,67,82,428,469);
        _SFD_CV_INIT_EML_IF(0,1,87,104,178,427);
        _SFD_CV_INIT_EML_IF(0,2,261,276,-1,308);
        _SFD_CV_INIT_EML_IF(0,3,350,362,-1,419);
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(5U, c3_T_mech_brk);
          _SFD_SET_DATA_VALUE_PTR(6U, c3_delta_p);
        }
      }
    } else {
...
static void sf_opaque_initialize_c3_hyd_hyb_2_opt_cont_test_new_1(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_hyd_hyb_2_opt_cont_test_new_1
    ((SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct*) chartInstanceVar);
  initialize_c3_hyd_hyb_2_opt_cont_test_new_1
    ((SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_hyd_hyb_2_opt_cont_test_new_1(void
  *chartInstanceVar)
{
  enable_c3_hyd_hyb_2_opt_cont_test_new_1
    ((SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_hyd_hyb_2_opt_cont_test_new_1(void
  *chartInstanceVar)
{
  disable_c3_hyd_hyb_2_opt_cont_test_new_1
    ((SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_hyd_hyb_2_opt_cont_test_new_1(void
  *chartInstanceVar)
{
  sf_c3_hyd_hyb_2_opt_cont_test_new_1
    ((SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_hyd_hyb_2_opt_cont_test_new_1
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_hyd_hyb_2_opt_cont_test_new_1
    ((SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_hyd_hyb_2_opt_cont_test_new_1();/* state var info */
...
extern void sf_internal_set_sim_state_c3_hyd_hyb_2_opt_cont_test_new_1(SimStruct*
  S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c3_hyd_hyb_2_opt_cont_test_new_1
    ((SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_hyd_hyb_2_opt_cont_test_new_1
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c3_hyd_hyb_2_opt_cont_test_new_1(S);
}

static void sf_opaque_set_sim_state_c3_hyd_hyb_2_opt_cont_test_new_1(SimStruct*
  S, const mxArray *st)
{
  sf_internal_set_sim_state_c3_hyd_hyb_2_opt_cont_test_new_1(S, st);
}

static void sf_opaque_terminate_c3_hyd_hyb_2_opt_cont_test_new_1(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c3_hyd_hyb_2_opt_cont_test_new_1
      ((SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_hyd_hyb_2_opt_cont_test_new_1
    ((SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_hyd_hyb_2_opt_cont_test_new_1(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c3_hyd_hyb_2_opt_cont_test_new_1
      ((SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c3_hyd_hyb_2_opt_cont_test_new_1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"hyd_hyb_2_opt_cont_test_new_1",
      "hyd_hyb_2_opt_cont_test_new_1",3);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"hyd_hyb_2_opt_cont_test_new_1",
                "hyd_hyb_2_opt_cont_test_new_1",3,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,
      "hyd_hyb_2_opt_cont_test_new_1","hyd_hyb_2_opt_cont_test_new_1",3,
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"hyd_hyb_2_opt_cont_test_new_1",
        "hyd_hyb_2_opt_cont_test_new_1",3,4);
      sf_mark_chart_reusable_outputs(S,"hyd_hyb_2_opt_cont_test_new_1",
        "hyd_hyb_2_opt_cont_test_new_1",3,3);
    }
  ...
  ssSetChecksum0(S,(3333390655U));
  ssSetChecksum1(S,(3782032017U));
  ssSetChecksum2(S,(2227283158U));
  ssSetChecksum3(S,(1991103165U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c3_hyd_hyb_2_opt_cont_test_new_1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_hyd_hyb_2_opt_cont_test_new_1(SimStruct *S)
{
  SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance;
  chartInstance = (SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *)malloc
    (sizeof(SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct));
  memset(chartInstance, 0, sizeof
         (SFc3_hyd_hyb_2_opt_cont_test_new_1InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_hyd_hyb_2_opt_cont_test_new_1;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_hyd_hyb_2_opt_cont_test_new_1;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_hyd_hyb_2_opt_cont_test_new_1;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c3_hyd_hyb_2_opt_cont_test_new_1;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_hyd_hyb_2_opt_cont_test_new_1;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_hyd_hyb_2_opt_cont_test_new_1;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_hyd_hyb_2_opt_cont_test_new_1;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_hyd_hyb_2_opt_cont_test_new_1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_hyd_hyb_2_opt_cont_test_new_1;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_hyd_hyb_2_opt_cont_test_new_1;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_hyd_hyb_2_opt_cont_test_new_1;
...
void c3_hyd_hyb_2_opt_cont_test_new_1_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_hyd_hyb_2_opt_cont_test_new_1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_hyd_hyb_2_opt_cont_test_new_1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_hyd_hyb_2_opt_cont_test_new_1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_hyd_hyb_2_opt_cont_test_new_1_method_dispatcher.\n"
