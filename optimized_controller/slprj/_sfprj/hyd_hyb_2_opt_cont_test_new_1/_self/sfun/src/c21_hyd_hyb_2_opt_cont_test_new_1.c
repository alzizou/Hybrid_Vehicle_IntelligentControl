...
#include "c21_hyd_hyb_2_opt_cont_test_new_1.h"
...
static void initialize_c21_hyd_hyb_2_opt_cont_test_new_1
  (SFc21_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance);
static void initialize_params_c21_hyd_hyb_2_opt_cont_test_new_1
  (SFc21_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance);
static void enable_c21_hyd_hyb_2_opt_cont_test_new_1
  (SFc21_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance);
static void disable_c21_hyd_hyb_2_opt_cont_test_new_1
  (SFc21_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance);
static void c21_update_debugger_state_c21_hyd_hyb_2_opt_cont_test_new_1
  (SFc21_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c21_hyd_hyb_2_opt_cont_test_new_1
  (SFc21_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance);
static void set_sim_state_c21_hyd_hyb_2_opt_cont_test_new_1
  (SFc21_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance, const
   mxArray *c21_st);
static void finalize_c21_hyd_hyb_2_opt_cont_test_new_1
  (SFc21_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance);
static void sf_c21_hyd_hyb_2_opt_cont_test_new_1
  (SFc21_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance);
static void initSimStructsc21_hyd_hyb_2_opt_cont_test_new_1
  (SFc21_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance);
...
static real_T c21_emlrt_marshallIn
  (SFc21_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance, const
   mxArray *c21_y, const char_T *c21_identifier);
...
static uint8_T c21_d_emlrt_marshallIn
  (SFc21_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance, const
   mxArray *c21_b_is_active_c21_hyd_hyb_2_opt_cont_test_new_1, const char_T
   *c21_identifier);
  ...
  (SFc21_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance)
{
  ...
  chartInstance->c21_is_active_c21_hyd_hyb_2_opt_cont_test_new_1 = 0U;
}
  ...
  (SFc21_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance)
{
  ...
  c21_b_hoistedGlobal =
    chartInstance->c21_is_active_c21_hyd_hyb_2_opt_cont_test_new_1;
   ...
   mxArray *c21_st)
{
  ...
  *c21_y = c21_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c21_u,
  ...
  chartInstance->c21_is_active_c21_hyd_hyb_2_opt_cont_test_new_1 =
    ...
    "is_active_c21_hyd_hyb_2_opt_cont_test_new_1");
  sf_mex_destroy(&c21_u);
  c21_update_debugger_state_c21_hyd_hyb_2_opt_cont_test_new_1(chartInstance);
  ...
  *c21_inData)
{
  ...
  const mxArray *c21_y = NULL;
  SFc21_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance;
  chartInstance = (SFc21_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *)
    chartInstanceVoid;
   ...
   *c21_identifier)
{
  ...
  c21_y = c21_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c21_b_is_active_c21_hyd_hyb_2_opt_cont_test_new_1), &c21_thisId);
  sf_mex_destroy(&c21_b_is_active_c21_hyd_hyb_2_opt_cont_test_new_1);
  return c21_y;
}
...
/* SFunction Glue Code */
void sf_c21_hyd_hyb_2_opt_cont_test_new_1_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c21_hyd_hyb_2_opt_cont_test_new_1_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c21_hyd_hyb_2_opt_cont_test_new_1
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c21_hyd_hyb_2_opt_cont_test_new_1\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c21_hyd_hyb_2_opt_cont_test_new_1_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c21_hyd_hyb_2_opt_cont_test_new_1(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc21_hyd_hyb_2_opt_cont_test_new_1InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c21_hyd_hyb_2_opt_cont_test_new_1
    ((SFc21_hyd_hyb_2_opt_cont_test_new_1InstanceStruct*) chartInstanceVar);
  initialize_c21_hyd_hyb_2_opt_cont_test_new_1
    ((SFc21_hyd_hyb_2_opt_cont_test_new_1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c21_hyd_hyb_2_opt_cont_test_new_1(void
  *chartInstanceVar)
{
  enable_c21_hyd_hyb_2_opt_cont_test_new_1
    ((SFc21_hyd_hyb_2_opt_cont_test_new_1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c21_hyd_hyb_2_opt_cont_test_new_1(void
  *chartInstanceVar)
{
  disable_c21_hyd_hyb_2_opt_cont_test_new_1
    ((SFc21_hyd_hyb_2_opt_cont_test_new_1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c21_hyd_hyb_2_opt_cont_test_new_1(void
  *chartInstanceVar)
{
  sf_c21_hyd_hyb_2_opt_cont_test_new_1
    ((SFc21_hyd_hyb_2_opt_cont_test_new_1InstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c21_hyd_hyb_2_opt_cont_test_new_1(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c21_hyd_hyb_2_opt_cont_test_new_1
    ((SFc21_hyd_hyb_2_opt_cont_test_new_1InstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c21_hyd_hyb_2_opt_cont_test_new_1();/* state var info */
...
extern void sf_internal_set_sim_state_c21_hyd_hyb_2_opt_cont_test_new_1
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c21_hyd_hyb_2_opt_cont_test_new_1
    ((SFc21_hyd_hyb_2_opt_cont_test_new_1InstanceStruct*)
     chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c21_hyd_hyb_2_opt_cont_test_new_1
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c21_hyd_hyb_2_opt_cont_test_new_1(S);
}

static void sf_opaque_set_sim_state_c21_hyd_hyb_2_opt_cont_test_new_1(SimStruct*
  S, const mxArray *st)
{
  sf_internal_set_sim_state_c21_hyd_hyb_2_opt_cont_test_new_1(S, st);
}

static void sf_opaque_terminate_c21_hyd_hyb_2_opt_cont_test_new_1(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc21_hyd_hyb_2_opt_cont_test_new_1InstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c21_hyd_hyb_2_opt_cont_test_new_1
      ((SFc21_hyd_hyb_2_opt_cont_test_new_1InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc21_hyd_hyb_2_opt_cont_test_new_1
    ((SFc21_hyd_hyb_2_opt_cont_test_new_1InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c21_hyd_hyb_2_opt_cont_test_new_1(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c21_hyd_hyb_2_opt_cont_test_new_1
      ((SFc21_hyd_hyb_2_opt_cont_test_new_1InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c21_hyd_hyb_2_opt_cont_test_new_1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"hyd_hyb_2_opt_cont_test_new_1",
      "hyd_hyb_2_opt_cont_test_new_1",21);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"hyd_hyb_2_opt_cont_test_new_1",
                "hyd_hyb_2_opt_cont_test_new_1",21,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,
      "hyd_hyb_2_opt_cont_test_new_1","hyd_hyb_2_opt_cont_test_new_1",21,
      "gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"hyd_hyb_2_opt_cont_test_new_1",
        "hyd_hyb_2_opt_cont_test_new_1",21,2);
      sf_mark_chart_reusable_outputs(S,"hyd_hyb_2_opt_cont_test_new_1",
        "hyd_hyb_2_opt_cont_test_new_1",21,1);
    }
...
static void mdlRTW_c21_hyd_hyb_2_opt_cont_test_new_1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c21_hyd_hyb_2_opt_cont_test_new_1(SimStruct *S)
{
  SFc21_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *chartInstance;
  chartInstance = (SFc21_hyd_hyb_2_opt_cont_test_new_1InstanceStruct *)malloc
    (sizeof(SFc21_hyd_hyb_2_opt_cont_test_new_1InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c21_hyd_hyb_2_opt_cont_test_new_1;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c21_hyd_hyb_2_opt_cont_test_new_1;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c21_hyd_hyb_2_opt_cont_test_new_1;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c21_hyd_hyb_2_opt_cont_test_new_1;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c21_hyd_hyb_2_opt_cont_test_new_1;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c21_hyd_hyb_2_opt_cont_test_new_1;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c21_hyd_hyb_2_opt_cont_test_new_1;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c21_hyd_hyb_2_opt_cont_test_new_1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c21_hyd_hyb_2_opt_cont_test_new_1;
  chartInstance->chartInfo.mdlStart = mdlStart_c21_hyd_hyb_2_opt_cont_test_new_1;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c21_hyd_hyb_2_opt_cont_test_new_1;
...
void c21_hyd_hyb_2_opt_cont_test_new_1_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c21_hyd_hyb_2_opt_cont_test_new_1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c21_hyd_hyb_2_opt_cont_test_new_1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c21_hyd_hyb_2_opt_cont_test_new_1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c21_hyd_hyb_2_opt_cont_test_new_1_method_dispatcher.\n"
