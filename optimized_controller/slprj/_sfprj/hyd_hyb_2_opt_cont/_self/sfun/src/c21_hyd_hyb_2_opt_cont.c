...
static void initialize_c21_hyd_hyb_2_opt_cont
  (SFc21_hyd_hyb_2_opt_contInstanceStruct *chartInstance);
static void initialize_params_c21_hyd_hyb_2_opt_cont
  (SFc21_hyd_hyb_2_opt_contInstanceStruct *chartInstance);
static void enable_c21_hyd_hyb_2_opt_cont(SFc21_hyd_hyb_2_opt_contInstanceStruct
  *chartInstance);
static void disable_c21_hyd_hyb_2_opt_cont
  (SFc21_hyd_hyb_2_opt_contInstanceStruct *chartInstance);
static void c21_update_debugger_state_c21_hyd_hyb_2_opt_cont
  (SFc21_hyd_hyb_2_opt_contInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c21_hyd_hyb_2_opt_cont
  (SFc21_hyd_hyb_2_opt_contInstanceStruct *chartInstance);
static void set_sim_state_c21_hyd_hyb_2_opt_cont
  (SFc21_hyd_hyb_2_opt_contInstanceStruct *chartInstance, const mxArray *c21_st);
static void finalize_c21_hyd_hyb_2_opt_cont
  (SFc21_hyd_hyb_2_opt_contInstanceStruct *chartInstance);
static void sf_c21_hyd_hyb_2_opt_cont(SFc21_hyd_hyb_2_opt_contInstanceStruct
  *chartInstance);
static void initSimStructsc21_hyd_hyb_2_opt_cont
  (SFc21_hyd_hyb_2_opt_contInstanceStruct *chartInstance);
...
static const mxArray *c21_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static real_T c21_emlrt_marshallIn(SFc21_hyd_hyb_2_opt_contInstanceStruct
  *chartInstance, const mxArray *c21_y, const char_T *c21_identifier);
static real_T c21_b_emlrt_marshallIn(SFc21_hyd_hyb_2_opt_contInstanceStruct
...
static const mxArray *c21_c_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static int32_T c21_c_emlrt_marshallIn(SFc21_hyd_hyb_2_opt_contInstanceStruct
  *chartInstance, const mxArray *c21_u, const emlrtMsgIdentifier *c21_parentId);
static void c21_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c21_mxArrayInData, const char_T *c21_varName, void *c21_outData);
static uint8_T c21_d_emlrt_marshallIn(SFc21_hyd_hyb_2_opt_contInstanceStruct
  *chartInstance, const mxArray *c21_b_is_active_c21_hyd_hyb_2_opt_cont, const
  char_T *c21_identifier);
static uint8_T c21_e_emlrt_marshallIn(SFc21_hyd_hyb_2_opt_contInstanceStruct
  *chartInstance, const mxArray *c21_u, const emlrtMsgIdentifier *c21_parentId);
static void init_dsm_address_info(SFc21_hyd_hyb_2_opt_contInstanceStruct
  *chartInstance);
  ...
  (SFc21_hyd_hyb_2_opt_contInstanceStruct *chartInstance)
{
  ...
  chartInstance->c21_is_active_c21_hyd_hyb_2_opt_cont = 0U;
}
  ...
  (SFc21_hyd_hyb_2_opt_contInstanceStruct *chartInstance)
{
  ...
  c21_b_hoistedGlobal = chartInstance->c21_is_active_c21_hyd_hyb_2_opt_cont;
  ...
  (SFc21_hyd_hyb_2_opt_contInstanceStruct *chartInstance, const mxArray *c21_st)
{
  ...
  *c21_y = c21_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c21_u,
    0)), "y");
  chartInstance->c21_is_active_c21_hyd_hyb_2_opt_cont = c21_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c21_u, 1)),
     "is_active_c21_hyd_hyb_2_opt_cont");
  sf_mex_destroy(&c21_u);
  c21_update_debugger_state_c21_hyd_hyb_2_opt_cont(chartInstance);
  ...
  *c21_inData)
{
  ...
  const mxArray *c21_y = NULL;
  SFc21_hyd_hyb_2_opt_contInstanceStruct *chartInstance;
  chartInstance = (SFc21_hyd_hyb_2_opt_contInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c21_hyd_hyb_2_opt_cont_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c21_identifier)
{
  ...
  c21_y = c21_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c21_b_is_active_c21_hyd_hyb_2_opt_cont), &c21_thisId);
  sf_mex_destroy(&c21_b_is_active_c21_hyd_hyb_2_opt_cont);
  return c21_y;
}
...
/* SFunction Glue Code */
void sf_c21_hyd_hyb_2_opt_cont_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c21_hyd_hyb_2_opt_cont_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c21_hyd_hyb_2_opt_cont(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c21_hyd_hyb_2_opt_cont\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c21_hyd_hyb_2_opt_cont_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc21_hyd_hyb_2_opt_contInstanceStruct *chartInstance;
    chartInstance = (SFc21_hyd_hyb_2_opt_contInstanceStruct *) ((ChartInfoStruct
...
static void sf_opaque_initialize_c21_hyd_hyb_2_opt_cont(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc21_hyd_hyb_2_opt_contInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c21_hyd_hyb_2_opt_cont
    ((SFc21_hyd_hyb_2_opt_contInstanceStruct*) chartInstanceVar);
  initialize_c21_hyd_hyb_2_opt_cont((SFc21_hyd_hyb_2_opt_contInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c21_hyd_hyb_2_opt_cont(void *chartInstanceVar)
{
  enable_c21_hyd_hyb_2_opt_cont((SFc21_hyd_hyb_2_opt_contInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c21_hyd_hyb_2_opt_cont(void *chartInstanceVar)
{
  disable_c21_hyd_hyb_2_opt_cont((SFc21_hyd_hyb_2_opt_contInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c21_hyd_hyb_2_opt_cont(void *chartInstanceVar)
{
  sf_c21_hyd_hyb_2_opt_cont((SFc21_hyd_hyb_2_opt_contInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c21_hyd_hyb_2_opt_cont(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c21_hyd_hyb_2_opt_cont
    ((SFc21_hyd_hyb_2_opt_contInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c21_hyd_hyb_2_opt_cont();/* state var info */
...
extern void sf_internal_set_sim_state_c21_hyd_hyb_2_opt_cont(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c21_hyd_hyb_2_opt_cont((SFc21_hyd_hyb_2_opt_contInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c21_hyd_hyb_2_opt_cont(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c21_hyd_hyb_2_opt_cont(S);
}

static void sf_opaque_set_sim_state_c21_hyd_hyb_2_opt_cont(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c21_hyd_hyb_2_opt_cont(S, st);
}

static void sf_opaque_terminate_c21_hyd_hyb_2_opt_cont(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc21_hyd_hyb_2_opt_contInstanceStruct*) chartInstanceVar
      )->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c21_hyd_hyb_2_opt_cont((SFc21_hyd_hyb_2_opt_contInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc21_hyd_hyb_2_opt_cont((SFc21_hyd_hyb_2_opt_contInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c21_hyd_hyb_2_opt_cont(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c21_hyd_hyb_2_opt_cont
      ((SFc21_hyd_hyb_2_opt_contInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c21_hyd_hyb_2_opt_cont(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c21_hyd_hyb_2_opt_cont(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "hyd_hyb_2_opt_cont", "hyd_hyb_2_opt_cont",21);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c21_hyd_hyb_2_opt_cont(SimStruct *S)
{
  SFc21_hyd_hyb_2_opt_contInstanceStruct *chartInstance;
  chartInstance = (SFc21_hyd_hyb_2_opt_contInstanceStruct *)malloc(sizeof
    (SFc21_hyd_hyb_2_opt_contInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc21_hyd_hyb_2_opt_contInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c21_hyd_hyb_2_opt_cont;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c21_hyd_hyb_2_opt_cont;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c21_hyd_hyb_2_opt_cont;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c21_hyd_hyb_2_opt_cont;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c21_hyd_hyb_2_opt_cont;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c21_hyd_hyb_2_opt_cont;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c21_hyd_hyb_2_opt_cont;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c21_hyd_hyb_2_opt_cont;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c21_hyd_hyb_2_opt_cont;
  chartInstance->chartInfo.mdlStart = mdlStart_c21_hyd_hyb_2_opt_cont;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c21_hyd_hyb_2_opt_cont;
...
void c21_hyd_hyb_2_opt_cont_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c21_hyd_hyb_2_opt_cont(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c21_hyd_hyb_2_opt_cont(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c21_hyd_hyb_2_opt_cont(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c21_hyd_hyb_2_opt_cont_method_dispatcher.\n"
