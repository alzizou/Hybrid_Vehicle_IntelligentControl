...
#include "hyd_hyb_2_sec_con_1_sfun.h"
#include "c3_hyd_hyb_2_sec_con_1.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "hyd_hyb_2_sec_con_1_sfun_debug_macros.h"
...
static void initialize_c3_hyd_hyb_2_sec_con_1
  (SFc3_hyd_hyb_2_sec_con_1InstanceStruct *chartInstance);
static void initialize_params_c3_hyd_hyb_2_sec_con_1
  (SFc3_hyd_hyb_2_sec_con_1InstanceStruct *chartInstance);
static void enable_c3_hyd_hyb_2_sec_con_1(SFc3_hyd_hyb_2_sec_con_1InstanceStruct
  *chartInstance);
static void disable_c3_hyd_hyb_2_sec_con_1
  (SFc3_hyd_hyb_2_sec_con_1InstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_hyd_hyb_2_sec_con_1
  (SFc3_hyd_hyb_2_sec_con_1InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_hyd_hyb_2_sec_con_1
  (SFc3_hyd_hyb_2_sec_con_1InstanceStruct *chartInstance);
static void set_sim_state_c3_hyd_hyb_2_sec_con_1
  (SFc3_hyd_hyb_2_sec_con_1InstanceStruct *chartInstance, const mxArray *c3_st);
static void c3_set_sim_state_side_effects_c3_hyd_hyb_2_sec_con_1
  (SFc3_hyd_hyb_2_sec_con_1InstanceStruct *chartInstance);
static void finalize_c3_hyd_hyb_2_sec_con_1
  (SFc3_hyd_hyb_2_sec_con_1InstanceStruct *chartInstance);
static void sf_c3_hyd_hyb_2_sec_con_1(SFc3_hyd_hyb_2_sec_con_1InstanceStruct
  *chartInstance);
static void c3_chartstep_c3_hyd_hyb_2_sec_con_1
  (SFc3_hyd_hyb_2_sec_con_1InstanceStruct *chartInstance);
static void initSimStructsc3_hyd_hyb_2_sec_con_1
  (SFc3_hyd_hyb_2_sec_con_1InstanceStruct *chartInstance);
static void c3_exit_internal_state2(SFc3_hyd_hyb_2_sec_con_1InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static int32_T c3_emlrt_marshallIn(SFc3_hyd_hyb_2_sec_con_1InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static uint8_T c3_b_emlrt_marshallIn(SFc3_hyd_hyb_2_sec_con_1InstanceStruct
  *chartInstance, const mxArray *c3_c_tp_state1, const char_T *c3_identifier);
static uint8_T c3_c_emlrt_marshallIn(SFc3_hyd_hyb_2_sec_con_1InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_d_emlrt_marshallIn(SFc3_hyd_hyb_2_sec_con_1InstanceStruct
  *chartInstance, const mxArray *c3_T_eng, const char_T *c3_identifier);
static real_T c3_e_emlrt_marshallIn(SFc3_hyd_hyb_2_sec_con_1InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_f_emlrt_marshallIn
  (SFc3_hyd_hyb_2_sec_con_1InstanceStruct *chartInstance, const mxArray
   *c3_b_setSimStateSideEffectsInfo, const char_T *c3_identifier);
static const mxArray *c3_g_emlrt_marshallIn
  (SFc3_hyd_hyb_2_sec_con_1InstanceStruct *chartInstance, const mxArray *c3_u,
   const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_hyd_hyb_2_sec_con_1InstanceStruct
  *chartInstance);
  ...
  (SFc3_hyd_hyb_2_sec_con_1InstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_hyd_hyb_2_sec_con_1 = 0U;
  chartInstance->c3_is_c3_hyd_hyb_2_sec_con_1 = 0U;
  ...
  (SFc3_hyd_hyb_2_sec_con_1InstanceStruct *chartInstance)
{
  ...
  if ((int16_T)chartInstance->c3_is_active_c3_hyd_hyb_2_sec_con_1 == 1) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 2U, chartInstance->c3_sfEvent);
  }

  if (chartInstance->c3_is_c3_hyd_hyb_2_sec_con_1 == c3_IN_state1) {
  ...
  if (chartInstance->c3_is_c3_hyd_hyb_2_sec_con_1 == c3_IN_state2) {
  ...
  if (chartInstance->c3_is_c3_hyd_hyb_2_sec_con_1 == c3_IN_state3) {
  ...
  (SFc3_hyd_hyb_2_sec_con_1InstanceStruct *chartInstance)
{
  ...
  c3_d_hoistedGlobal = chartInstance->c3_is_active_c3_hyd_hyb_2_sec_con_1;
  c3_d_u = c3_d_hoistedGlobal;
  c3_e_y = NULL;
  sf_mex_assign(&c3_e_y, sf_mex_create("y", &c3_d_u, 3, 0U, 0U, 0U, 0));
  sf_mex_setcell(c3_y, 3, c3_e_y);
  c3_e_hoistedGlobal = chartInstance->c3_is_c3_hyd_hyb_2_sec_con_1;
  ...
  (SFc3_hyd_hyb_2_sec_con_1InstanceStruct *chartInstance, const mxArray *c3_st)
{
  ...
  *c3_b_u = c3_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u,
    2)), "u");
  chartInstance->c3_is_active_c3_hyd_hyb_2_sec_con_1 = c3_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 3)),
     "is_active_c3_hyd_hyb_2_sec_con_1");
  chartInstance->c3_is_c3_hyd_hyb_2_sec_con_1 = c3_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 4)),
     "is_c3_hyd_hyb_2_sec_con_1");
  ...
  sf_mex_assign(&chartInstance->c3_setSimStateSideEffectsInfo,
    ...
    (c3_u, 6)), "setSimStateSideEffectsInfo"));
  sf_mex_destroy(&c3_u);
  chartInstance->c3_doSetSimStateSideEffects = 1U;
  c3_update_debugger_state_c3_hyd_hyb_2_sec_con_1(chartInstance);
  ...
  *chartInstance)
{
  ...
  c3_set_sim_state_side_effects_c3_hyd_hyb_2_sec_con_1(chartInstance);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  ...
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_hyd_hyb_2_sec_con_1(chartInstance);
  sf_debug_check_for_state_inconsistency(_hyd_hyb_2_sec_con_1MachineNumber_,
  ...
  (SFc3_hyd_hyb_2_sec_con_1InstanceStruct *chartInstance)
{
  ...
  if ((int16_T)chartInstance->c3_is_active_c3_hyd_hyb_2_sec_con_1 == 0) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 2U, chartInstance->c3_sfEvent);
    chartInstance->c3_is_active_c3_hyd_hyb_2_sec_con_1 = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 2U, chartInstance->c3_sfEvent);
    _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 0U, chartInstance->c3_sfEvent);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
    chartInstance->c3_is_c3_hyd_hyb_2_sec_con_1 = c3_IN_state1;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
    chartInstance->c3_tp_state1 = 1U;
  } else {
    switch (chartInstance->c3_is_c3_hyd_hyb_2_sec_con_1) {
     case c3_IN_state1:
      CV_CHART_EVAL(2, 0, 1);
      ...
      if (CV_TRANSITION_EVAL(2U, (int32_T)_SFD_CCP_CALL(2U, 0, *c3_soc <=
        ...
        chartInstance->c3_tp_state1 = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
        chartInstance->c3_is_c3_hyd_hyb_2_sec_con_1 = c3_IN_state3;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 5U, chartInstance->c3_sfEvent);
        chartInstance->c3_b_tp_state3 = 1U;
      } else {
        ...
        if (CV_TRANSITION_EVAL(1U, (int32_T)c3_b_temp)) {
          ...
          chartInstance->c3_tp_state1 = 0U;
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
          chartInstance->c3_is_c3_hyd_hyb_2_sec_con_1 = c3_IN_state2;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c3_sfEvent);
          chartInstance->c3_b_tp_state2 = 1U;
     ...
     case c3_IN_state2:
      ...
      if (CV_TRANSITION_EVAL(3U, (int32_T)_SFD_CCP_CALL(3U, 0, *c3_soc <=
        ...
        if (CV_TRANSITION_EVAL(11U, (int32_T)c3_c_temp)) {
     ...
     case c3_IN_state3:
      ...
      if (CV_TRANSITION_EVAL(10U, (int32_T)c3_d_temp)) {
        if (sf_debug_transition_conflict_check_enabled()) {
          unsigned int transitionList[2];
          unsigned int numTransitions = 1;
          transitionList[0] = 10;
        ...
        if (CV_TRANSITION_EVAL(4U, (int32_T)c3_e_temp)) {
     ...
     default:
      CV_CHART_EVAL(2, 0, 0);
      chartInstance->c3_is_c3_hyd_hyb_2_sec_con_1 = (uint8_T)
...
const mxArray *sf_c3_hyd_hyb_2_sec_con_1_get_eml_resolved_functions_info(void)
{
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_hyd_hyb_2_sec_con_1InstanceStruct *chartInstance;
  chartInstance = (SFc3_hyd_hyb_2_sec_con_1InstanceStruct *)chartInstanceVoid;
...
/* SFunction Glue Code */
void sf_c3_hyd_hyb_2_sec_con_1_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(604275523U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(839313420U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2954381206U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3721064345U);
}

mxArray *sf_c3_hyd_hyb_2_sec_con_1_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c3_hyd_hyb_2_sec_con_1(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x6'type','srcId','name','auxInfo'{{M[1],M[4],T\"T_eng\",},{M[1],M[6],T\"T_pm\",},{M[1],M[215],T\"u\",},{M[8],M[0],T\"is_active_c3_hyd_hyb_2_sec_con_1\",},{M[9],M[0],T\"is_c3_hyd_hyb_2_sec_con_1\",},{M[9],M[12],T\"is_state2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 6, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_hyd_hyb_2_sec_con_1_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc3_hyd_hyb_2_sec_con_1InstanceStruct *chartInstance;
    chartInstance = (SFc3_hyd_hyb_2_sec_con_1InstanceStruct *) ((ChartInfoStruct
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (_hyd_hyb_2_sec_con_1MachineNumber_,
           3,
           6,
           12,
           18,
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_hyd_hyb_2_sec_con_1MachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (_hyd_hyb_2_sec_con_1MachineNumber_,chartInstance->chartNumber,1);
          sf_debug_set_chart_event_thresholds(_hyd_hyb_2_sec_con_1MachineNumber_,
            chartInstance->chartNumber,
            0,
            0,
            0);
      ...
      sf_debug_reset_current_state_configuration
        (_hyd_hyb_2_sec_con_1MachineNumber_,chartInstance->chartNumber,
         chartInstance->instanceNumber);
    }
  }
}

static void sf_opaque_initialize_c3_hyd_hyb_2_sec_con_1(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_hyd_hyb_2_sec_con_1InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_hyd_hyb_2_sec_con_1
    ((SFc3_hyd_hyb_2_sec_con_1InstanceStruct*) chartInstanceVar);
  initialize_c3_hyd_hyb_2_sec_con_1((SFc3_hyd_hyb_2_sec_con_1InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c3_hyd_hyb_2_sec_con_1(void *chartInstanceVar)
{
  enable_c3_hyd_hyb_2_sec_con_1((SFc3_hyd_hyb_2_sec_con_1InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c3_hyd_hyb_2_sec_con_1(void *chartInstanceVar)
{
  disable_c3_hyd_hyb_2_sec_con_1((SFc3_hyd_hyb_2_sec_con_1InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c3_hyd_hyb_2_sec_con_1(void *chartInstanceVar)
{
  sf_c3_hyd_hyb_2_sec_con_1((SFc3_hyd_hyb_2_sec_con_1InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_hyd_hyb_2_sec_con_1(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_hyd_hyb_2_sec_con_1
    ((SFc3_hyd_hyb_2_sec_con_1InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_hyd_hyb_2_sec_con_1();/* state var info */
...
extern void sf_internal_set_sim_state_c3_hyd_hyb_2_sec_con_1(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c3_hyd_hyb_2_sec_con_1((SFc3_hyd_hyb_2_sec_con_1InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_hyd_hyb_2_sec_con_1(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c3_hyd_hyb_2_sec_con_1(S);
}

static void sf_opaque_set_sim_state_c3_hyd_hyb_2_sec_con_1(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c3_hyd_hyb_2_sec_con_1(S, st);
}

static void sf_opaque_terminate_c3_hyd_hyb_2_sec_con_1(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_hyd_hyb_2_sec_con_1InstanceStruct*) chartInstanceVar
      )->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c3_hyd_hyb_2_sec_con_1((SFc3_hyd_hyb_2_sec_con_1InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc3_hyd_hyb_2_sec_con_1((SFc3_hyd_hyb_2_sec_con_1InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_hyd_hyb_2_sec_con_1(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c3_hyd_hyb_2_sec_con_1
      ((SFc3_hyd_hyb_2_sec_con_1InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c3_hyd_hyb_2_sec_con_1(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"hyd_hyb_2_sec_con_1","hyd_hyb_2_sec_con_1",
      3);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"hyd_hyb_2_sec_con_1",
                "hyd_hyb_2_sec_con_1",3,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"hyd_hyb_2_sec_con_1",
      "hyd_hyb_2_sec_con_1",3,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"hyd_hyb_2_sec_con_1",
        "hyd_hyb_2_sec_con_1",3,6);
      sf_mark_chart_reusable_outputs(S,"hyd_hyb_2_sec_con_1",
        "hyd_hyb_2_sec_con_1",3,3);
    }

    sf_set_rtw_dwork_info(S,"hyd_hyb_2_sec_con_1","hyd_hyb_2_sec_con_1",3);
    ssSetHasSubFunctions(S,!(chartIsInlinable));
  } else {
  }

  ssSetOptions(S,ssGetOptions(S)|SS_OPTION_WORKS_WITH_CODE_REUSE);
  ssSetChecksum0(S,(393809730U));
  ssSetChecksum1(S,(366380990U));
  ssSetChecksum2(S,(1896849006U));
  ssSetChecksum3(S,(1557179879U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c3_hyd_hyb_2_sec_con_1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "hyd_hyb_2_sec_con_1", "hyd_hyb_2_sec_con_1",3);
    ssWriteRTWStrParam(S, "StateflowChartType", "Stateflow");
  }
}

static void mdlStart_c3_hyd_hyb_2_sec_con_1(SimStruct *S)
{
  SFc3_hyd_hyb_2_sec_con_1InstanceStruct *chartInstance;
  chartInstance = (SFc3_hyd_hyb_2_sec_con_1InstanceStruct *)malloc(sizeof
    (SFc3_hyd_hyb_2_sec_con_1InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_hyd_hyb_2_sec_con_1InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_hyd_hyb_2_sec_con_1;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_hyd_hyb_2_sec_con_1;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_hyd_hyb_2_sec_con_1;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_hyd_hyb_2_sec_con_1;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_hyd_hyb_2_sec_con_1;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_hyd_hyb_2_sec_con_1;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_hyd_hyb_2_sec_con_1;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_hyd_hyb_2_sec_con_1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_hyd_hyb_2_sec_con_1;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_hyd_hyb_2_sec_con_1;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_hyd_hyb_2_sec_con_1;
...
void c3_hyd_hyb_2_sec_con_1_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_hyd_hyb_2_sec_con_1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_hyd_hyb_2_sec_con_1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_hyd_hyb_2_sec_con_1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_hyd_hyb_2_sec_con_1_method_dispatcher.\n"
