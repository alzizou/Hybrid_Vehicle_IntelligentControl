...
static void initialize_c7_hyd_hyb_2_int_cont_1_new3_5cyc
  (SFc7_hyd_hyb_2_int_cont_1_new3_5cycInstanceStruct *chartInstance);
static void initialize_params_c7_hyd_hyb_2_int_cont_1_new3_5cyc
  (SFc7_hyd_hyb_2_int_cont_1_new3_5cycInstanceStruct *chartInstance);
static void enable_c7_hyd_hyb_2_int_cont_1_new3_5cyc
  (SFc7_hyd_hyb_2_int_cont_1_new3_5cycInstanceStruct *chartInstance);
static void disable_c7_hyd_hyb_2_int_cont_1_new3_5cyc
  (SFc7_hyd_hyb_2_int_cont_1_new3_5cycInstanceStruct *chartInstance);
static void c7_update_debugger_state_c7_hyd_hyb_2_int_cont_1_new3_5cyc
  (SFc7_hyd_hyb_2_int_cont_1_new3_5cycInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c7_hyd_hyb_2_int_cont_1_new3_5cyc
  (SFc7_hyd_hyb_2_int_cont_1_new3_5cycInstanceStruct *chartInstance);
static void set_sim_state_c7_hyd_hyb_2_int_cont_1_new3_5cyc
  (SFc7_hyd_hyb_2_int_cont_1_new3_5cycInstanceStruct *chartInstance, const
   mxArray *c7_st);
static void finalize_c7_hyd_hyb_2_int_cont_1_new3_5cyc
  (SFc7_hyd_hyb_2_int_cont_1_new3_5cycInstanceStruct *chartInstance);
static void sf_c7_hyd_hyb_2_int_cont_1_new3_5cyc
  (SFc7_hyd_hyb_2_int_cont_1_new3_5cycInstanceStruct *chartInstance);
static void initSimStructsc7_hyd_hyb_2_int_cont_1_new3_5cyc
  (SFc7_hyd_hyb_2_int_cont_1_new3_5cycInstanceStruct *chartInstance);
...
static uint8_T c7_d_emlrt_marshallIn
  (SFc7_hyd_hyb_2_int_cont_1_new3_5cycInstanceStruct *chartInstance, const
   mxArray *c7_b_is_active_c7_hyd_hyb_2_int_cont_1_new3_5cyc, const char_T
   *c7_identifier);
  ...
  (SFc7_hyd_hyb_2_int_cont_1_new3_5cycInstanceStruct *chartInstance)
{
  ...
  chartInstance->c7_is_active_c7_hyd_hyb_2_int_cont_1_new3_5cyc = 0U;
}
  ...
  (SFc7_hyd_hyb_2_int_cont_1_new3_5cycInstanceStruct *chartInstance)
{
  ...
  c7_b_hoistedGlobal =
    chartInstance->c7_is_active_c7_hyd_hyb_2_int_cont_1_new3_5cyc;
   ...
   mxArray *c7_st)
{
  ...
  *c7_y = c7_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 0)),
  ...
  chartInstance->c7_is_active_c7_hyd_hyb_2_int_cont_1_new3_5cyc =
    ...
    "is_active_c7_hyd_hyb_2_int_cont_1_new3_5cyc");
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_hyd_hyb_2_int_cont_1_new3_5cyc(chartInstance);
...
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData)
{
  ...
  const mxArray *c7_y = NULL;
  SFc7_hyd_hyb_2_int_cont_1_new3_5cycInstanceStruct *chartInstance;
  chartInstance = (SFc7_hyd_hyb_2_int_cont_1_new3_5cycInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c7_hyd_hyb_2_int_cont_1_new3_5cyc_get_eml_resolved_functions_info(void)
{
   ...
   *c7_identifier)
{
  ...
  c7_y = c7_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c7_b_is_active_c7_hyd_hyb_2_int_cont_1_new3_5cyc), &c7_thisId);
  sf_mex_destroy(&c7_b_is_active_c7_hyd_hyb_2_int_cont_1_new3_5cyc);
  return c7_y;
}
...
/* SFunction Glue Code */
void sf_c7_hyd_hyb_2_int_cont_1_new3_5cyc_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c7_hyd_hyb_2_int_cont_1_new3_5cyc_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c7_hyd_hyb_2_int_cont_1_new3_5cyc
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c7_hyd_hyb_2_int_cont_1_new3_5cyc\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c7_hyd_hyb_2_int_cont_1_new3_5cyc_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c7_hyd_hyb_2_int_cont_1_new3_5cyc(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc7_hyd_hyb_2_int_cont_1_new3_5cycInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c7_hyd_hyb_2_int_cont_1_new3_5cyc
    ((SFc7_hyd_hyb_2_int_cont_1_new3_5cycInstanceStruct*) chartInstanceVar);
  initialize_c7_hyd_hyb_2_int_cont_1_new3_5cyc
    ((SFc7_hyd_hyb_2_int_cont_1_new3_5cycInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c7_hyd_hyb_2_int_cont_1_new3_5cyc(void
  *chartInstanceVar)
{
  enable_c7_hyd_hyb_2_int_cont_1_new3_5cyc
    ((SFc7_hyd_hyb_2_int_cont_1_new3_5cycInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c7_hyd_hyb_2_int_cont_1_new3_5cyc(void
  *chartInstanceVar)
{
  disable_c7_hyd_hyb_2_int_cont_1_new3_5cyc
    ((SFc7_hyd_hyb_2_int_cont_1_new3_5cycInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c7_hyd_hyb_2_int_cont_1_new3_5cyc(void
  *chartInstanceVar)
{
  sf_c7_hyd_hyb_2_int_cont_1_new3_5cyc
    ((SFc7_hyd_hyb_2_int_cont_1_new3_5cycInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c7_hyd_hyb_2_int_cont_1_new3_5cyc(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c7_hyd_hyb_2_int_cont_1_new3_5cyc
    ((SFc7_hyd_hyb_2_int_cont_1_new3_5cycInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c7_hyd_hyb_2_int_cont_1_new3_5cyc();/* state var info */
...
extern void sf_internal_set_sim_state_c7_hyd_hyb_2_int_cont_1_new3_5cyc
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c7_hyd_hyb_2_int_cont_1_new3_5cyc
    ((SFc7_hyd_hyb_2_int_cont_1_new3_5cycInstanceStruct*)
     chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c7_hyd_hyb_2_int_cont_1_new3_5cyc
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c7_hyd_hyb_2_int_cont_1_new3_5cyc(S);
}

static void sf_opaque_set_sim_state_c7_hyd_hyb_2_int_cont_1_new3_5cyc(SimStruct*
  S, const mxArray *st)
{
  sf_internal_set_sim_state_c7_hyd_hyb_2_int_cont_1_new3_5cyc(S, st);
}

static void sf_opaque_terminate_c7_hyd_hyb_2_int_cont_1_new3_5cyc(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc7_hyd_hyb_2_int_cont_1_new3_5cycInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c7_hyd_hyb_2_int_cont_1_new3_5cyc
      ((SFc7_hyd_hyb_2_int_cont_1_new3_5cycInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc7_hyd_hyb_2_int_cont_1_new3_5cyc
    ((SFc7_hyd_hyb_2_int_cont_1_new3_5cycInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_hyd_hyb_2_int_cont_1_new3_5cyc(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c7_hyd_hyb_2_int_cont_1_new3_5cyc
      ((SFc7_hyd_hyb_2_int_cont_1_new3_5cycInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c7_hyd_hyb_2_int_cont_1_new3_5cyc(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"hyd_hyb_2_int_cont_1_new3_5cyc",
      "hyd_hyb_2_int_cont_1_new3_5cyc",7);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"hyd_hyb_2_int_cont_1_new3_5cyc",
                "hyd_hyb_2_int_cont_1_new3_5cyc",7,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,
      "hyd_hyb_2_int_cont_1_new3_5cyc","hyd_hyb_2_int_cont_1_new3_5cyc",7,
      "gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"hyd_hyb_2_int_cont_1_new3_5cyc",
        "hyd_hyb_2_int_cont_1_new3_5cyc",7,2);
      sf_mark_chart_reusable_outputs(S,"hyd_hyb_2_int_cont_1_new3_5cyc",
        "hyd_hyb_2_int_cont_1_new3_5cyc",7,1);
    }
...
static void mdlRTW_c7_hyd_hyb_2_int_cont_1_new3_5cyc(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c7_hyd_hyb_2_int_cont_1_new3_5cyc(SimStruct *S)
{
  SFc7_hyd_hyb_2_int_cont_1_new3_5cycInstanceStruct *chartInstance;
  chartInstance = (SFc7_hyd_hyb_2_int_cont_1_new3_5cycInstanceStruct *)malloc
    (sizeof(SFc7_hyd_hyb_2_int_cont_1_new3_5cycInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c7_hyd_hyb_2_int_cont_1_new3_5cyc;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c7_hyd_hyb_2_int_cont_1_new3_5cyc;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c7_hyd_hyb_2_int_cont_1_new3_5cyc;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c7_hyd_hyb_2_int_cont_1_new3_5cyc;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c7_hyd_hyb_2_int_cont_1_new3_5cyc;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c7_hyd_hyb_2_int_cont_1_new3_5cyc;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c7_hyd_hyb_2_int_cont_1_new3_5cyc;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c7_hyd_hyb_2_int_cont_1_new3_5cyc;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c7_hyd_hyb_2_int_cont_1_new3_5cyc;
  chartInstance->chartInfo.mdlStart = mdlStart_c7_hyd_hyb_2_int_cont_1_new3_5cyc;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c7_hyd_hyb_2_int_cont_1_new3_5cyc;
...
void c7_hyd_hyb_2_int_cont_1_new3_5cyc_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c7_hyd_hyb_2_int_cont_1_new3_5cyc(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_hyd_hyb_2_int_cont_1_new3_5cyc(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_hyd_hyb_2_int_cont_1_new3_5cyc(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_hyd_hyb_2_int_cont_1_new3_5cyc_method_dispatcher.\n"
