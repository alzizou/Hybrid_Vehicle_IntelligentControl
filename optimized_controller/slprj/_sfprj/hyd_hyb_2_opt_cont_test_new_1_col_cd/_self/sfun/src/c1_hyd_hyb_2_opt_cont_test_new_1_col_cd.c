...
static void initialize_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void initialize_params_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void enable_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void disable_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void set_sim_state_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance, const
   mxArray *c1_st);
static void c1_set_sim_state_side_effects_c1_hyd_hyb_2_opt_cont_test_new_1_c
  (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void finalize_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void sf_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void initSimStructsc1_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
  ...
  (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd = 0U;
  chartInstance->c1_is_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd = 0U;
  ...
  (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance)
{
  ...
  if ((int16_T)
      chartInstance->c1_is_active_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd == 1)
  {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
  }

  if (chartInstance->c1_is_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd ==
      c1_IN_Drive) {
  ...
  (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance)
{
  ...
  c1_b_hoistedGlobal =
    chartInstance->c1_is_active_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  c1_b_u = c1_b_hoistedGlobal;
  c1_c_y = NULL;
  sf_mex_assign(&c1_c_y, sf_mex_create("y", &c1_b_u, 3, 0U, 0U, 0U, 0));
  sf_mex_setcell(c1_y, 1, c1_c_y);
  c1_c_hoistedGlobal =
    chartInstance->c1_is_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd;
   ...
   mxArray *c1_st)
{
  ...
  *c1_s = c1_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 0)),
  ...
  chartInstance->c1_is_active_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd =
    ...
    "is_active_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd");
  chartInstance->c1_is_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd =
    c1_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 2)),
    "is_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd");
  ...
  (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance)
{
  ...
  if ((int16_T)
      chartInstance->c1_is_active_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd == 0)
  {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
    chartInstance->c1_is_active_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
    _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 0U, chartInstance->c1_sfEvent);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
    chartInstance->c1_is_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd = c1_IN_Neutral;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c1_sfEvent);
    chartInstance->c1_tp_Neutral = 1U;
  } else {
    switch (chartInstance->c1_is_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd) {
     case c1_IN_Drive:
      CV_CHART_EVAL(0, 0, 1);
     ...
     default:
      CV_CHART_EVAL(0, 0, 0);
      chartInstance->c1_is_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd = (uint8_T)
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance;
  chartInstance = (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *)
    chartInstanceVoid;
...
/* SFunction Glue Code */
void sf_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd_get_autoinheritance_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[9],T\"s\",},{M[8],M[0],T\"is_active_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd\",},{M[9],M[0],T\"is_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"at\",M[2],M[1]}}},{M[13],M[0],T\"previousTicks\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc1_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc1_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*) chartInstanceVar);
  initialize_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc1_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd(void
  *chartInstanceVar)
{
  enable_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc1_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd(void
  *chartInstanceVar)
{
  disable_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc1_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd(void
  *chartInstanceVar)
{
  sf_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc1_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc1_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd();/* state var info */
...
extern void sf_internal_set_sim_state_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc1_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd(S);
}

static void sf_opaque_set_sim_state_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd(S, st);
}

static void sf_opaque_terminate_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd
      ((SFc1_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc1_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc1_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd(SimStruct
  *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      ...
      "hyd_hyb_2_opt_cont_test_new_1_col_cd",1);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"hyd_hyb_2_opt_cont_test_new_1_col_cd",
                "hyd_hyb_2_opt_cont_test_new_1_col_cd",1,"RTWCG"));
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,
        "hyd_hyb_2_opt_cont_test_new_1_col_cd",
        "hyd_hyb_2_opt_cont_test_new_1_col_cd",1,2);
      sf_mark_chart_reusable_outputs(S,"hyd_hyb_2_opt_cont_test_new_1_col_cd",
        "hyd_hyb_2_opt_cont_test_new_1_col_cd",1,1);
    }
...
static void mdlRTW_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd(SimStruct *S)
{
  SFc1_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance;
  chartInstance = (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *)
    malloc(sizeof(SFc1_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd;
...
void c1_hyd_hyb_2_opt_cont_test_new_1_col_cd_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_hyd_hyb_2_opt_cont_test_new_1_col_cd(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_hyd_hyb_2_opt_cont_test_new_1_col_cd_method_dispatcher.\n"
