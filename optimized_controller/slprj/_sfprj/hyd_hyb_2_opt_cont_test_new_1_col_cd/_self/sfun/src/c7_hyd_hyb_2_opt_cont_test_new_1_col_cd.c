...
static void initialize_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc7_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void initialize_params_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc7_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void enable_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc7_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void disable_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc7_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void c7_update_debugger_state_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc7_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc7_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void set_sim_state_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc7_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance, const
   mxArray *c7_st);
static void finalize_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc7_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void sf_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc7_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void initSimStructsc7_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc7_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
...
static uint8_T c7_d_emlrt_marshallIn
  (SFc7_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance, const
   mxArray *c7_b_is_active_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd, const char_T
   *c7_identifier);
  ...
  (SFc7_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance)
{
  ...
  chartInstance->c7_is_active_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd = 0U;
}
  ...
  (SFc7_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance)
{
  ...
  c7_b_hoistedGlobal =
    chartInstance->c7_is_active_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd;
   ...
   mxArray *c7_st)
{
  ...
  *c7_y = c7_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 0)),
  ...
  chartInstance->c7_is_active_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd =
    ...
    "is_active_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd");
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd(chartInstance);
...
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData)
{
  ...
  const mxArray *c7_y = NULL;
  SFc7_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance;
  chartInstance = (SFc7_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *)
    chartInstanceVoid;
   ...
   *c7_identifier)
{
  ...
  c7_y = c7_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c7_b_is_active_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd), &c7_thisId);
  sf_mex_destroy(&c7_b_is_active_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd);
  return c7_y;
}
...
/* SFunction Glue Code */
void sf_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd_get_autoinheritance_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc7_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc7_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*) chartInstanceVar);
  initialize_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc7_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd(void
  *chartInstanceVar)
{
  enable_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc7_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd(void
  *chartInstanceVar)
{
  disable_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc7_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd(void
  *chartInstanceVar)
{
  sf_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc7_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc7_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd();/* state var info */
...
extern void sf_internal_set_sim_state_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc7_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd(SimStruct* S)
{
  return sf_internal_get_sim_state_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd(S);
}

static void sf_opaque_set_sim_state_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd(S, st);
}

static void sf_opaque_terminate_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc7_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd
      ((SFc7_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc7_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc7_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd(SimStruct
  *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"hyd_hyb_2_opt_cont_test_new_1_col_cd",
      "hyd_hyb_2_opt_cont_test_new_1_col_cd",7);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"hyd_hyb_2_opt_cont_test_new_1_col_cd",
                "hyd_hyb_2_opt_cont_test_new_1_col_cd",7,"RTWCG"));
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,
        "hyd_hyb_2_opt_cont_test_new_1_col_cd",
        "hyd_hyb_2_opt_cont_test_new_1_col_cd",7,2);
      sf_mark_chart_reusable_outputs(S,"hyd_hyb_2_opt_cont_test_new_1_col_cd",
        "hyd_hyb_2_opt_cont_test_new_1_col_cd",7,1);
    }
...
static void mdlRTW_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd(SimStruct *S)
{
  SFc7_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance;
  chartInstance = (SFc7_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *)
    malloc(sizeof(SFc7_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd;
...
void c7_hyd_hyb_2_opt_cont_test_new_1_col_cd_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_hyd_hyb_2_opt_cont_test_new_1_col_cd(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_hyd_hyb_2_opt_cont_test_new_1_col_cd_method_dispatcher.\n"
