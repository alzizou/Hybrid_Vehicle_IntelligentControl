...
static void initialize_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc21_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void initialize_params_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc21_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void enable_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc21_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void disable_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc21_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void c21_update_debugger_state_c21_hyd_hyb_2_opt_cont_test_new_1_col_
  (SFc21_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc21_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void set_sim_state_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc21_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance,
   const mxArray *c21_st);
static void finalize_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc21_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void sf_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc21_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void initSimStructsc21_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc21_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
...
static uint8_T c21_d_emlrt_marshallIn
  (SFc21_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance,
   const mxArray *c21_b_is_active_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd,
  ...
  (SFc21_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance)
{
  ...
  chartInstance->c21_is_active_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd = 0U;
}
  ...
  (SFc21_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance)
{
  ...
  c21_b_hoistedGlobal =
    chartInstance->c21_is_active_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd;
   ...
   const mxArray *c21_st)
{
  ...
  *c21_y = c21_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c21_u,
  ...
  chartInstance->c21_is_active_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd =
    ...
    "is_active_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd");
  sf_mex_destroy(&c21_u);
  c21_update_debugger_state_c21_hyd_hyb_2_opt_cont_test_new_1_col_(chartInstance);
  ...
  *c21_inData)
{
  ...
  const mxArray *c21_y = NULL;
  SFc21_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance;
  chartInstance = (SFc21_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *)
    chartInstanceVoid;
   ...
   const char_T *c21_identifier)
{
  ...
  c21_y = c21_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c21_b_is_active_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd), &c21_thisId);
  sf_mex_destroy(&c21_b_is_active_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd);
  return c21_y;
}
...
/* SFunction Glue Code */
void sf_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd_get_autoinheritance_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc21_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc21_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
     chartInstanceVar);
  initialize_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc21_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd(void
  *chartInstanceVar)
{
  enable_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc21_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd(void
  *chartInstanceVar)
{
  disable_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc21_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd(void
  *chartInstanceVar)
{
  sf_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc21_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc21_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd();/* state var info */
...
extern void sf_internal_set_sim_state_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc21_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd(SimStruct* S)
{
  return sf_internal_get_sim_state_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd(S);
}

static void sf_opaque_set_sim_state_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd(S, st);
}

static void sf_opaque_terminate_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc21_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd
      ((SFc21_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc21_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc21_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd(SimStruct *
  S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"hyd_hyb_2_opt_cont_test_new_1_col_cd",
      "hyd_hyb_2_opt_cont_test_new_1_col_cd",21);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"hyd_hyb_2_opt_cont_test_new_1_col_cd",
                "hyd_hyb_2_opt_cont_test_new_1_col_cd",21,"RTWCG"));
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,
        "hyd_hyb_2_opt_cont_test_new_1_col_cd",
        "hyd_hyb_2_opt_cont_test_new_1_col_cd",21,2);
      sf_mark_chart_reusable_outputs(S,"hyd_hyb_2_opt_cont_test_new_1_col_cd",
        "hyd_hyb_2_opt_cont_test_new_1_col_cd",21,1);
    }
...
static void mdlRTW_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd(SimStruct *S)
{
  SFc21_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance;
  chartInstance = (SFc21_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *)
    malloc(sizeof(SFc21_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd;
...
void c21_hyd_hyb_2_opt_cont_test_new_1_col_cd_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c21_hyd_hyb_2_opt_cont_test_new_1_col_cd(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c21_hyd_hyb_2_opt_cont_test_new_1_col_cd_method_dispatcher.\n"
