...
static void initialize_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc16_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void initialize_params_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc16_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void enable_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc16_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void disable_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc16_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void c16_update_debugger_state_c16_hyd_hyb_2_opt_cont_test_new_1_col_
  (SFc16_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc16_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void set_sim_state_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc16_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance,
   const mxArray *c16_st);
static void finalize_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc16_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void sf_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc16_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void initSimStructsc16_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc16_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
...
static uint8_T c16_d_emlrt_marshallIn
  (SFc16_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance,
   const mxArray *c16_b_is_active_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd,
  ...
  (SFc16_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance)
{
  ...
  chartInstance->c16_is_active_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd = 0U;
}
  ...
  (SFc16_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance)
{
  ...
  c16_b_hoistedGlobal =
    chartInstance->c16_is_active_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd;
   ...
   const mxArray *c16_st)
{
  ...
  *c16_y = c16_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c16_u,
  ...
  chartInstance->c16_is_active_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd =
    ...
    "is_active_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd");
  sf_mex_destroy(&c16_u);
  c16_update_debugger_state_c16_hyd_hyb_2_opt_cont_test_new_1_col_(chartInstance);
  ...
  *c16_inData)
{
  ...
  const mxArray *c16_y = NULL;
  SFc16_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance;
  chartInstance = (SFc16_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *)
    chartInstanceVoid;
   ...
   const char_T *c16_identifier)
{
  ...
  c16_y = c16_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c16_b_is_active_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd), &c16_thisId);
  sf_mex_destroy(&c16_b_is_active_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd);
  return c16_y;
}
...
/* SFunction Glue Code */
void sf_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd_get_autoinheritance_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc16_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc16_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
     chartInstanceVar);
  initialize_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc16_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd(void
  *chartInstanceVar)
{
  enable_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc16_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd(void
  *chartInstanceVar)
{
  disable_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc16_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd(void
  *chartInstanceVar)
{
  sf_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc16_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc16_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd();/* state var info */
...
extern void sf_internal_set_sim_state_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc16_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd(SimStruct* S)
{
  return sf_internal_get_sim_state_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd(S);
}

static void sf_opaque_set_sim_state_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd(S, st);
}

static void sf_opaque_terminate_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc16_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd
      ((SFc16_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc16_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc16_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd(SimStruct *
  S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"hyd_hyb_2_opt_cont_test_new_1_col_cd",
      "hyd_hyb_2_opt_cont_test_new_1_col_cd",16);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"hyd_hyb_2_opt_cont_test_new_1_col_cd",
                "hyd_hyb_2_opt_cont_test_new_1_col_cd",16,"RTWCG"));
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,
        "hyd_hyb_2_opt_cont_test_new_1_col_cd",
        "hyd_hyb_2_opt_cont_test_new_1_col_cd",16,2);
      sf_mark_chart_reusable_outputs(S,"hyd_hyb_2_opt_cont_test_new_1_col_cd",
        "hyd_hyb_2_opt_cont_test_new_1_col_cd",16,1);
    }
...
static void mdlRTW_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd(SimStruct *S)
{
  SFc16_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance;
  chartInstance = (SFc16_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *)
    malloc(sizeof(SFc16_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd;
...
void c16_hyd_hyb_2_opt_cont_test_new_1_col_cd_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c16_hyd_hyb_2_opt_cont_test_new_1_col_cd(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c16_hyd_hyb_2_opt_cont_test_new_1_col_cd_method_dispatcher.\n"
