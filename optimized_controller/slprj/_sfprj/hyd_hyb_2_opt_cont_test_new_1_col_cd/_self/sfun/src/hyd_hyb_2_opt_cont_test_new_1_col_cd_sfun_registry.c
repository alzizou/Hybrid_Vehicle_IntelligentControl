...
{
  extern unsigned int
    sf_hyd_hyb_2_opt_cont_test_new_1_col_cd_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_hyd_hyb_2_opt_cont_test_new_1_col_cd_process_check_sum_call(nlhs,plhs,
       nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int
    sf_hyd_hyb_2_opt_cont_test_new_1_col_cd_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "hyd_hyb_2_opt_cont_test_new_1_col_cd") == 0) {
    const mxArray *newRhs[2] = { NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_hyd_hyb_2_opt_cont_test_new_1_col_cd_autoinheritance_info(nlhs,
      plhs,2,newRhs);
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "hyd_hyb_2_opt_cont_test_new_1_col_cd") == 0) {
    ...
    newRhs[1] = prhs[2];
    return
      sf_hyd_hyb_2_opt_cont_test_new_1_col_cd_get_eml_resolved_functions_info
      (nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_hyd_hyb_2_opt_cont_test_new_1_col_cd_method_dispatcher
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"hyd_hyb_2_opt_cont_test_new_1_col_cd")) {
    return(sf_hyd_hyb_2_opt_cont_test_new_1_col_cd_method_dispatcher
...
extern void hyd_hyb_2_opt_cont_test_new_1_col_cd_terminator(void);
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    hyd_hyb_2_opt_cont_test_new_1_col_cd_terminator();
    sf_debug_terminate();
  }
...
extern void hyd_hyb_2_opt_cont_test_new_1_col_cd_initializer(void);
extern void hyd_hyb_2_opt_cont_test_new_1_col_cd_register_exported_symbols
  (SimStruct* S);
extern void hyd_hyb_2_opt_cont_test_new_1_col_cd_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  hyd_hyb_2_opt_cont_test_new_1_col_cd_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      hyd_hyb_2_opt_cont_test_new_1_col_cd_debug_initialize();
    }

    hyd_hyb_2_opt_cont_test_new_1_col_cd_initializer();
  }
