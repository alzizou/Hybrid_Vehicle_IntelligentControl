...
static void initialize_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc3_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void initialize_params_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc3_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void enable_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc3_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void disable_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc3_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc3_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc3_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void set_sim_state_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc3_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance, const
   mxArray *c3_st);
static void finalize_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc3_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void sf_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc3_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
static void initSimStructsc3_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SFc3_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance);
...
static real_T c3_min(SFc3_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct
...
static uint8_T c3_d_emlrt_marshallIn
  (SFc3_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance, const
   mxArray *c3_b_is_active_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd, const char_T
   *c3_identifier);
  ...
  (SFc3_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd = 0U;
}
  ...
  (SFc3_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance)
{
  ...
  c3_d_hoistedGlobal =
    chartInstance->c3_is_active_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd;
   ...
   mxArray *c3_st)
{
  ...
  *c3_T_pm = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u,
  ...
  chartInstance->c3_is_active_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd =
    ...
    "is_active_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd");
  sf_mex_destroy(&c3_u);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance;
  chartInstance = (SFc3_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *)
    chartInstanceVoid;
   ...
   *c3_identifier)
{
  ...
  c3_y = c3_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd);
  return c3_y;
}
...
/* SFunction Glue Code */
void sf_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2255736144U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3390907014U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(340983060U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3563948189U);
}

mxArray *sf_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd_get_autoinheritance_info
  (void)
{
...

  {
    ...
    pr[0] = (double)(1904694071U);
    pr[1] = (double)(1349748334U);
    pr[2] = (double)(3349455804U);
    pr[3] = (double)(1544157726U);
...
static const mxArray
  *sf_get_sim_state_info_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"T_eng\",},{M[1],M[8],T\"T_mech_brk\",},{M[1],M[4],T\"T_pm\",},{M[8],M[0],T\"is_active_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc3_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc3_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*) chartInstanceVar);
  initialize_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc3_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd(void
  *chartInstanceVar)
{
  enable_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc3_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd(void
  *chartInstanceVar)
{
  disable_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc3_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd(void
  *chartInstanceVar)
{
  sf_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc3_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc3_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd();/* state var info */
...
extern void sf_internal_set_sim_state_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc3_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd(S);
}

static void sf_opaque_set_sim_state_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd(S, st);
}

static void sf_opaque_terminate_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd
      ((SFc3_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc3_hyd_hyb_2_opt_cont_test_new_1_col_cd
    ((SFc3_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd(SimStruct
  *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"hyd_hyb_2_opt_cont_test_new_1_col_cd",
      "hyd_hyb_2_opt_cont_test_new_1_col_cd",3);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"hyd_hyb_2_opt_cont_test_new_1_col_cd",
                "hyd_hyb_2_opt_cont_test_new_1_col_cd",3,"RTWCG"));
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,
        "hyd_hyb_2_opt_cont_test_new_1_col_cd",
        "hyd_hyb_2_opt_cont_test_new_1_col_cd",3,5);
      sf_mark_chart_reusable_outputs(S,"hyd_hyb_2_opt_cont_test_new_1_col_cd",
        "hyd_hyb_2_opt_cont_test_new_1_col_cd",3,3);
    }
  ...
  ssSetChecksum0(S,(4045748248U));
  ssSetChecksum1(S,(3486945353U));
  ssSetChecksum2(S,(3430391801U));
  ssSetChecksum3(S,(3476660555U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd(SimStruct *S)
{
  SFc3_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *chartInstance;
  chartInstance = (SFc3_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct *)
    malloc(sizeof(SFc3_hyd_hyb_2_opt_cont_test_new_1_col_cdInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd;
...
void c3_hyd_hyb_2_opt_cont_test_new_1_col_cd_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_hyd_hyb_2_opt_cont_test_new_1_col_cd(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_hyd_hyb_2_opt_cont_test_new_1_col_cd_method_dispatcher.\n"
