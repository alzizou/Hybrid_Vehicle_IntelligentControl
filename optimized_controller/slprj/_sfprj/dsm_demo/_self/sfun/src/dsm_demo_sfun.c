  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3399539117U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1976028084U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2155755716U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2688949550U);
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3707579467U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3056879337U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2194065919U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2258119290U);
  }
...
void dsm_demo_debug_initialize(void)
{
  _dsm_demoMachineNumber_ = sf_debug_initialize_machine("dsm_demo","sfun",0,1,0,
    0,0);
  sf_debug_set_machine_event_thresholds(_dsm_demoMachineNumber_,0,0);
  sf_debug_set_machine_data_thresholds(_dsm_demoMachineNumber_,0);
}
