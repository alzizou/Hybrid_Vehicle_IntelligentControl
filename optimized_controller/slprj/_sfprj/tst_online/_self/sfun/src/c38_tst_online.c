...
static void initialize_c38_tst_online(SFc38_tst_onlineInstanceStruct
  *chartInstance);
static void initialize_params_c38_tst_online(SFc38_tst_onlineInstanceStruct
  *chartInstance);
static void enable_c38_tst_online(SFc38_tst_onlineInstanceStruct *chartInstance);
static void disable_c38_tst_online(SFc38_tst_onlineInstanceStruct *chartInstance);
static void c38_update_debugger_state_c38_tst_online
  (SFc38_tst_onlineInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c38_tst_online
  (SFc38_tst_onlineInstanceStruct *chartInstance);
static void set_sim_state_c38_tst_online(SFc38_tst_onlineInstanceStruct
  *chartInstance, const mxArray *c38_st);
static void finalize_c38_tst_online(SFc38_tst_onlineInstanceStruct
  *chartInstance);
static void sf_c38_tst_online(SFc38_tst_onlineInstanceStruct *chartInstance);
static void c38_chartstep_c38_tst_online(SFc38_tst_onlineInstanceStruct
  *chartInstance);
static void initSimStructsc38_tst_online(SFc38_tst_onlineInstanceStruct
  *chartInstance);
...
static const mxArray *c38_sf_marshallOut(void *chartInstanceVoid, void
  *c38_inData);
static real_T c38_emlrt_marshallIn(SFc38_tst_onlineInstanceStruct *chartInstance,
  const mxArray *c38_PKE, const char_T *c38_identifier);
static real_T c38_b_emlrt_marshallIn(SFc38_tst_onlineInstanceStruct
...
static void c38_eml_scalar_eg(SFc38_tst_onlineInstanceStruct *chartInstance);
static real_T c38_mpower(SFc38_tst_onlineInstanceStruct *chartInstance, real_T
  c38_a);
static const mxArray *c38_c_sf_marshallOut(void *chartInstanceVoid, void
  *c38_inData);
static int32_T c38_c_emlrt_marshallIn(SFc38_tst_onlineInstanceStruct
  *chartInstance, const mxArray *c38_u, const emlrtMsgIdentifier *c38_parentId);
static void c38_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c38_mxArrayInData, const char_T *c38_varName, void *c38_outData);
static uint8_T c38_d_emlrt_marshallIn(SFc38_tst_onlineInstanceStruct
  *chartInstance, const mxArray *c38_b_is_active_c38_tst_online, const char_T
  *c38_identifier);
static uint8_T c38_e_emlrt_marshallIn(SFc38_tst_onlineInstanceStruct
  *chartInstance, const mxArray *c38_u, const emlrtMsgIdentifier *c38_parentId);
static void init_dsm_address_info(SFc38_tst_onlineInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c38_is_active_c38_tst_online = 0U;
}
  ...
  (SFc38_tst_onlineInstanceStruct *chartInstance)
{
  ...
  c38_g_hoistedGlobal = chartInstance->c38_is_active_c38_tst_online;
  ...
  *chartInstance, const mxArray *c38_st)
{
  ...
  *c38_y_avg_dec = c38_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c38_u, 5)), "y_avg_dec");
  chartInstance->c38_is_active_c38_tst_online = c38_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c38_u, 6)),
     "is_active_c38_tst_online");
  sf_mex_destroy(&c38_u);
  c38_update_debugger_state_c38_tst_online(chartInstance);
...
static void sf_c38_tst_online(SFc38_tst_onlineInstanceStruct *chartInstance)
{
  ...
  c38_prc_acc_2_4 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 1U, chartInstance->c38_sfEvent);
  ...
  chartInstance->c38_sfEvent = CALL_EVENT;
  c38_chartstep_c38_tst_online(chartInstance);
  ...
  *chartInstance)
{
  ...
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 1U, chartInstance->c38_sfEvent);
  ...
  *c38_b_RPA = c38_RPA;
  *c38_b_PKE = c38_PKE;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 1U, chartInstance->c38_sfEvent);
}
  ...
  *c38_inData)
{
  ...
  const mxArray *c38_y = NULL;
  SFc38_tst_onlineInstanceStruct *chartInstance;
  chartInstance = (SFc38_tst_onlineInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c38_tst_online_get_eml_resolved_functions_info(void)
{
  ...
  *c38_identifier)
{
  ...
  c38_y = c38_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c38_b_is_active_c38_tst_online), &c38_thisId);
  sf_mex_destroy(&c38_b_is_active_c38_tst_online);
  return c38_y;
}
...
/* SFunction Glue Code */
void sf_c38_tst_online_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c38_tst_online_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c38_tst_online(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x7'type','srcId','name','auxInfo'{{M[1],M[17],T\"PKE\",},{M[1],M[5],T\"RPA\",},{M[1],M[13],T\"prc_acc_2_4\",},{M[1],M[16],T\"prc_spdacc_0_5\",},{M[1],M[14],T\"y_avg_acc\",},{M[1],M[15],T\"y_avg_dec\",},{M[8],M[0],T\"is_active_c38_tst_online\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 7, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c38_tst_online_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc38_tst_onlineInstanceStruct *chartInstance;
    chartInstance = (SFc38_tst_onlineInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c38_tst_online(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc38_tst_onlineInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c38_tst_online((SFc38_tst_onlineInstanceStruct*)
    chartInstanceVar);
  initialize_c38_tst_online((SFc38_tst_onlineInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c38_tst_online(void *chartInstanceVar)
{
  enable_c38_tst_online((SFc38_tst_onlineInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c38_tst_online(void *chartInstanceVar)
{
  disable_c38_tst_online((SFc38_tst_onlineInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c38_tst_online(void *chartInstanceVar)
{
  sf_c38_tst_online((SFc38_tst_onlineInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c38_tst_online(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c38_tst_online
    ((SFc38_tst_onlineInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c38_tst_online();/* state var info */
...
extern void sf_internal_set_sim_state_c38_tst_online(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c38_tst_online((SFc38_tst_onlineInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c38_tst_online(SimStruct* S)
{
  return sf_internal_get_sim_state_c38_tst_online(S);
}

static void sf_opaque_set_sim_state_c38_tst_online(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c38_tst_online(S, st);
}

static void sf_opaque_terminate_c38_tst_online(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc38_tst_onlineInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c38_tst_online((SFc38_tst_onlineInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc38_tst_online((SFc38_tst_onlineInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c38_tst_online(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c38_tst_online(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"tst_online","tst_online",38);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"tst_online","tst_online",38,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"tst_online",
      "tst_online",38,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 2, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 3, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"tst_online","tst_online",38,4);
      sf_mark_chart_reusable_outputs(S,"tst_online","tst_online",38,6);
    }

    sf_set_rtw_dwork_info(S,"tst_online","tst_online",38);
...
static void mdlRTW_c38_tst_online(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "tst_online", "tst_online",38);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c38_tst_online(SimStruct *S)
{
  SFc38_tst_onlineInstanceStruct *chartInstance;
  chartInstance = (SFc38_tst_onlineInstanceStruct *)malloc(sizeof
    (SFc38_tst_onlineInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc38_tst_onlineInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c38_tst_online;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c38_tst_online;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c38_tst_online;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c38_tst_online;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c38_tst_online;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c38_tst_online;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c38_tst_online;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c38_tst_online;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c38_tst_online;
  chartInstance->chartInfo.mdlStart = mdlStart_c38_tst_online;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c38_tst_online;
...
void c38_tst_online_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c38_tst_online(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c38_tst_online(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c38_tst_online(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c38_tst_online_method_dispatcher.\n"
