...
static void initialize_c7_hyd_hyb_2_int_cont_1_5cyc
  (SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct *chartInstance);
static void initialize_params_c7_hyd_hyb_2_int_cont_1_5cyc
  (SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct *chartInstance);
static void enable_c7_hyd_hyb_2_int_cont_1_5cyc
  (SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct *chartInstance);
static void disable_c7_hyd_hyb_2_int_cont_1_5cyc
  (SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct *chartInstance);
static void c7_update_debugger_state_c7_hyd_hyb_2_int_cont_1_5cyc
  (SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c7_hyd_hyb_2_int_cont_1_5cyc
  (SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct *chartInstance);
static void set_sim_state_c7_hyd_hyb_2_int_cont_1_5cyc
  (SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct *chartInstance, const mxArray
   *c7_st);
static void finalize_c7_hyd_hyb_2_int_cont_1_5cyc
  (SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct *chartInstance);
static void sf_c7_hyd_hyb_2_int_cont_1_5cyc
  (SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct *chartInstance);
static void initSimStructsc7_hyd_hyb_2_int_cont_1_5cyc
  (SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c7_machineNumber, uint32_T
  c7_chartNumber);
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData);
static real_T c7_emlrt_marshallIn(SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct
  *chartInstance, const mxArray *c7_y, const char_T *c7_identifier);
static real_T c7_b_emlrt_marshallIn(SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct
...
static uint8_T c7_d_emlrt_marshallIn
  (SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct *chartInstance, const mxArray
   *c7_b_is_active_c7_hyd_hyb_2_int_cont_1_5cyc, const char_T *c7_identifier);
static uint8_T c7_e_emlrt_marshallIn
  (SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct *chartInstance, const mxArray
   *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void init_dsm_address_info(SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct
  *chartInstance);
  ...
  (SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct *chartInstance)
{
  ...
  chartInstance->c7_is_active_c7_hyd_hyb_2_int_cont_1_5cyc = 0U;
}
  ...
  (SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct *chartInstance)
{
  ...
  c7_b_hoistedGlobal = chartInstance->c7_is_active_c7_hyd_hyb_2_int_cont_1_5cyc;
   ...
   *c7_st)
{
  ...
  *c7_y = c7_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 0)),
    "y");
  chartInstance->c7_is_active_c7_hyd_hyb_2_int_cont_1_5cyc =
    c7_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 1)),
    "is_active_c7_hyd_hyb_2_int_cont_1_5cyc");
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_hyd_hyb_2_int_cont_1_5cyc(chartInstance);
...
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData)
{
  ...
  const mxArray *c7_y = NULL;
  SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct *chartInstance;
  chartInstance = (SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c7_hyd_hyb_2_int_cont_1_5cyc_get_eml_resolved_functions_info
  (void)
{
   ...
   *c7_b_is_active_c7_hyd_hyb_2_int_cont_1_5cyc, const char_T *c7_identifier)
{
  ...
  c7_y = c7_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c7_b_is_active_c7_hyd_hyb_2_int_cont_1_5cyc), &c7_thisId);
  sf_mex_destroy(&c7_b_is_active_c7_hyd_hyb_2_int_cont_1_5cyc);
  return c7_y;
}
...
void sf_c7_hyd_hyb_2_int_cont_1_5cyc_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c7_hyd_hyb_2_int_cont_1_5cyc_get_autoinheritance_info(void)
{
...
mxArray *sf_c7_hyd_hyb_2_int_cont_1_5cyc_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c7_hyd_hyb_2_int_cont_1_5cyc_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c7_hyd_hyb_2_int_cont_1_5cyc(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c7_hyd_hyb_2_int_cont_1_5cyc\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c7_hyd_hyb_2_int_cont_1_5cyc_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c7_hyd_hyb_2_int_cont_1_5cyc(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c7_hyd_hyb_2_int_cont_1_5cyc
    ((SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct*) chartInstanceVar);
  initialize_c7_hyd_hyb_2_int_cont_1_5cyc
    ((SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c7_hyd_hyb_2_int_cont_1_5cyc(void *chartInstanceVar)
{
  enable_c7_hyd_hyb_2_int_cont_1_5cyc
    ((SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c7_hyd_hyb_2_int_cont_1_5cyc(void
  *chartInstanceVar)
{
  disable_c7_hyd_hyb_2_int_cont_1_5cyc
    ((SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c7_hyd_hyb_2_int_cont_1_5cyc(void
  *chartInstanceVar)
{
  sf_c7_hyd_hyb_2_int_cont_1_5cyc((SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c7_hyd_hyb_2_int_cont_1_5cyc
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c7_hyd_hyb_2_int_cont_1_5cyc
    ((SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c7_hyd_hyb_2_int_cont_1_5cyc();/* state var info */
...
extern void sf_internal_set_sim_state_c7_hyd_hyb_2_int_cont_1_5cyc(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c7_hyd_hyb_2_int_cont_1_5cyc
    ((SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c7_hyd_hyb_2_int_cont_1_5cyc
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c7_hyd_hyb_2_int_cont_1_5cyc(S);
}

static void sf_opaque_set_sim_state_c7_hyd_hyb_2_int_cont_1_5cyc(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c7_hyd_hyb_2_int_cont_1_5cyc(S, st);
}

static void sf_opaque_terminate_c7_hyd_hyb_2_int_cont_1_5cyc(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c7_hyd_hyb_2_int_cont_1_5cyc
      ((SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc7_hyd_hyb_2_int_cont_1_5cyc
    ((SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_hyd_hyb_2_int_cont_1_5cyc(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c7_hyd_hyb_2_int_cont_1_5cyc
      ((SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c7_hyd_hyb_2_int_cont_1_5cyc(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c7_hyd_hyb_2_int_cont_1_5cyc(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c7_hyd_hyb_2_int_cont_1_5cyc(SimStruct *S)
{
  SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct *chartInstance;
  chartInstance = (SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct *)utMalloc
    (sizeof(SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc7_hyd_hyb_2_int_cont_1_5cycInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c7_hyd_hyb_2_int_cont_1_5cyc;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c7_hyd_hyb_2_int_cont_1_5cyc;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c7_hyd_hyb_2_int_cont_1_5cyc;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c7_hyd_hyb_2_int_cont_1_5cyc;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c7_hyd_hyb_2_int_cont_1_5cyc;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c7_hyd_hyb_2_int_cont_1_5cyc;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c7_hyd_hyb_2_int_cont_1_5cyc;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c7_hyd_hyb_2_int_cont_1_5cyc;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c7_hyd_hyb_2_int_cont_1_5cyc;
  chartInstance->chartInfo.mdlStart = mdlStart_c7_hyd_hyb_2_int_cont_1_5cyc;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c7_hyd_hyb_2_int_cont_1_5cyc;
...
void c7_hyd_hyb_2_int_cont_1_5cyc_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c7_hyd_hyb_2_int_cont_1_5cyc(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_hyd_hyb_2_int_cont_1_5cyc(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_hyd_hyb_2_int_cont_1_5cyc(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_hyd_hyb_2_int_cont_1_5cyc_method_dispatcher.\n"
