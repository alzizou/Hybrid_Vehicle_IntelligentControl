...
static void set_sim_state_c4_untitled(SFc4_untitledInstanceStruct *chartInstance,
  const mxArray *c4_st);
static void c4_set_sim_state_side_effects_c4_untitled
...
static int32_T c4_emlrt_marshallIn(SFc4_untitledInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_b_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static uint8_T c4_b_emlrt_marshallIn(SFc4_untitledInstanceStruct *chartInstance,
  const mxArray *c4_b_tp_state1, const char_T *c4_identifier);
static uint8_T c4_c_emlrt_marshallIn(SFc4_untitledInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static real_T c4_d_emlrt_marshallIn(SFc4_untitledInstanceStruct *chartInstance,
  const mxArray *c4_u1, const char_T *c4_identifier);
static real_T c4_e_emlrt_marshallIn(SFc4_untitledInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_f_emlrt_marshallIn(SFc4_untitledInstanceStruct
  *chartInstance, const mxArray *c4_b_setSimStateSideEffectsInfo, const char_T
  *c4_identifier);
static const mxArray *c4_g_emlrt_marshallIn(SFc4_untitledInstanceStruct
...
static void initialize_c4_untitled(SFc4_untitledInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_is_c4_untitled = 0U;
  ...
  *chartInstance)
{
  ...
  c4_c_hoistedGlobal = chartInstance->c4_is_c4_untitled;
  ...
  const mxArray *c4_st)
{
  ...
  *c4_u1 = c4_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c4_u,
    0)), "u1");
  chartInstance->c4_is_active_c4_untitled = c4_b_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c4_u, 1)), "is_active_c4_untitled");
  chartInstance->c4_is_c4_untitled = c4_b_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c4_u, 2)), "is_c4_untitled");
...
static void sf_c4_untitled(SFc4_untitledInstanceStruct *chartInstance)
{
  ...
  c4_set_sim_state_side_effects_c4_untitled(chartInstance);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  ...
  if ((int16_T)chartInstance->c4_is_active_c4_untitled == 0) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 0U, chartInstance->c4_sfEvent);
    chartInstance->c4_is_active_c4_untitled = 1U;
    ...
    chartInstance->c4_is_c4_untitled = c4_IN_state1;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c4_sfEvent);
    chartInstance->c4_tp_state1 = 1U;
  } else {
    switch (chartInstance->c4_is_c4_untitled) {
     case c4_IN_state1:
      CV_CHART_EVAL(0, 0, 1);
      ...
      if (CV_TRANSITION_EVAL(1U, (int32_T)_SFD_CCP_CALL(1U, 0, *c4_soc <=
        ...
        chartInstance->c4_tp_state1 = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c4_sfEvent);
        chartInstance->c4_is_c4_untitled = c4_IN_state2;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c4_sfEvent);
        chartInstance->c4_tp_state2 = 1U;
      } else {
        *c4_u1 = 1.0;
     ...
     default:
      CV_CHART_EVAL(0, 0, 0);
      chartInstance->c4_is_c4_untitled = (uint8_T)c4_IN_NO_ACTIVE_CHILD;
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c4_sfEvent);
      break;
    }
  }
...
static const mxArray *sf_get_sim_state_info_c4_untitled(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[15],T\"u1\",},{M[8],M[0],T\"is_active_c4_untitled\",},{M[9],M[0],T\"is_c4_untitled\",}}"
  };
...
static void mdlSetWorkWidths_c4_untitled(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"untitled","untitled",4);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"untitled","untitled",4,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"untitled","untitled",4,
      "gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"untitled","untitled",4,2);
      sf_mark_chart_reusable_outputs(S,"untitled","untitled",4,1);
    }

    sf_set_rtw_dwork_info(S,"untitled","untitled",4);
...
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "untitled", "untitled",4);
