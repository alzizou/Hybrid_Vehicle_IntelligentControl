...
static void initialize_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK
  (SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OKInstanceStruct *chartInstance);
static void initialize_params_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK
  (SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OKInstanceStruct *chartInstance);
static void enable_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK
  (SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OKInstanceStruct *chartInstance);
static void disable_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK
  (SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OKInstanceStruct *chartInstance);
static void c8_update_debugger_state_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final
  (SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OKInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK
  (SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OKInstanceStruct *chartInstance);
static void set_sim_state_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK
  (SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OKInstanceStruct *chartInstance,
   const mxArray *c8_st);
static void finalize_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK
  (SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OKInstanceStruct *chartInstance);
static void sf_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK
  (SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OKInstanceStruct *chartInstance);
static void initSimStructsc8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK
  (SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OKInstanceStruct *chartInstance);
...
static uint8_T c8_d_emlrt_marshallIn
  (SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OKInstanceStruct *chartInstance,
   const mxArray *c8_b_is_active_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK,
  ...
  (SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OKInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK = 0U;
}
  ...
  (SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OKInstanceStruct *chartInstance)
{
  ...
  c8_b_hoistedGlobal =
    chartInstance->c8_is_active_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK;
   ...
   const mxArray *c8_st)
{
  ...
  *c8_y = c8_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 0)),
  ...
  chartInstance->c8_is_active_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK =
    ...
    "is_active_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK");
  sf_mex_destroy(&c8_u);
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  const mxArray *c8_y = NULL;
  SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OKInstanceStruct *chartInstance;
  chartInstance = (SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OKInstanceStruct *)
    chartInstanceVoid;
   ...
   const char_T *c8_identifier)
{
  ...
  c8_y = c8_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK);
  return c8_y;
}
...
/* SFunction Glue Code */
void sf_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK_get_autoinheritance_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OKInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK
    ((SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OKInstanceStruct*)
     chartInstanceVar);
  initialize_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK
    ((SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OKInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK(void
  *chartInstanceVar)
{
  enable_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK
    ((SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OKInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK(void
  *chartInstanceVar)
{
  disable_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK
    ((SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OKInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK(void
  *chartInstanceVar)
{
  sf_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK
    ((SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OKInstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK
    ((SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OKInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK();/* state var info */
...
extern void sf_internal_set_sim_state_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK
    ((SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OKInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK(S);
}

static void sf_opaque_set_sim_state_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK(S, st);
}

static void sf_opaque_terminate_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK(void *
  chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OKInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK
      ((SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OKInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK
    ((SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OKInstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK
  (SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK",
      "hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK",8);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,
                "hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK",
                "hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK",8,"RTWCG"));
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,
        "hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK",
        "hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK",8,2);
      sf_mark_chart_reusable_outputs(S,"hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK",
        "hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK",8,1);
    }
...
static void mdlRTW_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK(SimStruct *S)
{
  SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OKInstanceStruct *chartInstance;
  chartInstance = (SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OKInstanceStruct *)
    malloc(sizeof(SFc8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OKInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK;
...
void c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_hyd_hyb_2_int_cont_1_new3_5cyc_Final_OK_method_dispatcher.\n"
