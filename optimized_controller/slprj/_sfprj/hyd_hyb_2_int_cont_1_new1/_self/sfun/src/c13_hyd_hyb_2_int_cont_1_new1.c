...
static void initialize_c13_hyd_hyb_2_int_cont_1_new1
  (SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance);
static void initialize_params_c13_hyd_hyb_2_int_cont_1_new1
  (SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance);
static void enable_c13_hyd_hyb_2_int_cont_1_new1
  (SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance);
static void disable_c13_hyd_hyb_2_int_cont_1_new1
  (SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance);
static void c13_update_debugger_state_c13_hyd_hyb_2_int_cont_1_new1
  (SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c13_hyd_hyb_2_int_cont_1_new1
  (SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance);
static void set_sim_state_c13_hyd_hyb_2_int_cont_1_new1
  (SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance, const mxArray
   *c13_st);
static void finalize_c13_hyd_hyb_2_int_cont_1_new1
  (SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance);
static void sf_c13_hyd_hyb_2_int_cont_1_new1
  (SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance);
static void initSimStructsc13_hyd_hyb_2_int_cont_1_new1
  (SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c13_machineNumber, uint32_T
  c13_chartNumber);
static const mxArray *c13_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static real_T c13_emlrt_marshallIn(SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct
...
static uint8_T c13_d_emlrt_marshallIn
  (SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance, const mxArray
   *c13_b_is_active_c13_hyd_hyb_2_int_cont_1_new1, const char_T *c13_identifier);
static uint8_T c13_e_emlrt_marshallIn
  (SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance, const mxArray
   *c13_u, const emlrtMsgIdentifier *c13_parentId);
static void init_dsm_address_info(SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct *
  chartInstance);
  ...
  (SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance)
{
  ...
  chartInstance->c13_is_active_c13_hyd_hyb_2_int_cont_1_new1 = 0U;
}
  ...
  (SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance)
{
  ...
  c13_b_hoistedGlobal =
    chartInstance->c13_is_active_c13_hyd_hyb_2_int_cont_1_new1;
   ...
   *c13_st)
{
  ...
  *c13_y = c13_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c13_u,
  ...
  chartInstance->c13_is_active_c13_hyd_hyb_2_int_cont_1_new1 =
    ...
    "is_active_c13_hyd_hyb_2_int_cont_1_new1");
  sf_mex_destroy(&c13_u);
  c13_update_debugger_state_c13_hyd_hyb_2_int_cont_1_new1(chartInstance);
  ...
  (SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance)
{
  ...
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 8U, chartInstance->c13_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c13_b_u, 0U);
  _SFD_DATA_RANGE_CHECK(*c13_d_y, 1U);
  _SFD_DATA_RANGE_CHECK(chartInstance->c13_T0, 2U);
  chartInstance->c13_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 8U, chartInstance->c13_sfEvent);
  ...
  *c13_d_y = c13_y;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 8U, chartInstance->c13_sfEvent);
  ...
  *c13_inData)
{
  ...
  const mxArray *c13_y = NULL;
  SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance;
  chartInstance = (SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c13_hyd_hyb_2_int_cont_1_new1_get_eml_resolved_functions_info
  (void)
{
   ...
   *c13_b_is_active_c13_hyd_hyb_2_int_cont_1_new1, const char_T *c13_identifier)
{
  ...
  c13_y = c13_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c13_b_is_active_c13_hyd_hyb_2_int_cont_1_new1), &c13_thisId);
  sf_mex_destroy(&c13_b_is_active_c13_hyd_hyb_2_int_cont_1_new1);
  return c13_y;
}
...
/* SFunction Glue Code */
void sf_c13_hyd_hyb_2_int_cont_1_new1_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c13_hyd_hyb_2_int_cont_1_new1_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c13_hyd_hyb_2_int_cont_1_new1(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c13_hyd_hyb_2_int_cont_1_new1\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c13_hyd_hyb_2_int_cont_1_new1_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c13_hyd_hyb_2_int_cont_1_new1(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c13_hyd_hyb_2_int_cont_1_new1
    ((SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct*) chartInstanceVar);
  initialize_c13_hyd_hyb_2_int_cont_1_new1
    ((SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c13_hyd_hyb_2_int_cont_1_new1(void
  *chartInstanceVar)
{
  enable_c13_hyd_hyb_2_int_cont_1_new1
    ((SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c13_hyd_hyb_2_int_cont_1_new1(void
  *chartInstanceVar)
{
  disable_c13_hyd_hyb_2_int_cont_1_new1
    ((SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c13_hyd_hyb_2_int_cont_1_new1(void
  *chartInstanceVar)
{
  sf_c13_hyd_hyb_2_int_cont_1_new1
    ((SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c13_hyd_hyb_2_int_cont_1_new1
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c13_hyd_hyb_2_int_cont_1_new1
    ((SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c13_hyd_hyb_2_int_cont_1_new1();/* state var info */
...
extern void sf_internal_set_sim_state_c13_hyd_hyb_2_int_cont_1_new1(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c13_hyd_hyb_2_int_cont_1_new1
    ((SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c13_hyd_hyb_2_int_cont_1_new1
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c13_hyd_hyb_2_int_cont_1_new1(S);
}

static void sf_opaque_set_sim_state_c13_hyd_hyb_2_int_cont_1_new1(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c13_hyd_hyb_2_int_cont_1_new1(S, st);
}

static void sf_opaque_terminate_c13_hyd_hyb_2_int_cont_1_new1(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c13_hyd_hyb_2_int_cont_1_new1
      ((SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc13_hyd_hyb_2_int_cont_1_new1
    ((SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c13_hyd_hyb_2_int_cont_1_new1(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c13_hyd_hyb_2_int_cont_1_new1
      ((SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c13_hyd_hyb_2_int_cont_1_new1(SimStruct *S)
{
...
static void mdlRTW_c13_hyd_hyb_2_int_cont_1_new1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c13_hyd_hyb_2_int_cont_1_new1(SimStruct *S)
{
  SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance;
  chartInstance = (SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct *)malloc(sizeof
    (SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc13_hyd_hyb_2_int_cont_1_new1InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c13_hyd_hyb_2_int_cont_1_new1;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c13_hyd_hyb_2_int_cont_1_new1;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c13_hyd_hyb_2_int_cont_1_new1;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c13_hyd_hyb_2_int_cont_1_new1;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c13_hyd_hyb_2_int_cont_1_new1;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c13_hyd_hyb_2_int_cont_1_new1;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c13_hyd_hyb_2_int_cont_1_new1;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c13_hyd_hyb_2_int_cont_1_new1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c13_hyd_hyb_2_int_cont_1_new1;
  chartInstance->chartInfo.mdlStart = mdlStart_c13_hyd_hyb_2_int_cont_1_new1;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c13_hyd_hyb_2_int_cont_1_new1;
...
void c13_hyd_hyb_2_int_cont_1_new1_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c13_hyd_hyb_2_int_cont_1_new1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c13_hyd_hyb_2_int_cont_1_new1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c13_hyd_hyb_2_int_cont_1_new1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c13_hyd_hyb_2_int_cont_1_new1_method_dispatcher.\n"
