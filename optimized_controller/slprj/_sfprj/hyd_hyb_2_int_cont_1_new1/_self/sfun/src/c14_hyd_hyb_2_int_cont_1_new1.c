...
static void initialize_c14_hyd_hyb_2_int_cont_1_new1
  (SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance);
static void initialize_params_c14_hyd_hyb_2_int_cont_1_new1
  (SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance);
static void enable_c14_hyd_hyb_2_int_cont_1_new1
  (SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance);
static void disable_c14_hyd_hyb_2_int_cont_1_new1
  (SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance);
static void c14_update_debugger_state_c14_hyd_hyb_2_int_cont_1_new1
  (SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c14_hyd_hyb_2_int_cont_1_new1
  (SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance);
static void set_sim_state_c14_hyd_hyb_2_int_cont_1_new1
  (SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance, const mxArray
   *c14_st);
static void finalize_c14_hyd_hyb_2_int_cont_1_new1
  (SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance);
static void sf_c14_hyd_hyb_2_int_cont_1_new1
  (SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance);
static void initSimStructsc14_hyd_hyb_2_int_cont_1_new1
  (SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance);
...
static const mxArray *c14_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static real_T c14_emlrt_marshallIn(SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct
...
static real_T c14_mpower(SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct
...
static uint8_T c14_d_emlrt_marshallIn
  (SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance, const mxArray
   *c14_b_is_active_c14_hyd_hyb_2_int_cont_1_new1, const char_T *c14_identifier);
static uint8_T c14_e_emlrt_marshallIn
  (SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance, const mxArray
   *c14_u, const emlrtMsgIdentifier *c14_parentId);
static void init_dsm_address_info(SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct *
  chartInstance);
  ...
  (SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance)
{
  ...
  chartInstance->c14_is_active_c14_hyd_hyb_2_int_cont_1_new1 = 0U;
}
  ...
  (SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance)
{
  ...
  c14_b_hoistedGlobal =
    chartInstance->c14_is_active_c14_hyd_hyb_2_int_cont_1_new1;
   ...
   *c14_st)
{
  ...
  *c14_y = c14_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c14_u,
  ...
  chartInstance->c14_is_active_c14_hyd_hyb_2_int_cont_1_new1 =
    ...
    "is_active_c14_hyd_hyb_2_int_cont_1_new1");
  sf_mex_destroy(&c14_u);
  c14_update_debugger_state_c14_hyd_hyb_2_int_cont_1_new1(chartInstance);
  ...
  *c14_inData)
{
  ...
  const mxArray *c14_y = NULL;
  SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance;
  chartInstance = (SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c14_hyd_hyb_2_int_cont_1_new1_get_eml_resolved_functions_info
  (void)
{
   ...
   *c14_b_is_active_c14_hyd_hyb_2_int_cont_1_new1, const char_T *c14_identifier)
{
  ...
  c14_y = c14_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c14_b_is_active_c14_hyd_hyb_2_int_cont_1_new1), &c14_thisId);
  sf_mex_destroy(&c14_b_is_active_c14_hyd_hyb_2_int_cont_1_new1);
  return c14_y;
}
...
/* SFunction Glue Code */
void sf_c14_hyd_hyb_2_int_cont_1_new1_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c14_hyd_hyb_2_int_cont_1_new1_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c14_hyd_hyb_2_int_cont_1_new1(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c14_hyd_hyb_2_int_cont_1_new1\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c14_hyd_hyb_2_int_cont_1_new1_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c14_hyd_hyb_2_int_cont_1_new1(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c14_hyd_hyb_2_int_cont_1_new1
    ((SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct*) chartInstanceVar);
  initialize_c14_hyd_hyb_2_int_cont_1_new1
    ((SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c14_hyd_hyb_2_int_cont_1_new1(void
  *chartInstanceVar)
{
  enable_c14_hyd_hyb_2_int_cont_1_new1
    ((SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c14_hyd_hyb_2_int_cont_1_new1(void
  *chartInstanceVar)
{
  disable_c14_hyd_hyb_2_int_cont_1_new1
    ((SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c14_hyd_hyb_2_int_cont_1_new1(void
  *chartInstanceVar)
{
  sf_c14_hyd_hyb_2_int_cont_1_new1
    ((SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c14_hyd_hyb_2_int_cont_1_new1
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c14_hyd_hyb_2_int_cont_1_new1
    ((SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c14_hyd_hyb_2_int_cont_1_new1();/* state var info */
...
extern void sf_internal_set_sim_state_c14_hyd_hyb_2_int_cont_1_new1(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c14_hyd_hyb_2_int_cont_1_new1
    ((SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c14_hyd_hyb_2_int_cont_1_new1
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c14_hyd_hyb_2_int_cont_1_new1(S);
}

static void sf_opaque_set_sim_state_c14_hyd_hyb_2_int_cont_1_new1(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c14_hyd_hyb_2_int_cont_1_new1(S, st);
}

static void sf_opaque_terminate_c14_hyd_hyb_2_int_cont_1_new1(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c14_hyd_hyb_2_int_cont_1_new1
      ((SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc14_hyd_hyb_2_int_cont_1_new1
    ((SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c14_hyd_hyb_2_int_cont_1_new1(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c14_hyd_hyb_2_int_cont_1_new1
      ((SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c14_hyd_hyb_2_int_cont_1_new1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"hyd_hyb_2_int_cont_1_new1",
      "hyd_hyb_2_int_cont_1_new1",14);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"hyd_hyb_2_int_cont_1_new1",
                "hyd_hyb_2_int_cont_1_new1",14,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,
      "hyd_hyb_2_int_cont_1_new1","hyd_hyb_2_int_cont_1_new1",14,
      "gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"hyd_hyb_2_int_cont_1_new1",
        "hyd_hyb_2_int_cont_1_new1",14,2);
      sf_mark_chart_reusable_outputs(S,"hyd_hyb_2_int_cont_1_new1",
        "hyd_hyb_2_int_cont_1_new1",14,1);
    }
...
static void mdlRTW_c14_hyd_hyb_2_int_cont_1_new1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c14_hyd_hyb_2_int_cont_1_new1(SimStruct *S)
{
  SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct *chartInstance;
  chartInstance = (SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct *)malloc(sizeof
    (SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc14_hyd_hyb_2_int_cont_1_new1InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c14_hyd_hyb_2_int_cont_1_new1;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c14_hyd_hyb_2_int_cont_1_new1;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c14_hyd_hyb_2_int_cont_1_new1;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c14_hyd_hyb_2_int_cont_1_new1;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c14_hyd_hyb_2_int_cont_1_new1;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c14_hyd_hyb_2_int_cont_1_new1;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c14_hyd_hyb_2_int_cont_1_new1;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c14_hyd_hyb_2_int_cont_1_new1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c14_hyd_hyb_2_int_cont_1_new1;
  chartInstance->chartInfo.mdlStart = mdlStart_c14_hyd_hyb_2_int_cont_1_new1;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c14_hyd_hyb_2_int_cont_1_new1;
...
void c14_hyd_hyb_2_int_cont_1_new1_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c14_hyd_hyb_2_int_cont_1_new1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c14_hyd_hyb_2_int_cont_1_new1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c14_hyd_hyb_2_int_cont_1_new1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c14_hyd_hyb_2_int_cont_1_new1_method_dispatcher.\n"
