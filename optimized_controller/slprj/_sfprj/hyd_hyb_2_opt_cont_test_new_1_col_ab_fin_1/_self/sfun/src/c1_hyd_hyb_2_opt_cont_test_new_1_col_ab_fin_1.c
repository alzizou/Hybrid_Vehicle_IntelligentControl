...
static void initialize_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1
  (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1InstanceStruct *chartInstance);
static void initialize_params_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1
  (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1InstanceStruct *chartInstance);
static void enable_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1
  (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1InstanceStruct *chartInstance);
static void disable_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1
  (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1InstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab
  (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1InstanceStruct *chartInstance);
static const mxArray
  *get_sim_state_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1
  (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1InstanceStruct *chartInstance);
static void set_sim_state_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1
  (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1InstanceStruct *chartInstance,
   const mxArray *c1_st);
static void c1_set_sim_state_side_effects_c1_hyd_hyb_2_opt_cont_test_new_1_c
  (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1InstanceStruct *chartInstance);
static void finalize_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1
  (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1InstanceStruct *chartInstance);
static void sf_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1
  (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1InstanceStruct *chartInstance);
static void initSimStructsc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1
  (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1InstanceStruct *chartInstance);
  ...
  (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1InstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1 = 0U;
  chartInstance->c1_is_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1 = 0U;
  ...
  (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1InstanceStruct *chartInstance)
{
  ...
  if ((int16_T)
      chartInstance->c1_is_active_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1 ==
      1) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
  }

  if (chartInstance->c1_is_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1 ==
      c1_IN_Drive) {
  ...
  (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1InstanceStruct *chartInstance)
{
  ...
  c1_c_hoistedGlobal =
    chartInstance->c1_is_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1;
   ...
   const mxArray *c1_st)
{
  ...
  *c1_s = c1_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 0)),
  ...
  chartInstance->c1_is_active_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1 =
    ...
    "is_active_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1");
  chartInstance->c1_is_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1 =
    c1_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 2)),
    "is_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1");
  ...
  (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1InstanceStruct *chartInstance)
{
  ...
  if ((int16_T)
    ...
    switch (chartInstance->c1_is_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1)
    {
     case c1_IN_Drive:
      CV_CHART_EVAL(0, 0, 1);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1InstanceStruct *chartInstance;
  chartInstance = (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1InstanceStruct
                   *)chartInstanceVoid;
...
/* SFunction Glue Code */
void sf_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1_get_check_sum(mxArray
  *plhs[])
{
...
static const mxArray
  *sf_get_sim_state_info_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[9],T\"s\",},{M[8],M[0],T\"is_active_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1\",},{M[9],M[0],T\"is_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"at\",M[2],M[1]}}},{M[13],M[0],T\"previousTicks\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1InstanceStruct *chartInstance;
    chartInstance =
      (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1InstanceStruct *)
...
static void sf_opaque_initialize_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1
  (void *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1InstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1
    ((SFc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1InstanceStruct*)
     chartInstanceVar);
  initialize_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1
    ((SFc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1(void *
  chartInstanceVar)
{
  enable_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1
    ((SFc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1(void
  *chartInstanceVar)
{
  disable_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1
    ((SFc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1(void
  *chartInstanceVar)
{
  sf_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1
    ((SFc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1InstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1
  (SimStruct* S)
{
  ...
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1();/* state var info */
...
extern void
  sf_internal_set_sim_state_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1
    ((SFc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1InstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1
    (S);
}

static void
  sf_opaque_set_sim_state_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1(S, st);
}

static void sf_opaque_terminate_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1
  (void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    ...
    finalize_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1
      ((SFc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1InstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1
    ((SFc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1InstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1
  (SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      ...
      "hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1",1);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,
                "hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1",
                "hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1",1,"RTWCG"));
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,
        "hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1",
        "hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1",1,2);
      sf_mark_chart_reusable_outputs(S,
        "hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1",
        "hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1",1,1);
    }
...
static void mdlRTW_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1(SimStruct *S)
{
  SFc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1InstanceStruct *chartInstance;
  chartInstance = (SFc1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1InstanceStruct
                   *)malloc(sizeof
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1;
...
void c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1_method_dispatcher(SimStruct
  *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_hyd_hyb_2_opt_cont_test_new_1_col_ab_fin_1_method_dispatcher.\n"
