...
#include "c36_hyd_hyb_2_opt_cont_online.h"
...
static void initialize_c36_hyd_hyb_2_opt_cont_online
  (SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct *chartInstance);
static void initialize_params_c36_hyd_hyb_2_opt_cont_online
  (SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct *chartInstance);
static void enable_c36_hyd_hyb_2_opt_cont_online
  (SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct *chartInstance);
static void disable_c36_hyd_hyb_2_opt_cont_online
  (SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct *chartInstance);
static void c36_update_debugger_state_c36_hyd_hyb_2_opt_cont_online
  (SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c36_hyd_hyb_2_opt_cont_online
  (SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct *chartInstance);
static void set_sim_state_c36_hyd_hyb_2_opt_cont_online
  (SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct *chartInstance, const mxArray
   *c36_st);
static void finalize_c36_hyd_hyb_2_opt_cont_online
  (SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct *chartInstance);
static void sf_c36_hyd_hyb_2_opt_cont_online
  (SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct *chartInstance);
static void c36_chartstep_c36_hyd_hyb_2_opt_cont_online
  (SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct *chartInstance);
static void initSimStructsc36_hyd_hyb_2_opt_cont_online
  (SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct *chartInstance);
...
static const mxArray *c36_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static void c36_emlrt_marshallIn(SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct
  *chartInstance, const mxArray *c36_u, const char_T *c36_identifier, real_T
  c36_y[4]);
static void c36_b_emlrt_marshallIn(SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct
...
static const mxArray *c36_c_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static void c36_d_emlrt_marshallIn(SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct
  *chartInstance, const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId,
  real_T c36_y[24]);
...
static const mxArray *c36_d_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static void c36_eml_scalar_eg(SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct
  *chartInstance);
static real_T c36_power(SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct
  *chartInstance, real_T c36_a, real_T c36_b);
static void c36_eml_error(SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct
  *chartInstance);
...
static uint8_T c36_f_emlrt_marshallIn
  (SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct *chartInstance, const mxArray
   *c36_b_is_active_c36_hyd_hyb_2_opt_cont_online, const char_T *c36_identifier);
static uint8_T c36_g_emlrt_marshallIn
  (SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct *chartInstance, const mxArray
   *c36_u, const emlrtMsgIdentifier *c36_parentId);
static void init_dsm_address_info(SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct *
  chartInstance);
  ...
  (SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct *chartInstance)
{
  ...
  chartInstance->c36_is_active_c36_hyd_hyb_2_opt_cont_online = 0U;
}
  ...
  (SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct *chartInstance)
{
  ...
  c36_hoistedGlobal = chartInstance->c36_is_active_c36_hyd_hyb_2_opt_cont_online;
   ...
   *c36_st)
{
  ...
  chartInstance->c36_is_active_c36_hyd_hyb_2_opt_cont_online =
    c36_f_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c36_u, 1)),
    "is_active_c36_hyd_hyb_2_opt_cont_online");
  sf_mex_destroy(&c36_u);
  c36_update_debugger_state_c36_hyd_hyb_2_opt_cont_online(chartInstance);
  ...
  (SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct *chartInstance)
{
  ...
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 3U, chartInstance->c36_sfEvent);
  ...
  chartInstance->c36_sfEvent = CALL_EVENT;
  c36_chartstep_c36_hyd_hyb_2_opt_cont_online(chartInstance);
  ...
  (SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct *chartInstance)
{
  ...
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 3U, chartInstance->c36_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 3U, chartInstance->c36_sfEvent);
}
  ...
  *c36_inData)
{
  ...
  const mxArray *c36_y = NULL;
  SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct *chartInstance;
  chartInstance = (SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c36_hyd_hyb_2_opt_cont_online_get_eml_resolved_functions_info
  (void)
{
   ...
   *c36_b_is_active_c36_hyd_hyb_2_opt_cont_online, const char_T *c36_identifier)
{
  ...
  c36_y = c36_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c36_b_is_active_c36_hyd_hyb_2_opt_cont_online), &c36_thisId);
  sf_mex_destroy(&c36_b_is_active_c36_hyd_hyb_2_opt_cont_online);
  return c36_y;
}
...
/* SFunction Glue Code */
void sf_c36_hyd_hyb_2_opt_cont_online_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c36_hyd_hyb_2_opt_cont_online_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c36_hyd_hyb_2_opt_cont_online(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"u\",},{M[8],M[0],T\"is_active_c36_hyd_hyb_2_opt_cont_online\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c36_hyd_hyb_2_opt_cont_online_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c36_hyd_hyb_2_opt_cont_online(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c36_hyd_hyb_2_opt_cont_online
    ((SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct*) chartInstanceVar);
  initialize_c36_hyd_hyb_2_opt_cont_online
    ((SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c36_hyd_hyb_2_opt_cont_online(void
  *chartInstanceVar)
{
  enable_c36_hyd_hyb_2_opt_cont_online
    ((SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c36_hyd_hyb_2_opt_cont_online(void
  *chartInstanceVar)
{
  disable_c36_hyd_hyb_2_opt_cont_online
    ((SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c36_hyd_hyb_2_opt_cont_online(void
  *chartInstanceVar)
{
  sf_c36_hyd_hyb_2_opt_cont_online
    ((SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c36_hyd_hyb_2_opt_cont_online
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c36_hyd_hyb_2_opt_cont_online
    ((SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c36_hyd_hyb_2_opt_cont_online();/* state var info */
...
extern void sf_internal_set_sim_state_c36_hyd_hyb_2_opt_cont_online(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c36_hyd_hyb_2_opt_cont_online
    ((SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c36_hyd_hyb_2_opt_cont_online
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c36_hyd_hyb_2_opt_cont_online(S);
}

static void sf_opaque_set_sim_state_c36_hyd_hyb_2_opt_cont_online(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c36_hyd_hyb_2_opt_cont_online(S, st);
}

static void sf_opaque_terminate_c36_hyd_hyb_2_opt_cont_online(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c36_hyd_hyb_2_opt_cont_online
      ((SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc36_hyd_hyb_2_opt_cont_online
    ((SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c36_hyd_hyb_2_opt_cont_online(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c36_hyd_hyb_2_opt_cont_online
      ((SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c36_hyd_hyb_2_opt_cont_online(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      ...
      "hyd_hyb_2_opt_cont_online",36);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"hyd_hyb_2_opt_cont_online",
                "hyd_hyb_2_opt_cont_online",36,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,
      "hyd_hyb_2_opt_cont_online","hyd_hyb_2_opt_cont_online",36,
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"hyd_hyb_2_opt_cont_online",
        "hyd_hyb_2_opt_cont_online",36,3);
      sf_mark_chart_reusable_outputs(S,"hyd_hyb_2_opt_cont_online",
        "hyd_hyb_2_opt_cont_online",36,1);
    }
...
static void mdlRTW_c36_hyd_hyb_2_opt_cont_online(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c36_hyd_hyb_2_opt_cont_online(SimStruct *S)
{
  SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct *chartInstance;
  chartInstance = (SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct *)malloc(sizeof
    (SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc36_hyd_hyb_2_opt_cont_onlineInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c36_hyd_hyb_2_opt_cont_online;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c36_hyd_hyb_2_opt_cont_online;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c36_hyd_hyb_2_opt_cont_online;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c36_hyd_hyb_2_opt_cont_online;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c36_hyd_hyb_2_opt_cont_online;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c36_hyd_hyb_2_opt_cont_online;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c36_hyd_hyb_2_opt_cont_online;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c36_hyd_hyb_2_opt_cont_online;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c36_hyd_hyb_2_opt_cont_online;
  chartInstance->chartInfo.mdlStart = mdlStart_c36_hyd_hyb_2_opt_cont_online;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c36_hyd_hyb_2_opt_cont_online;
...
void c36_hyd_hyb_2_opt_cont_online_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c36_hyd_hyb_2_opt_cont_online(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c36_hyd_hyb_2_opt_cont_online(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c36_hyd_hyb_2_opt_cont_online(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c36_hyd_hyb_2_opt_cont_online_method_dispatcher.\n"
