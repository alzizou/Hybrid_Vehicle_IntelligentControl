...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_untitled1_process_check_sum_call( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_untitled1_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_untitled1_autoinheritance_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "untitled1") == 0) {
    const mxArray *newRhs[2] = { NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_untitled1_autoinheritance_info(nlhs,plhs,2,newRhs);
  }
...
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_untitled1_get_eml_resolved_functions_info( int nlhs,
  ...
  if (strcmp(machineName, "untitled1") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_untitled1_get_eml_resolved_functions_info(nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_untitled1_method_dispatcher(SimStruct *S, unsigned int
  ...
  method, void *data)
{
  if (!strcmp(machineName,"untitled1")) {
    return(sf_untitled1_method_dispatcher(simstructPtr,chartFileNumber,
...
extern void untitled1_terminator(void);
...
extern void untitled1_initializer(void);
extern void untitled1_register_exported_symbols(SimStruct* S);
extern void untitled1_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  untitled1_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      untitled1_debug_initialize();
    }

    untitled1_initializer();
  }
