...
static void initialize_c15_check(SFc15_checkInstanceStruct *chartInstance);
static void initialize_params_c15_check(SFc15_checkInstanceStruct *chartInstance);
static void enable_c15_check(SFc15_checkInstanceStruct *chartInstance);
static void disable_c15_check(SFc15_checkInstanceStruct *chartInstance);
static void c15_update_debugger_state_c15_check(SFc15_checkInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c15_check(SFc15_checkInstanceStruct
  *chartInstance);
static void set_sim_state_c15_check(SFc15_checkInstanceStruct *chartInstance,
  const mxArray *c15_st);
static void finalize_c15_check(SFc15_checkInstanceStruct *chartInstance);
static void sf_c15_check(SFc15_checkInstanceStruct *chartInstance);
static void initSimStructsc15_check(SFc15_checkInstanceStruct *chartInstance);
...
static const mxArray *c15_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static real_T c15_emlrt_marshallIn(SFc15_checkInstanceStruct *chartInstance,
  const mxArray *c15_y, const char_T *c15_identifier);
static real_T c15_b_emlrt_marshallIn(SFc15_checkInstanceStruct *chartInstance,
...
static const mxArray *c15_b_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static int32_T c15_c_emlrt_marshallIn(SFc15_checkInstanceStruct *chartInstance,
  const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
static void c15_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c15_mxArrayInData, const char_T *c15_varName, void *c15_outData);
static uint8_T c15_d_emlrt_marshallIn(SFc15_checkInstanceStruct *chartInstance,
  const mxArray *c15_b_is_active_c15_check, const char_T *c15_identifier);
static uint8_T c15_e_emlrt_marshallIn(SFc15_checkInstanceStruct *chartInstance,
  const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
static void init_dsm_address_info(SFc15_checkInstanceStruct *chartInstance);
...
static void initialize_c15_check(SFc15_checkInstanceStruct *chartInstance)
{
  ...
  chartInstance->c15_is_active_c15_check = 0U;
}
  ...
  *chartInstance)
{
  ...
  c15_b_hoistedGlobal = chartInstance->c15_is_active_c15_check;
  ...
  const mxArray *c15_st)
{
  ...
  *c15_y = c15_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c15_u,
    0)), "y");
  chartInstance->c15_is_active_c15_check = c15_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c15_u, 1)), "is_active_c15_check");
  sf_mex_destroy(&c15_u);
  c15_update_debugger_state_c15_check(chartInstance);
  ...
  *c15_inData)
{
  ...
  real_T c15_u;
  const mxArray *c15_y = NULL;
  SFc15_checkInstanceStruct *chartInstance;
  chartInstance = (SFc15_checkInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c15_check_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c15_b_is_active_c15_check, const char_T *c15_identifier)
{
  ...
  c15_y = c15_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c15_b_is_active_c15_check), &c15_thisId);
  sf_mex_destroy(&c15_b_is_active_c15_check);
  return c15_y;
}
...
/* SFunction Glue Code */
void sf_c15_check_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c15_check_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c15_check(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c15_check\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c15_check_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc15_checkInstanceStruct *chartInstance;
    chartInstance = (SFc15_checkInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c15_check(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc15_checkInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c15_check((SFc15_checkInstanceStruct*) chartInstanceVar);
  initialize_c15_check((SFc15_checkInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c15_check(void *chartInstanceVar)
{
  enable_c15_check((SFc15_checkInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c15_check(void *chartInstanceVar)
{
  disable_c15_check((SFc15_checkInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c15_check(void *chartInstanceVar)
{
  sf_c15_check((SFc15_checkInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c15_check(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c15_check((SFc15_checkInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c15_check();/* state var info */
...
extern void sf_internal_set_sim_state_c15_check(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c15_check((SFc15_checkInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c15_check(SimStruct* S)
{
  return sf_internal_get_sim_state_c15_check(S);
}

static void sf_opaque_set_sim_state_c15_check(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c15_check(S, st);
}

static void sf_opaque_terminate_c15_check(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc15_checkInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c15_check((SFc15_checkInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc15_check((SFc15_checkInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c15_check(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c15_check((SFc15_checkInstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c15_check(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"check","check",15);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"check","check",15,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"check","check",15,
      "gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"check","check",15,1);
      sf_mark_chart_reusable_outputs(S,"check","check",15,1);
    }

    sf_set_rtw_dwork_info(S,"check","check",15);
...
static void mdlRTW_c15_check(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "check", "check",15);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c15_check(SimStruct *S)
{
  SFc15_checkInstanceStruct *chartInstance;
  chartInstance = (SFc15_checkInstanceStruct *)malloc(sizeof
    (SFc15_checkInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc15_checkInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c15_check;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c15_check;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c15_check;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c15_check;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c15_check;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c15_check;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c15_check;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c15_check;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c15_check;
  chartInstance->chartInfo.mdlStart = mdlStart_c15_check;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c15_check;
...
void c15_check_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c15_check(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c15_check(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c15_check(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c15_check_method_dispatcher.\n"
