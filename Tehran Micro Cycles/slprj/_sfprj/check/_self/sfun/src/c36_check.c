...
static const char * c36_debug_family_names[15] = { "q", "u1", "i", "k", "den",
  "nargin", "nargout", "x_feat", "teta_new_10", "init", "t", "T0", "T1", "u",
  "dist" };

/* Function Declarations */
static void initialize_c36_check(SFc36_checkInstanceStruct *chartInstance);
static void initialize_params_c36_check(SFc36_checkInstanceStruct *chartInstance);
static void enable_c36_check(SFc36_checkInstanceStruct *chartInstance);
static void disable_c36_check(SFc36_checkInstanceStruct *chartInstance);
static void c36_update_debugger_state_c36_check(SFc36_checkInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c36_check(SFc36_checkInstanceStruct
  *chartInstance);
static void set_sim_state_c36_check(SFc36_checkInstanceStruct *chartInstance,
  const mxArray *c36_st);
static void finalize_c36_check(SFc36_checkInstanceStruct *chartInstance);
static void sf_c36_check(SFc36_checkInstanceStruct *chartInstance);
static void c36_chartstep_c36_check(SFc36_checkInstanceStruct *chartInstance);
static void initSimStructsc36_check(SFc36_checkInstanceStruct *chartInstance);
...
static const mxArray *c36_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static void c36_emlrt_marshallIn(SFc36_checkInstanceStruct *chartInstance, const
  mxArray *c36_dist, const char_T *c36_identifier, real_T c36_y[4]);
static void c36_b_emlrt_marshallIn(SFc36_checkInstanceStruct *chartInstance,
...
static const mxArray *c36_b_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static real_T c36_c_emlrt_marshallIn(SFc36_checkInstanceStruct *chartInstance,
...
static const mxArray *c36_c_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static void c36_d_emlrt_marshallIn(SFc36_checkInstanceStruct *chartInstance,
...
static const mxArray *c36_d_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static void c36_info_helper(c36_ResolvedFunctionInfo c36_info[17]);
static void c36_eml_scalar_eg(SFc36_checkInstanceStruct *chartInstance);
static real_T c36_ceval_xdot(SFc36_checkInstanceStruct *chartInstance, int32_T
  c36_n, real_T c36_x[10], int32_T c36_ix0, int32_T c36_incx, real_T c36_y[10],
  int32_T c36_iy0, int32_T c36_incy);
static const mxArray *c36_e_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static int32_T c36_e_emlrt_marshallIn(SFc36_checkInstanceStruct *chartInstance,
  const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId);
static void c36_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c36_mxArrayInData, const char_T *c36_varName, void *c36_outData);
static uint8_T c36_f_emlrt_marshallIn(SFc36_checkInstanceStruct *chartInstance,
  const mxArray *c36_b_is_active_c36_check, const char_T *c36_identifier);
static uint8_T c36_g_emlrt_marshallIn(SFc36_checkInstanceStruct *chartInstance,
  const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId);
static void init_dsm_address_info(SFc36_checkInstanceStruct *chartInstance);
...
static void initialize_c36_check(SFc36_checkInstanceStruct *chartInstance)
{
  ...
  chartInstance->c36_is_active_c36_check = 0U;
}
  ...
  *chartInstance)
{
  ...
  c36_hoistedGlobal = chartInstance->c36_is_active_c36_check;
  ...
  const mxArray *c36_st)
{
  ...
  chartInstance->c36_is_active_c36_check = c36_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c36_u, 2)), "is_active_c36_check");
  sf_mex_destroy(&c36_u);
  c36_update_debugger_state_c36_check(chartInstance);
...
static void sf_c36_check(SFc36_checkInstanceStruct *chartInstance)
{
  ...
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 23U, chartInstance->c36_sfEvent);
  ...
  chartInstance->c36_sfEvent = CALL_EVENT;
  c36_chartstep_c36_check(chartInstance);
...
static void c36_chartstep_c36_check(SFc36_checkInstanceStruct *chartInstance)
{
  ...
  real_T c36_b_T0;
  real_T c36_b_T1;
  uint32_T c36_debug_family_var_map[15];
  real_T c36_q;
  real_T c36_u1[4];
  real_T c36_i;
  real_T c36_k;
  ...
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 23U, chartInstance->c36_sfEvent);
  c36_hoistedGlobal = *c36_c_t;
  c36_b_hoistedGlobal = chartInstance->c36_T0;
  c36_c_hoistedGlobal = chartInstance->c36_T1;
  for (c36_i10 = 0; c36_i10 < 10; c36_i10++) {
    c36_x_feat[c36_i10] = (*c36_b_x_feat)[c36_i10];
  }

  for (c36_i11 = 0; c36_i11 < 40; c36_i11++) {
    c36_b_teta_new_10[c36_i11] = chartInstance->c36_teta_new_10[c36_i11];
  }

  for (c36_i12 = 0; c36_i12 < 4; c36_i12++) {
    c36_init[c36_i12] = (*c36_b_init)[c36_i12];
  }

  c36_t = c36_hoistedGlobal;
  c36_b_T0 = c36_b_hoistedGlobal;
  c36_b_T1 = c36_c_hoistedGlobal;
  sf_debug_symbol_scope_push_eml(0U, 15U, 15U, c36_debug_family_names,
  ...
  sf_debug_symbol_scope_add_eml_importable(c36_u1, 1U, c36_sf_marshallOut,
    c36_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c36_i, 2U, c36_b_sf_marshallOut,
    c36_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c36_k, 3U, c36_b_sf_marshallOut,
    c36_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c36_den, 4U, c36_b_sf_marshallOut,
    c36_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c36_nargin, 5U, c36_b_sf_marshallOut,
    c36_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c36_nargout, 6U,
    c36_b_sf_marshallOut, c36_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(c36_x_feat, 7U, c36_d_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(c36_b_teta_new_10, 8U,
    c36_c_sf_marshallOut, c36_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(c36_init, 9U, c36_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c36_t, 10U, c36_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c36_b_T0, 11U, c36_b_sf_marshallOut,
    c36_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c36_b_T1, 12U, c36_b_sf_marshallOut,
    c36_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c36_u, 13U, c36_sf_marshallOut,
    c36_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c36_dist, 14U, c36_sf_marshallOut,
    c36_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  for (c36_i15 = 0; c36_i15 < 4; c36_i15++) {
    c36_u[c36_i15] = c36_init[c36_i15];
  }

  _SFD_EML_CALL(0U, chartInstance->c36_sfEvent, 5);
  if (CV_EML_IF(0, 0, c36_t > c36_b_T0 - 1.0)) {
    c36_i = 1.0;
    c36_b_i = 1.0;
    while (c36_b_i <= 4.0) {
      c36_i = c36_b_i;
      ...
      for (c36_i16 = 0; c36_i16 < 10; c36_i16++) {
        c36_a[c36_i16] = c36_x_feat[c36_i16] - c36_b_teta_new_10[c36_i16 + 10 *
          c36_c_i];
      }

      c36_d_i = _SFD_EML_ARRAY_BOUNDS_CHECK("teta_new_10", (int32_T)
        _SFD_INTEGER_CHECK("i", c36_i), 1, 4, 2, 0) - 1;
      for (c36_i17 = 0; c36_i17 < 10; c36_i17++) {
        c36_b[c36_i17] = c36_x_feat[c36_i17] - c36_b_teta_new_10[c36_i17 + 10 *
          c36_d_i];
      }

      c36_eml_scalar_eg(chartInstance);
      for (c36_i18 = 0; c36_i18 < 10; c36_i18++) {
        c36_b_a[c36_i18] = c36_a[c36_i18];
      }

      for (c36_i19 = 0; c36_i19 < 10; c36_i19++) {
        c36_b_b[c36_i19] = c36_b[c36_i19];
      }

      c36_y = c36_ceval_xdot(chartInstance, 10, c36_b_a, 1, 1, c36_b_b, 1, 1);
      c36_dist[_SFD_EML_ARRAY_BOUNDS_CHECK("dist", (int32_T)_SFD_INTEGER_CHECK(
        "i", c36_i), 1, 4, 1, 0) - 1] = c36_y;
      c36_b_i++;
  ...
  for (c36_i21 = 0; c36_i21 < 4; c36_i21++) {
    (*c36_b_u)[c36_i21] = c36_u[c36_i21];
  }

  for (c36_i22 = 0; c36_i22 < 4; c36_i22++) {
    (*c36_b_dist)[c36_i22] = c36_dist[c36_i22];
  }

  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 23U, chartInstance->c36_sfEvent);
}
  ...
  *c36_inData)
{
  ...
  real_T c36_u[4];
  const mxArray *c36_y = NULL;
  SFc36_checkInstanceStruct *chartInstance;
  chartInstance = (SFc36_checkInstanceStruct *)chartInstanceVoid;
  c36_mxArrayOutData = NULL;
  for (c36_i23 = 0; c36_i23 < 4; c36_i23++) {
    c36_b_inData[c36_i23] = (*(real_T (*)[4])c36_inData)[c36_i23];
  }
  ...
  *c36_mxArrayInData, const char_T *c36_varName, void *c36_outData)
{
  ...
  for (c36_i26 = 0; c36_i26 < 4; c36_i26++) {
    (*(real_T (*)[4])c36_outData)[c36_i26] = c36_y[c36_i26];
  }
  ...
  *c36_inData)
{
  ...
  for (c36_i28 = 0; c36_i28 < 4; c36_i28++) {
    for (c36_i29 = 0; c36_i29 < 10; c36_i29++) {
      c36_b_inData[c36_i29 + c36_i27] = (*(real_T (*)[40])c36_inData)[c36_i29 +
        c36_i27];
    }
  ...
  const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId, real_T c36_y[40])
{
  ...
  sf_mex_import(c36_parentId, sf_mex_dup(c36_u), c36_dv4, 1, 0, 0U, 1, 0U, 2, 10,
                4);
  for (c36_i33 = 0; c36_i33 < 40; c36_i33++) {
    c36_y[c36_i33] = c36_dv4[c36_i33];
  }
  ...
  *c36_mxArrayInData, const char_T *c36_varName, void *c36_outData)
{
  ...
  c36_i34 = 0;
  for (c36_i35 = 0; c36_i35 < 4; c36_i35++) {
    for (c36_i36 = 0; c36_i36 < 10; c36_i36++) {
      (*(real_T (*)[40])c36_outData)[c36_i36 + c36_i34] = c36_y[c36_i36 +
        c36_i34];
    }
  ...
  *c36_inData)
{
  ...
  for (c36_i37 = 0; c36_i37 < 10; c36_i37++) {
    c36_b_inData[c36_i37] = (*(real_T (*)[10])c36_inData)[c36_i37];
  }

  for (c36_i38 = 0; c36_i38 < 10; c36_i38++) {
    c36_u[c36_i38] = c36_b_inData[c36_i38];
  }
...
const mxArray *sf_c36_check_get_eml_resolved_functions_info(void)
{
  const mxArray *c36_nameCaptureInfo;
  c36_ResolvedFunctionInfo c36_info[17];
  ...
  sf_mex_assign(&c36_m0, sf_mex_createstruct("nameCaptureInfo", 1, 17));
  for (c36_i39 = 0; c36_i39 < 17; c36_i39++) {
    c36_r0 = &c36_info[c36_i39];
...
{
  c36_info[0].context = "";
  c36_info[0].name = "mtimes";
  c36_info[0].dominantType = "double";
  c36_info[0].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c36_info[0].fileTimeLo = 3767347712U;
  c36_info[0].fileTimeHi = 30114278U;
  c36_info[0].mFileTimeLo = 0U;
  c36_info[0].mFileTimeHi = 0U;
  c36_info[1].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c36_info[1].name = "eml_index_class";
  c36_info[1].dominantType = "";
  c36_info[1].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  c36_info[1].fileTimeLo = 3021966592U;
  c36_info[1].fileTimeHi = 30107998U;
  c36_info[1].mFileTimeLo = 0U;
  c36_info[1].mFileTimeHi = 0U;
  c36_info[2].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c36_info[2].name = "eml_scalar_eg";
  ...
  c36_info[14].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c36_info[14].name = "eml_scalexp_alloc";
  c36_info[14].dominantType = "double";
  c36_info[14].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_alloc.m";
  c36_info[14].fileTimeLo = 3201966592U;
  c36_info[14].fileTimeHi = 30107998U;
  c36_info[14].mFileTimeLo = 0U;
  c36_info[14].mFileTimeHi = 0U;
  c36_info[15].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c36_info[15].name = "eml_scalar_floor";
  c36_info[15].dominantType = "double";
  c36_info[15].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_floor.m";
  c36_info[15].fileTimeLo = 2501966592U;
  c36_info[15].fileTimeHi = 30107998U;
  c36_info[15].mFileTimeLo = 0U;
  c36_info[15].mFileTimeHi = 0U;
  c36_info[16].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c36_info[16].name = "eml_error";
  c36_info[16].dominantType = "char";
  c36_info[16].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_error.m";
  c36_info[16].fileTimeLo = 2241966592U;
  ...
  const mxArray *c36_b_is_active_c36_check, const char_T *c36_identifier)
{
  ...
  c36_y = c36_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c36_b_is_active_c36_check), &c36_thisId);
  sf_mex_destroy(&c36_b_is_active_c36_check);
  return c36_y;
}
...
/* SFunction Glue Code */
void sf_c36_check_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3989241286U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3909312651U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3044186097U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1336538417U);
}

mxArray *sf_c36_check_get_autoinheritance_info(void)
{
...

  {
    ...
    pr[0] = (double)(3743630348U);
    pr[1] = (double)(1677441426U);
    pr[2] = (double)(2451228032U);
    pr[3] = (double)(1321767775U);
...
static const mxArray *sf_get_sim_state_info_c36_check(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[11],T\"dist\",},{M[1],M[5],T\"u\",},{M[8],M[0],T\"is_active_c36_check\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c36_check_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc36_checkInstanceStruct *chartInstance;
    chartInstance = (SFc36_checkInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML(0,1,1,0,0,3,0,0,0);
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",1,-1,518);
        _SFD_CV_INIT_EML_IF(0,0,105,116,-1,508);
        _SFD_CV_INIT_EML_FOR(0,0,202,212,297);
        _SFD_CV_INIT_EML_FOR(0,1,322,332,482);
        _SFD_CV_INIT_EML_FOR(0,2,363,373,443);
...
static void sf_opaque_initialize_c36_check(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc36_checkInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c36_check((SFc36_checkInstanceStruct*) chartInstanceVar);
  initialize_c36_check((SFc36_checkInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c36_check(void *chartInstanceVar)
{
  enable_c36_check((SFc36_checkInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c36_check(void *chartInstanceVar)
{
  disable_c36_check((SFc36_checkInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c36_check(void *chartInstanceVar)
{
  sf_c36_check((SFc36_checkInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c36_check(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c36_check((SFc36_checkInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c36_check();/* state var info */
...
extern void sf_internal_set_sim_state_c36_check(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c36_check((SFc36_checkInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c36_check(SimStruct* S)
{
  return sf_internal_get_sim_state_c36_check(S);
}

static void sf_opaque_set_sim_state_c36_check(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c36_check(S, st);
}

static void sf_opaque_terminate_c36_check(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc36_checkInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c36_check((SFc36_checkInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc36_check((SFc36_checkInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c36_check(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c36_check((SFc36_checkInstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c36_check(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"check","check",36);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"check","check",36,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"check","check",36,
      "gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 2, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"check","check",36,3);
      sf_mark_chart_reusable_outputs(S,"check","check",36,2);
    }

    sf_set_rtw_dwork_info(S,"check","check",36);
    ssSetHasSubFunctions(S,!(chartIsInlinable));
  } else {
  }

  ssSetOptions(S,ssGetOptions(S)|SS_OPTION_WORKS_WITH_CODE_REUSE);
  ssSetChecksum0(S,(3671743361U));
  ssSetChecksum1(S,(3294610685U));
  ssSetChecksum2(S,(2325389626U));
  ssSetChecksum3(S,(429283124U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c36_check(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "check", "check",36);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c36_check(SimStruct *S)
{
  SFc36_checkInstanceStruct *chartInstance;
  chartInstance = (SFc36_checkInstanceStruct *)malloc(sizeof
    (SFc36_checkInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc36_checkInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c36_check;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c36_check;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c36_check;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c36_check;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c36_check;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c36_check;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c36_check;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c36_check;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c36_check;
  chartInstance->chartInfo.mdlStart = mdlStart_c36_check;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c36_check;
...
void c36_check_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c36_check(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c36_check(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c36_check(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c36_check_method_dispatcher.\n"
