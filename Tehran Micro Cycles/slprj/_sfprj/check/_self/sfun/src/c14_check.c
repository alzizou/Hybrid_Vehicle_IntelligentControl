...
static void initialize_c14_check(SFc14_checkInstanceStruct *chartInstance);
static void initialize_params_c14_check(SFc14_checkInstanceStruct *chartInstance);
static void enable_c14_check(SFc14_checkInstanceStruct *chartInstance);
static void disable_c14_check(SFc14_checkInstanceStruct *chartInstance);
static void c14_update_debugger_state_c14_check(SFc14_checkInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c14_check(SFc14_checkInstanceStruct
  *chartInstance);
static void set_sim_state_c14_check(SFc14_checkInstanceStruct *chartInstance,
  const mxArray *c14_st);
static void finalize_c14_check(SFc14_checkInstanceStruct *chartInstance);
static void sf_c14_check(SFc14_checkInstanceStruct *chartInstance);
static void initSimStructsc14_check(SFc14_checkInstanceStruct *chartInstance);
...
static const mxArray *c14_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static real_T c14_emlrt_marshallIn(SFc14_checkInstanceStruct *chartInstance,
  const mxArray *c14_y, const char_T *c14_identifier);
static real_T c14_b_emlrt_marshallIn(SFc14_checkInstanceStruct *chartInstance,
...
static real_T c14_mpower(SFc14_checkInstanceStruct *chartInstance, real_T c14_a);
static const mxArray *c14_b_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static int32_T c14_c_emlrt_marshallIn(SFc14_checkInstanceStruct *chartInstance,
  const mxArray *c14_u, const emlrtMsgIdentifier *c14_parentId);
static void c14_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c14_mxArrayInData, const char_T *c14_varName, void *c14_outData);
static uint8_T c14_d_emlrt_marshallIn(SFc14_checkInstanceStruct *chartInstance,
  const mxArray *c14_b_is_active_c14_check, const char_T *c14_identifier);
static uint8_T c14_e_emlrt_marshallIn(SFc14_checkInstanceStruct *chartInstance,
  const mxArray *c14_u, const emlrtMsgIdentifier *c14_parentId);
static void init_dsm_address_info(SFc14_checkInstanceStruct *chartInstance);
...
static void initialize_c14_check(SFc14_checkInstanceStruct *chartInstance)
{
  ...
  chartInstance->c14_is_active_c14_check = 0U;
}
  ...
  *chartInstance)
{
  ...
  c14_b_hoistedGlobal = chartInstance->c14_is_active_c14_check;
  ...
  const mxArray *c14_st)
{
  ...
  *c14_y = c14_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c14_u,
    0)), "y");
  chartInstance->c14_is_active_c14_check = c14_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c14_u, 1)), "is_active_c14_check");
  sf_mex_destroy(&c14_u);
  c14_update_debugger_state_c14_check(chartInstance);
  ...
  *c14_inData)
{
  ...
  real_T c14_u;
  const mxArray *c14_y = NULL;
  SFc14_checkInstanceStruct *chartInstance;
  chartInstance = (SFc14_checkInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c14_check_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c14_b_is_active_c14_check, const char_T *c14_identifier)
{
  ...
  c14_y = c14_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c14_b_is_active_c14_check), &c14_thisId);
  sf_mex_destroy(&c14_b_is_active_c14_check);
  return c14_y;
}
...
/* SFunction Glue Code */
void sf_c14_check_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c14_check_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c14_check(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c14_check\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c14_check_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc14_checkInstanceStruct *chartInstance;
    chartInstance = (SFc14_checkInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c14_check(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc14_checkInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c14_check((SFc14_checkInstanceStruct*) chartInstanceVar);
  initialize_c14_check((SFc14_checkInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c14_check(void *chartInstanceVar)
{
  enable_c14_check((SFc14_checkInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c14_check(void *chartInstanceVar)
{
  disable_c14_check((SFc14_checkInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c14_check(void *chartInstanceVar)
{
  sf_c14_check((SFc14_checkInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c14_check(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c14_check((SFc14_checkInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c14_check();/* state var info */
...
extern void sf_internal_set_sim_state_c14_check(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c14_check((SFc14_checkInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c14_check(SimStruct* S)
{
  return sf_internal_get_sim_state_c14_check(S);
}

static void sf_opaque_set_sim_state_c14_check(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c14_check(S, st);
}

static void sf_opaque_terminate_c14_check(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc14_checkInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c14_check((SFc14_checkInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc14_check((SFc14_checkInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c14_check(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c14_check((SFc14_checkInstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c14_check(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"check","check",14);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"check","check",14,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"check","check",14,
      "gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"check","check",14,2);
      sf_mark_chart_reusable_outputs(S,"check","check",14,1);
    }

    sf_set_rtw_dwork_info(S,"check","check",14);
...
static void mdlRTW_c14_check(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "check", "check",14);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c14_check(SimStruct *S)
{
  SFc14_checkInstanceStruct *chartInstance;
  chartInstance = (SFc14_checkInstanceStruct *)malloc(sizeof
    (SFc14_checkInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc14_checkInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c14_check;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c14_check;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c14_check;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c14_check;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c14_check;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c14_check;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c14_check;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c14_check;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c14_check;
  chartInstance->chartInfo.mdlStart = mdlStart_c14_check;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c14_check;
...
void c14_check_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c14_check(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c14_check(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c14_check(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c14_check_method_dispatcher.\n"
