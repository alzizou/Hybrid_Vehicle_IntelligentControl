...
static const char * c36_debug_family_names[16] = { "q", "u1", "r", "i", "k",
  "den", "nargin", "nargout", "x_feat", "teta_new_10", "init", "t", "T0", "T1",
  "u", "dist" };

/* Function Declarations */
static void initialize_c36_check_1(SFc36_check_1InstanceStruct *chartInstance);
static void initialize_params_c36_check_1(SFc36_check_1InstanceStruct
  *chartInstance);
static void enable_c36_check_1(SFc36_check_1InstanceStruct *chartInstance);
static void disable_c36_check_1(SFc36_check_1InstanceStruct *chartInstance);
static void c36_update_debugger_state_c36_check_1(SFc36_check_1InstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c36_check_1(SFc36_check_1InstanceStruct
  *chartInstance);
static void set_sim_state_c36_check_1(SFc36_check_1InstanceStruct *chartInstance,
  const mxArray *c36_st);
static void finalize_c36_check_1(SFc36_check_1InstanceStruct *chartInstance);
static void sf_c36_check_1(SFc36_check_1InstanceStruct *chartInstance);
static void c36_chartstep_c36_check_1(SFc36_check_1InstanceStruct *chartInstance);
static void initSimStructsc36_check_1(SFc36_check_1InstanceStruct *chartInstance);
...
static const mxArray *c36_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static void c36_emlrt_marshallIn(SFc36_check_1InstanceStruct *chartInstance,
  const mxArray *c36_dist, const char_T *c36_identifier, real_T c36_y[4]);
static void c36_b_emlrt_marshallIn(SFc36_check_1InstanceStruct *chartInstance,
...
static const mxArray *c36_b_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static real_T c36_c_emlrt_marshallIn(SFc36_check_1InstanceStruct *chartInstance,
...
static const mxArray *c36_c_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static void c36_d_emlrt_marshallIn(SFc36_check_1InstanceStruct *chartInstance,
...
static void c36_eml_scalar_eg(SFc36_check_1InstanceStruct *chartInstance);
static void c36_b_eml_scalar_eg(SFc36_check_1InstanceStruct *chartInstance);
static real_T c36_ceval_xdot(SFc36_check_1InstanceStruct *chartInstance, int32_T
...
static const mxArray *c36_e_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static int32_T c36_e_emlrt_marshallIn(SFc36_check_1InstanceStruct *chartInstance,
  const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId);
static void c36_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c36_mxArrayInData, const char_T *c36_varName, void *c36_outData);
static uint8_T c36_f_emlrt_marshallIn(SFc36_check_1InstanceStruct *chartInstance,
  const mxArray *c36_b_is_active_c36_check_1, const char_T *c36_identifier);
static uint8_T c36_g_emlrt_marshallIn(SFc36_check_1InstanceStruct *chartInstance,
  const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId);
static void init_dsm_address_info(SFc36_check_1InstanceStruct *chartInstance);
...
static void initialize_c36_check_1(SFc36_check_1InstanceStruct *chartInstance)
{
  ...
  chartInstance->c36_is_active_c36_check_1 = 0U;
}
  ...
  *chartInstance)
{
  ...
  c36_hoistedGlobal = chartInstance->c36_is_active_c36_check_1;
  ...
  const mxArray *c36_st)
{
  ...
  chartInstance->c36_is_active_c36_check_1 = c36_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c36_u, 2)),
     "is_active_c36_check_1");
  sf_mex_destroy(&c36_u);
  c36_update_debugger_state_c36_check_1(chartInstance);
...
static void sf_c36_check_1(SFc36_check_1InstanceStruct *chartInstance)
{
  ...
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 1U, chartInstance->c36_sfEvent);
  ...
  chartInstance->c36_sfEvent = CALL_EVENT;
  c36_chartstep_c36_check_1(chartInstance);
...
static void c36_chartstep_c36_check_1(SFc36_check_1InstanceStruct *chartInstance)
{
  ...
  real_T c36_b_T0;
  real_T c36_b_T1;
  uint32_T c36_debug_family_var_map[16];
  real_T c36_q;
  real_T c36_u1[4];
  real_T c36_r;
  real_T c36_i;
  ...
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 1U, chartInstance->c36_sfEvent);
  ...
  sf_debug_symbol_scope_push_eml(0U, 16U, 16U, c36_debug_family_names,
  ...
  sf_debug_symbol_scope_add_eml_importable(&c36_b_T1, 13U, c36_b_sf_marshallOut,
    c36_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c36_u, 14U, c36_sf_marshallOut,
    c36_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c36_dist, 15U, c36_sf_marshallOut,
    c36_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  if (CV_EML_IF(0, 0, c36_t >= c36_b_T0)) {
    ...
    c36_xk = c36_x;
    c36_b_x = c36_xk;
    c36_r = muDoubleScalarRem(c36_b_x, 5.0);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 1U, chartInstance->c36_sfEvent);
}
  ...
  *c36_inData)
{
  ...
  real_T c36_u[4];
  const mxArray *c36_y = NULL;
  SFc36_check_1InstanceStruct *chartInstance;
  chartInstance = (SFc36_check_1InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c36_check_1_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c36_b_is_active_c36_check_1, const char_T *c36_identifier)
{
  ...
  c36_y = c36_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c36_b_is_active_c36_check_1), &c36_thisId);
  sf_mex_destroy(&c36_b_is_active_c36_check_1);
  return c36_y;
}
...
/* SFunction Glue Code */
void sf_c36_check_1_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3480277546U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2680303418U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1102876000U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1679351619U);
}

mxArray *sf_c36_check_1_get_autoinheritance_info(void)
{
...

  {
    ...
    pr[0] = (double)(102503970U);
    pr[1] = (double)(24633842U);
    pr[2] = (double)(1196406063U);
    pr[3] = (double)(2546420606U);
...
static const mxArray *sf_get_sim_state_info_c36_check_1(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[11],T\"dist\",},{M[1],M[5],T\"u\",},{M[8],M[0],T\"is_active_c36_check_1\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c36_check_1_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc36_check_1InstanceStruct *chartInstance;
    chartInstance = (SFc36_check_1InstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",1,-1,508);
        _SFD_CV_INIT_EML_IF(0,0,105,113,-1,498);
        _SFD_CV_INIT_EML_IF(0,1,154,166,-1,494);
        _SFD_CV_INIT_EML_FOR(0,0,184,194,279);
        _SFD_CV_INIT_EML_FOR(0,1,304,314,464);
        _SFD_CV_INIT_EML_FOR(0,2,345,355,425);
...
static void sf_opaque_initialize_c36_check_1(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc36_check_1InstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c36_check_1((SFc36_check_1InstanceStruct*) chartInstanceVar);
  initialize_c36_check_1((SFc36_check_1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c36_check_1(void *chartInstanceVar)
{
  enable_c36_check_1((SFc36_check_1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c36_check_1(void *chartInstanceVar)
{
  disable_c36_check_1((SFc36_check_1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c36_check_1(void *chartInstanceVar)
{
  sf_c36_check_1((SFc36_check_1InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c36_check_1(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c36_check_1((SFc36_check_1InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c36_check_1();/* state var info */
...
extern void sf_internal_set_sim_state_c36_check_1(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c36_check_1((SFc36_check_1InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c36_check_1(SimStruct* S)
{
  return sf_internal_get_sim_state_c36_check_1(S);
}

static void sf_opaque_set_sim_state_c36_check_1(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c36_check_1(S, st);
}

static void sf_opaque_terminate_c36_check_1(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc36_check_1InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c36_check_1((SFc36_check_1InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc36_check_1((SFc36_check_1InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c36_check_1(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c36_check_1((SFc36_check_1InstanceStruct*)
      (((ChartInfoStruct *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c36_check_1(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"check_1","check_1",36);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"check_1","check_1",36,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"check_1","check_1",36,
      "gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 2, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"check_1","check_1",36,3);
      sf_mark_chart_reusable_outputs(S,"check_1","check_1",36,2);
    }

    sf_set_rtw_dwork_info(S,"check_1","check_1",36);
    ssSetHasSubFunctions(S,!(chartIsInlinable));
  } else {
  }

  ssSetOptions(S,ssGetOptions(S)|SS_OPTION_WORKS_WITH_CODE_REUSE);
  ssSetChecksum0(S,(2121523114U));
  ssSetChecksum1(S,(2543830096U));
  ssSetChecksum2(S,(1475637668U));
  ssSetChecksum3(S,(3494197865U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c36_check_1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "check_1", "check_1",36);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c36_check_1(SimStruct *S)
{
  SFc36_check_1InstanceStruct *chartInstance;
  chartInstance = (SFc36_check_1InstanceStruct *)malloc(sizeof
    (SFc36_check_1InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc36_check_1InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c36_check_1;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c36_check_1;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c36_check_1;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c36_check_1;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c36_check_1;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c36_check_1;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c36_check_1;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c36_check_1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c36_check_1;
  chartInstance->chartInfo.mdlStart = mdlStart_c36_check_1;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c36_check_1;
...
void c36_check_1_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c36_check_1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c36_check_1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c36_check_1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c36_check_1_method_dispatcher.\n"
